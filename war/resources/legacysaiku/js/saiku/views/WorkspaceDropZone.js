        ...
        $.contextMenu({
            ...
            ignoreRightClick: true,
             build: function($trigger, e) {
                ...
                var citems = {
                        "filter" : {name: Saiku.i18n.getTranslation("Filter"), items: 
                         { 
                                "customfilter": {name: Saiku.i18n.getTranslation("Custom...") },
                                "clearfilter": {name: Saiku.i18n.getTranslation("Clear Filter") }
                         }},
                        "limit" : {name: Saiku.i18n.getTranslation("Limit"), items: 
                        {
                                "TopCount###SEPARATOR###10": {name: Saiku.i18n.getTranslation("Top 10") },
                                "BottomCount###SEPARATOR###10": {name: Saiku.i18n.getTranslation("Bottom 10") },
                                "TopCountQuick" : { name: Saiku.i18n.getTranslation("Top 10 by..."), items: addFun(items, "TopCount") },
                                "BottomCountQuick" : { name: Saiku.i18n.getTranslation("Bottom 10 by..."), items: addFun(items, "BottomCount") },
                                "customtop" : {name: Saiku.i18n.getTranslation("Custom Limit...") },
                                "clearlimit" : {name: Saiku.i18n.getTranslation("Clear Limit")}
                         }},
                        "sort" : {name: Saiku.i18n.getTranslation("Sort"), items:
                        {
                            "ASCQuick": {name: Saiku.i18n.getTranslation("Ascending") , items: addFun(items, "ASC") },
                            "DESCQuick": {name: Saiku.i18n.getTranslation("Descending"), items: addFun(items, "DESC")},
                            "BASCQuick": {name: Saiku.i18n.getTranslation("Ascending (Breaking Hierarchy)"), items: addFun(items, "BASC")},
                            "BDESCQuick": {name: Saiku.i18n.getTranslation("Descending (Breaking Hierarchy)"), items: addFun(items, "BDESC") },
                            "customsort" : { name: Saiku.i18n.getTranslation("Custom...") },
                            "clearsort" : {name: Saiku.i18n.getTranslation("Clear Sort") }
                        }}
                };
