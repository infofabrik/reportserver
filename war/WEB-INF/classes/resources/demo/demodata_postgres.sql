...
/*------------------------------------------------------------------------------------------*/
 ...
 drop table if exists t_agg_customer;
 drop table if exists t_agg_employee;
 drop table if exists t_agg_order;
 drop table if exists t_agg_payment;
 drop table if exists t_agg_product;
...
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('addressLine1','%',NULL,'Erste Zeile der Anschrift');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('addressLine2','%',NULL,'Zweite Zeile der Anschrift');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('amount','%',NULL,'Betrag der vorgenommenen Zahlung');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('buyPrice','%',NULL,'Einkaufspreis');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('checkNumber','%',NULL,'Referenznummer der Zahlung');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('city','%',NULL,'Stadt');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('column_name','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('comments','%',NULL,'Bearbeitungshinweise');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('contactFirstName','%',NULL,'Vorname des Ansprechpartners');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('contactLastName','%',NULL,'Nachname des Ansprechpartners');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('country','%',NULL,'Land');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('creditLimit','%',NULL,'Der dem Kunden eingeräumte Kreditrahmen');
INSERT INTO METADATA (column_name, table_name, default_alias, description, semantic, hasindex) VALUES ('customerName','%',NULL,'Name des Kunden','linkto|https://www.google.de/#q=${value}',1);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('customerNumber','%',NULL,'Kundennummer');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('CUS_ADDRESSLINE1','%',NULL,'Erste Zeile der Anschrift');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('CUS_ADDRESSLINE2','%',NULL,'Zweite Zeile der Anschrift');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('CUS_CITY','%',NULL,'Stadt');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('CUS_CONTACTFIRSTNAME','%',NULL,'Vorname des Ansprechpartners');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('CUS_CONTACTLASTNAME','%',NULL,'Nachname des Ansprechpartners');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('CUS_COUNTRY','%',NULL,'Land');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('CUS_CREDITLIMIT','%',NULL,'Der dem Kunden eingeräumte Kreditrahmen');
INSERT INTO METADATA (column_name, table_name, default_alias, description, semantic, hasindex) VALUES ('CUS_CUSTOMERNAME','%',NULL,'Name des Kunden','linkto|https://www.google.de/#q=${value}',0);
INSERT INTO METADATA (column_name, table_name, default_alias, description, semantic, hasindex) VALUES ('CUS_CUSTOMERNUMBER','%',NULL,'Kundennummer', NULL, 1);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('CUS_PHONE','%',NULL,'Telefonnummer');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('CUS_POSTALCODE','%',NULL,'Postleitzahl');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('CUS_SALESREPEMPLOYEENUMBER','%',NULL,'Mitarbeiternummer des zuständigen Kundenberaters');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('CUS_STATE','%',NULL,'Bundesland');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('email','%',NULL,'Email Adresse');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('employeeNumber','%',NULL,'Mitarbeiternummer');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('EMP_EMAIL','%',NULL,'Email Adresse');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('EMP_EMPLOYEENUMBER','%',NULL,'Mitarbeiternummer');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('EMP_EXTENSION','%',NULL,'Durchwahl');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('EMP_FIRSTNAME','%',NULL,'Vorname');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('EMP_JOBTITLE','%',NULL,'Position');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('EMP_LASTNAME','%',NULL,'Nachname');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('EMP_OFFICECODE','%',NULL,'Niederlassung');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('EMP_REPORTSTO','%',NULL,'Vorgesetzter');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('extension','%',NULL,'Durchwahl');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('firstName','%',NULL,'Vorname');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('htmlDescription','%',NULL,'Beschreibung');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('image','%',NULL,'Bild');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('jobTitle','%',NULL,'Position');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('lastName','%',NULL,'Nachname');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('MSRP','%',NULL,'Empfohlener Verkaufspreis');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('officeCode','%',NULL,'Niederlassung');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OFF_ADDRESSLINE1','%',NULL,'Erste Zeile der Anschrift');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OFF_ADDRESSLINE2','%',NULL,'Zweite Zeile der Anschrift');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OFF_CITY','%',NULL,'Stadt');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OFF_COUNTRY','%',NULL,'Land');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OFF_OFFICECODE','%',NULL,'Niederlassung');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OFF_PHONE','%',NULL,'Telefon');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OFF_POSTALCODE','%',NULL,'Postleitzahl');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OFF_STATE','%',NULL,'Bundesland');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OFF_TERRITORY','%',NULL,'Verkaufsgebiet');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('orderDate','%',NULL,'Bestelldatum');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OD_ORDERLINENUMBER','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OD_ORDERNUMBER','%',NULL,'Bestellnummer');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OD_PRICEEACH','%',NULL,'Stückpreis');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OD_PRODUCTCODE','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OD_QUANTITYORDERED','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('orderLineNumber','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('orderNumber','%',NULL,'Bestellnummer');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OR_COMMENTS','%',NULL,'Bemerkungen');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OR_CUSTOMERNUMBER','%',NULL,'Kundennummer');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OR_ORDERDATE','%',NULL,'Bestelldatum');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OR_ORDERNUMBER','%',NULL,'Bestellnummer');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OR_REQUIREDDATE','%',NULL,'Zugesagtes Lieferdatum');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OR_SHIPPEDDATE','%',NULL,'Versanddatum');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('OR_STATUS','%',NULL,'Bestellstatus');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('paymentDate','%',NULL,'Zahlungseingang');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PAY_AMOUNT','%',NULL,'Betrag');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PAY_CHECKNUMBER','%',NULL,'Zahlungreferenznummer');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PAY_CUSTOMERNUMBER','%',NULL,'Kundennummer');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PAY_PAYMENTDATE','%',NULL,'Zahlungsdatum');
...
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PL_IMAGE','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PL_PRODUCTLINE','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PL_TEXTDESCRIPTION','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('productName','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('productScale','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PRO_BUYPRICE','%',NULL,'Einkaufspreis');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PRO_MSRP','%',NULL,'Empfohlener Verkaufspreis');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PRO_PRODUCTCODE','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PRO_PRODUCTDESCRIPTION','%',NULL,'Produktbeschreibung');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PRO_PRODUCTLINE','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PRO_PRODUCTNAME','%',NULL,'Produktname');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PRO_PRODUCTSCALE','%',NULL,NULL);
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PRO_PRODUCTVENDOR','%',NULL,'Hersteller');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('PRO_QUANTITYINSTOCK','%',NULL,'Lagerbestand');
...
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('Y_ACC_BALANCE','%',NULL,'Kontostand des Kundenkontos');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('Y_AVG_PRICE','%',NULL,'Durchschnittlich erzielter Verkaufspreis');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('Y_NUM_CUSTOMERS','%',NULL,'Anzahl betreueter Kunden');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('Y_NUM_SOLD','%',NULL,'Anzahl verkaufter Artikel');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('Y_SALES_AMOUNT','%',NULL,'Betrag abgeschlossener Verkäufe');
INSERT INTO METADATA (column_name, table_name, default_alias, description) VALUES ('Y_VOLUME','%',NULL,'Umsatz');
...
UPDATE order2
SET orderDate = orderDate + (select now() - max(paymentDate) from payments),
    requiredDate = requiredDate + (select now() - max(paymentDate) from payments),
    shippedDate = shippedDate + (select now() - max(paymentDate) from payments);
...
UPDATE payments2
SET paymentDate = paymentDate + (select now() - max(paymentDate) from payments);
