...
import mondrian8.spi.CatalogLocator;
import mondrian8.tui.XmlaSupport;
import mondrian8.util.ClassResolver;
import mondrian8.util.LockBox;
import mondrian8.util.Pair;
import mondrian8.xmla.DataSourcesConfig;
...
/**
 * Implementation of {@link mondrian8.server.Repository} that reads
...
public class FileRepository implements Repository {
    ...
    private static final ScheduledExecutorService executorService =
        Util.getScheduledExecutorService(
            1,
            "mondrian8.server.DynamicContentFinder$executorService");
