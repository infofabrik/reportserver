...
/**
 * Implementation of {@link mondrian8.olap.MondrianServer}.
 *
 * @author jhyde
 * @since Jun 25, 2006
 */
    ...
    private void registerMBean() {
        ...
        try {
            ObjectName mxbeanName = new ObjectName(
                "mondrian8.server:type=Server-" + id);
