 ...
 * the "mondrian8.statistics.providers.DATABASE" property (substituting the
 * current database name, e.g. MYSQL or ORACLE, for <i>DATABASE</i>), then at
 * the {@link mondrian8.olap.MondrianProperties#StatisticsProviders "mondrian8.statistics.providers"}
 * property.</p>
 *
 * @see mondrian8.spi.impl.JdbcStatisticsProvider
 * @see mondrian8.spi.impl.SqlStatisticsProvider
 *
 */
