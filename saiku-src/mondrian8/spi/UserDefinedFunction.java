...
public interface UserDefinedFunction {
    ...
    interface Argument {
         ...
         * {@link #evaluate(mondrian8.olap.Evaluator)} except if the argument
         ...
         * {@link #evaluateList(mondrian8.olap.Evaluator)} or
         * {@link #evaluateIterable(mondrian8.olap.Evaluator)}.
         *
         * @param evaluator Evaluation context
