...
import mondrian8.spi.StatisticsProvider;
...
public class JdbcDialectImpl implements Dialect {
    ...
    private List<String> getStatisticsProviderNames() {
        // Dialect-specific path, e.g. "mondrian8.statistics.providers.MYSQL"
        final String path =
        ...
        // Generic property, "mondrian8.statistics.providers"
