...
import mondrian8.spi.DialectFactory;
...
/**
 * Implementation of {@link mondrian8.spi.DialectFactory} for subclasses
 * of {@link mondrian8.spi.impl.JdbcDialectImpl}.
 *
...
public class JdbcDialectFactory implements DialectFactory {
     ...
     * {@link mondrian8.spi.DialectFactory#createDialect(javax.sql.DataSource, java.sql.Connection)}.
     *
