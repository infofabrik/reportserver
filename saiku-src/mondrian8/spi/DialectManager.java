...
import mondrian8.spi.impl.JdbcDialectFactory;
import mondrian8.spi.impl.JdbcDialectImpl;
import mondrian8.util.ClassResolver;
import mondrian8.util.ServiceDiscovery;
...
/**
 * Manages {@link mondrian8.spi.Dialect} and {@link mondrian8.spi.DialectFactory}
 * objects.
 *
 * @author jhyde
 * @since Jan 13, 2009
...
public abstract class DialectManager {
    ...
    /**
     * Implementation class for {@link mondrian8.spi.DialectManager}.
     *
    ...
    private static class DialectManagerImpl {
         ...
         * {@link mondrian8.util.ServiceDiscovery} for more details.)
         */
        DialectManagerImpl() {
    ...
    /**
     * Implementation of {@link mondrian8.spi.DialectFactory} that caches
     * dialects based on data source.
     *
     * @see mondrian8.spi.Dialect#allowsDialectSharing()
     */
