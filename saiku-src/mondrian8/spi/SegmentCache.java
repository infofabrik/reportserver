 ...
 * mondrian8. The first one is to set the
 ...
 * <code>/META-INF/services/mondrian8.spi.SegmentCache</code> which contains
 ...
 * cache implementation is not part of the same class loader as mondrian8.
