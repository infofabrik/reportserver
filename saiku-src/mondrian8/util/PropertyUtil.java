...
/**
 * Utilities to generate MondrianProperties.java and mondrian8.properties
...
public class PropertyUtil {
    ...
    private void generate(String[] args) {
        ...
        final File propertiesFile =
            new File("target/mondrian8.properties.template");
    ...
    enum Generator {
        JAVA {
                ...
                PrintWriter out)
            {
                ...
                out.println("package mondrian8.olap;");
                out.println();
                ...
                String[] lines = {
                    ...
                    "     * plus the contents of \"mondrian8.properties\" if it",
                    "     * exists. A singleton.",
                    "     */",
