 ...
 * static methods in {@link mondrian8.olap.Util}, namely:<ul>
 * <li>{@link mondrian8.olap.Util#makeBigDecimalFromDouble(double)}</li>
 * <li>{@link mondrian8.olap.Util#quotePattern(String)}</li>
 * </ul></p>
 *
