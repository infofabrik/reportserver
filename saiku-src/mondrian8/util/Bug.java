 ...
 * <dl>
 *
 * <dt>Obsolete {@link mondrian8.olap.Id.Segment}</dt>
 * <dd>Replace it by {@link org.olap4j.mdx.IdentifierSegment}. Likewise
 * {@link mondrian8.olap.Id.Quoting} with {@link org.olap4j.mdx.Quoting}.
...
public class Bug {
     ...
     * {@link mondrian8.olap.MondrianProperties#SsasCompatibleNaming},
     ...
     * {@link mondrian8.spi.Dialect.DatabaseProduct#LUCIDDB} and we wish to
     * avoid slow tests.
     *
     ...
     * {@code mondrian8.test.PerforceTest} logger set at
    ...
    public static boolean avoidSlowTestOnLucidDB(Dialect dialect) {
        return
            ...
            && !LogManager.getLogger("mondrian8.test.PerformanceTest")
                .isDebugEnabled();
    }
}
