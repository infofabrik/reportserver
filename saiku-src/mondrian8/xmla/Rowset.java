 ...
 *
 * @author jhyde
 * @see mondrian8.xmla.RowsetDefinition
 * @since May 2, 2003
 */
abstract class Rowset implements XmlaConstants {
     ...
     * {@link mondrian8.xmla.Rowset.Row} object.
     *
     * @param row Row
     ...
     *
     * <p>A condition is a {@link mondrian8.olap.Util.Functor1} whose return
     * type is boolean.
     *
     ...
     * {@link mondrian8.xmla.Rowset.Row}.
     */
