...
package mondrian8.tui;

import mondrian8.olap.Category;
import mondrian8.olap.*;
import mondrian8.olap.Connection;
import mondrian8.olap.DriverManager;
import mondrian8.olap.Hierarchy;
import mondrian8.olap.fun.FunInfo;
import mondrian8.olap.type.TypeUtil;
...
public class CmdRunner {
    ...
    public Expr parseParameter(String value) {
        ...
        } else if (element instanceof mondrian8.olap.Level) {
            mondrian8.olap.Level level = (mondrian8.olap.Level) element;
    ...
    /**
     * Gets a connection to mondrian8.
     *
...
*/
    ...
    protected static void usage(String msg, PrintStream out) {
        ...
        buf.append(
            "Usage: mondrian8.tui.CmdRunner args"
            + nl
            + "  args:"
            + nl
    ...
    private static void setDefaultCommentState() {
        allowNestedComments = mondrian8.olap.Scanner.getNestedCommentsState();
        String[][] scannerCommentsDelimiters =
            mondrian8.olap.Scanner.getCommentDelimiters();
