 ...
 * {@link mondrian8.calc.impl.ValueCalc}; see also {@link mondrian8.calc.impl.TupleValueCalc}.
 *
 * @author jhyde
 * @since Sep 27, 2005
 */
public class MemberValueCalc extends GenericCalc {
     ...
     * {@link MemberValueCalc#create(mondrian8.olap.Exp,
     * mondrian8.calc.MemberCalc[], boolean)}
     * factory method.
     *
