...
/**
 * Abstract implementation of {@link mondrian8.calc.ExpCompiler}
 *
 * @author jhyde
 * @since Jan 2, 2006
 */
public class DelegatingExpCompiler implements ExpCompiler {
     ...
     * {@link #afterCompile(mondrian8.olap.Exp, mondrian8.calc.Calc, boolean)}
    ...
    /**
     * See {@link mondrian8.calc.impl.DelegatingExpCompiler#wrap}.
     */
