...
public final class TupleCollections {
     ...
     * {@link mondrian8.calc.TupleIterable#tupleIterator()} for a
     ...
     * {@link mondrian8.calc.TupleList#slice(int)}.
     *
    ...
    /**
     * Converts a {@link mondrian8.calc.TupleIterable} to an old-style iterable that
    ...
    /**
     * Converts a {@link mondrian8.calc.TupleList} to an old-style list of member
     * arrays.
     *
