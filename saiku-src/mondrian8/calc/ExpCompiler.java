...
import mondrian8.calc.impl.BetterExpCompiler;
import mondrian8.olap.*;
import mondrian8.olap.type.Type;
import mondrian8.util.CreationException;
import mondrian8.util.ObjectFactory;
...
/**
 * Mediates the compilation of an expression ({@link mondrian8.olap.Exp})
...
public interface ExpCompiler {
     ...
     *
     * <p>See {@link #compileList(mondrian8.olap.Exp)}.
     *
     * @param exp Expression
     ...
     *   {@link #compileString(mondrian8.olap.Exp)}
