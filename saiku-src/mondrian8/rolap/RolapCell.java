...
import mondrian8.olap.fun.SetFunDef;
import mondrian8.resource.MondrianResource;
import mondrian8.rolap.agg.*;
...
/**
 * <code>RolapCell</code> implements {@link mondrian8.olap.Cell} within a
 * {@link RolapResult}.
 */
public class RolapCell implements Cell {
    /**
     * @see mondrian8.util.Bug#olap4jUpgrade Use
     * {@link mondrian8.xmla.XmlaConstants}.ActionType.DRILLTHROUGH when present
     */
