...
import mondrian8.olap.CacheControl.CellRegion;
import mondrian8.resource.MondrianResource;
import mondrian8.rolap.*;
import mondrian8.rolap.cache.*;
import mondrian8.server.Execution;
import mondrian8.server.Locus;
import mondrian8.server.monitor.*;
import mondrian8.spi.*;
import mondrian8.util.*;
 ...
 * by a {@link mondrian8.spi.SegmentCache}.
 *
 * <p>Segment states</p>
 *
 * <table>
 ...
 *
 * <p>3. Delete {@link mondrian8.rolap.RolapStar#lookupOrCreateAggregation}
 * and {@link mondrian8.rolap.RolapStar#lookupSegment}
 * and {@link mondrian8.rolap.RolapStar}.lookupAggregationShared
 ...
 *
 * <p>1. {@link mondrian8.rolap.RolapStar#getCellFromCache} moved from
 ...
 * mondrian8.rolap.agg.enableCacheHitCounters.</p>
 *
 ...
 * mondrian8.spi. Leave behind dependencies on mondrian8.rolap.agg. In particular,
 ...
 *
 * <p>8. Longer term. Move {@link mondrian8.rolap.RolapStar.Bar}.segmentRefs to
 * {@link mondrian8.server.Execution}. Would it still be thread-local?</p>
 *
 * <p>10. Call
 * {@link mondrian8.spi.DataSourceChangeListener#isAggregationChanged}.
 ...
 * {@link mondrian8.rolap.agg.SegmentBuilder.SegmentConverter} is a hack that
 ...
 * {@link mondrian8.rolap.agg.SegmentCacheManager#peek}.</p>
 *
 ...
 * copying.</p>
 *
 * <p>21. Obsolete {@link mondrian8.util.CombiningGenerator}.</p>
 *
 * <p>22. {@link SegmentHeader#constrain(mondrian8.spi.SegmentColumn[])} is
...
public class SegmentCacheManager {
    ...
    public final ExecutorService cacheExecutor =
        Util.getExecutorService(
            ...
            MondrianProperties.instance()
                .SegmentCacheManagerNumberCacheThreads.get(),
            1,
            "mondrian8.rolap.agg.SegmentCacheManager$cacheExecutor",
    ...
    public final ExecutorService sqlExecutor =
        Util.getExecutorService(
            ...
            MondrianProperties.instance()
                .SegmentCacheManagerNumberSqlThreads.get(),
            1,
            "mondrian8.rolap.agg.SegmentCacheManager$sqlExecutor",
            new RejectedExecutionHandler() {
                public void rejectedExecution(
                    Runnable r,
                    ThreadPoolExecutor executor)
    ...
    public SegmentCacheManager(MondrianServer server) {
        ...
        ACTOR = new Actor();
        thread = new Thread(
            ACTOR, "mondrian8.rolap.agg.SegmentCacheManager$ACTOR");
    ...
    private static abstract class Event implements Message {
         ...
         * {@link mondrian8.server.monitor.Visitor}.
         *
    ...
    /**
     * Copy-pasted from {@link mondrian8.server.monitor.Monitor}. Consider
