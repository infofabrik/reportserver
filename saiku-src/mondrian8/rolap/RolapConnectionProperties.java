...
public enum RolapConnectionProperties {
  ...
  /**
   * The "Role" property is the name of the {@link mondrian8.olap.Role role}
   ...
   * {@link mondrian8.spi.DynamicSchemaProcessor} interface.
  ...
  /**
   * The name of a class implementing the
   * {@link mondrian8.spi.DataSourceChangeListener} interface.
   ...
   * {@link mondrian8.olap.Schema#getWarnings}.
   */
  Ignore,
