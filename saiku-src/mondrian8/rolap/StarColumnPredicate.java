...
public interface StarColumnPredicate extends StarPredicate {
     ...
     * {@link #toSql(mondrian8.rolap.sql.SqlQuery, StringBuilder)}.
     *
     * <p>todo: remove this method when
     * {@link mondrian8.util.Bug#BugMondrian313Fixed bug MONDRIAN-313} and
     * {@link mondrian8.util.Bug#BugMondrian314Fixed bug MONDRIAN-314} are fixed.
     */
    StarColumnPredicate cloneWithColumn(RolapStar.Column column);

    /**
     * Returned by
     * {@link mondrian8.rolap.StarColumnPredicate#intersect},
