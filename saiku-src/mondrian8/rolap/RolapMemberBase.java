...
import mondrian8.olap.fun.VisualTotalsFunDef;
import mondrian8.server.Locus;
import mondrian8.spi.PropertyFormatter;
    ...
    implements RolapMember
{
     ...
     * {@link mondrian8.olap.CacheControl#createMoveCommand}.
     *
     ...
     * {@link mondrian8.olap.fun.FunUtil#compareHierarchically}.
     *
     ...
     * {@link mondrian8.olap.MondrianProperties#PropertyValueMapFactoryClass}
     * is not set.
     */
        ...
        implements PropertyValueMapFactory
    {
         ...
         * {@link mondrian8.olap.Member}</p> have additional properties
         * that aren't explicitly declared.  The most common offenders
         * are the (@link mondrian8.olap.Measure} implementations, which
