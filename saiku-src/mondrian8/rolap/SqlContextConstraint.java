    ...
    implements MemberChildrenConstraint, TupleConstraint
{
    ...
    * methods {@link mondrian8.rolap.sql.MemberChildrenConstraint#addMemberConstraint(mondrian8.rolap.sql.SqlQuery, mondrian8.rolap.RolapCube, mondrian8.rolap.aggmatcher.AggStar, RolapMember)} and
    * {@link mondrian8.rolap.sql.MemberChildrenConstraint#addMemberConstraint(mondrian8.rolap.sql.SqlQuery, mondrian8.rolap.RolapCube, mondrian8.rolap.aggmatcher.AggStar, java.util.List)} will
