...
import mondrian8.rolap.cache.SmartCache;
import mondrian8.rolap.cache.SoftSmartCache;
import mondrian8.rolap.sql.SqlConstraint;
import mondrian8.util.Pair;

/**
 * Uses a {@link mondrian8.rolap.cache.SmartCache} to store lists of members,
 * where the key depends on a {@link mondrian8.rolap.sql.SqlConstraint}.
 *
 * <p>Example 1:
 *
 * <pre>
 ...
 * cacheKey of the {@link mondrian8.rolap.sql.SqlConstraint}.
 *
 * @see mondrian8.rolap.sql.SqlConstraint#getCacheKey
 *
 * @author av
 * @since Nov 21, 2005
 */
