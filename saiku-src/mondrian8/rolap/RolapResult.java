...
import mondrian8.olap.fun.VisualTotalsFunDef.VisualTotalMember;
import mondrian8.olap.type.ScalarType;
...
import mondrian8.rolap.agg.CellRequestQuantumExceededException;
...
public class RolapResult extends ResultBase {
  ...
  private Member setPlaceholderSlicerAxis(
     ...
     * as a parameter and uses it to get the {@link mondrian8.util.Format}
  ...
  public class CompoundSlicerRolapMember extends DelegatingRolapMember
    ...
    public boolean isOnSameHierarchyChainInternal( MemberBase member2 ) {
      ...
      int index = -1;
      for ( List<mondrian8.olap.Member> subList : tupleList ) {
        if ( index == -1 ) {
