...
import mondrian8.rolap.aggmatcher.AggTableManager;
import mondrian8.spi.*;
import mondrian8.spi.impl.Scripts;
import mondrian8.util.ByteString;
...
public class RolapSchema implements Schema {
     ...
     * that has
     * {@link mondrian8.rolap.RolapConnectionProperties#Ignore Ignore}=true.
     */
  ...
  @Deprecated
     ...
     * (see {@link mondrian8.rolap.RolapConnectionProperties#Ignore}), adds
     ...
     *   The class must implement {@link mondrian8.spi.UserDefinedFunction}
