...
import mondrian8.calc.ParameterSlot;
 ...
 * {@link mondrian8.olap.Evaluator#setContext(mondrian8.olap.Member)}) creates, at
...
public class RolapEvaluator implements Evaluator {
  private static final Logger LOGGER = LogManager.getLogger( RolapEvaluator.class );
    ...
    /**
     * More specific version of {@link #getContext(mondrian8.olap.Hierarchy)},
     * for internal code.
     *
     ...
     * @throws mondrian8.olap.fun.MondrianEvaluationException if there is a loop
     */
