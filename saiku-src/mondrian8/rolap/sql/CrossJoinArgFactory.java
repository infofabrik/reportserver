...
// All Rights Reserved.
*/
package mondrian8.rolap.sql;

import mondrian8.calc.*;
import mondrian8.mdx.*;
import mondrian8.olap.*;
import mondrian8.olap.Role.RollupPolicy;
...
public class CrossJoinArgFactory {
     ...
     *
     * @return an {@link mondrian8.rolap.sql.CrossJoinArg} instance describing the enumeration,
     ...
     *
     * @return an {@link mondrian8.rolap.sql.CrossJoinArg} instance describing the member.children
     ...
     *
     * @return an {@link mondrian8.rolap.sql.CrossJoinArg} instance describing the Level.members
     *         function, or null if <code>fun</code> represents something else.
     */
     ...
     *
     * @return an {@link mondrian8.rolap.sql.CrossJoinArg} instance describing the Descendants
     *         function, or null if <code>fun</code> represents something else.
     */
        ...
        boolean exclude)
    {
        ...
        if (!(currentMemberArgType
            instanceof mondrian8.olap.type.DimensionType
