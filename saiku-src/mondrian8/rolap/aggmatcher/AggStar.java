...
import mondrian8.olap.MondrianDef.AggLevel;
import mondrian8.recorder.MessageRecorder;
import mondrian8.resource.MondrianResource;
import mondrian8.rolap.*;
import mondrian8.rolap.RolapAggregator.BaseAggor;
import mondrian8.rolap.aggmatcher.JdbcSchema.Table.Column.Usage;
import mondrian8.rolap.aggmatcher.JdbcSchema.UsageType;
...
public class AggStar {
    ...
    public abstract class Table {
        ...
        public class JoinCondition {
            ...
            public void print(final PrintWriter pw, final String prefix) {
                ...
                if (left instanceof MondrianDef.Column) {
                    ...
                    mondrian8.rolap.RolapStar.Column col =
        ...
        /**
         * Converts a {@link mondrian8.rolap.RolapStar.Table} into a
