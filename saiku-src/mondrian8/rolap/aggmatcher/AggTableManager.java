...
import mondrian8.olap.Util.PropertyList;
import mondrian8.recorder.ListRecorder;
import mondrian8.recorder.MessageRecorder;
import mondrian8.recorder.RecorderException;
import mondrian8.resource.MondrianResource;
import mondrian8.rolap.RolapCube;
import mondrian8.rolap.RolapSchema;
import mondrian8.rolap.RolapStar;
 ...
 * <li>A {@link mondrian8.rolap.RolapSchema} creates an {@link AggTableManager},
 *     and stores it in a member variable to ensure that it is not
 *     garbage-collected.
 * <li>The {@link mondrian8.rolap.RolapSchema} calls {@link #initialize(PropertyList)},
...
*/
     ...
     * {@link mondrian8.rolap.aggmatcher.ExplicitRules.Group} in every
