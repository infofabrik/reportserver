...
import mondrian8.calc.impl.DelegatingTupleList;
...
import mondrian8.spi.impl.JndiDataSourceResolver;
 ...
 * {@link DriverManager#getConnection(String, mondrian8.spi.CatalogLocator)}.
...
public class RolapConnection extends ConnectionBase {
  ...
  /**
   * Returns the instance of the {@link mondrian8.spi.DataSourceResolver}
   * plugin.
   *
   ...
   * {@link mondrian8.olap.Util.PropertyList connectInfo}.
   *
   ...
   *                                        the property file
   * @deprecated Use {@link #execute(mondrian8.server.Execution)}; this method
