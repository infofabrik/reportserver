...
import mondrian8.calc.impl.*;
import mondrian8.mdx.*;
import mondrian8.olap.*;
import mondrian8.olap.DimensionType;
import mondrian8.olap.LevelType;
import mondrian8.olap.Role.HierarchyAccess;
import mondrian8.olap.fun.*;
import mondrian8.olap.type.*;
import mondrian8.resource.MondrianResource;
import mondrian8.rolap.RestrictedMemberReader.MultiCardinalityDefaultMember;
import mondrian8.rolap.format.FormatterCreateContext;
import mondrian8.rolap.format.FormatterFactory;
import mondrian8.rolap.sql.MemberChildrenConstraint;
import mondrian8.rolap.sql.SqlQuery;
import mondrian8.spi.CellFormatter;
import mondrian8.util.UnionIterator;
...
public class RolapHierarchy extends HierarchyBase {
    ...
    MemberReader createMemberReader(Role role) {
        ...
        case CUSTOM:
            ...
            case PARTIAL:
                Type memberType1 =
                    new mondrian8.olap.type.MemberType(
                        getDimension(),
                        this,
                        null,
                        null);
     ...
     * {@link mondrian8.olap.MondrianDef.Closure} element
     ...
     * As part of {@link mondrian8.util.Bug#BugSegregateRolapCubeMemberFixed},
     * maybe make {@link mondrian8.rolap.RolapCubeMember} an interface.
     *
     * @see mondrian8.olap.Role.RollupPolicy
     */
