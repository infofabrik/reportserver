...
import mondrian8.server.*;
import mondrian8.spi.Dialect;
import mondrian8.util.ClassResolver;
...
/**
 * Utility methods for classes in the <code>mondrian8.rolap</code> package.
 *
 * @author jhyde
 * @since 22 December, 2001
 */
public class RolapUtil {
    public static final Logger MDX_LOGGER = LogManager.getLogger("mondrian8.mdx");
    public static final Logger SQL_LOGGER = LogManager.getLogger("mondrian8.sql");
    public static final Logger MONITOR_LOGGER =
        LogManager.getLogger("mondrian8.server.monitor");
    public static final Logger PROFILE_LOGGER =
        LogManager.getLogger("mondrian8.profile");
     ...
     * {@link #setHook(mondrian8.rolap.RolapUtil.ExecuteQueryHook)} are
     ...
     * {@link mondrian8.calc.Calc#dependsOn(Hierarchy)} are accurate.
     */
