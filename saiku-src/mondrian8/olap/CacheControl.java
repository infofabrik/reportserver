 ...
 * {@link mondrian8.olap.Connection#getCacheControl}.</p>
 *
 ...
 * <li>{@link #createUnionRegion(mondrian8.olap.CacheControl.CellRegion[])}</li>
 * <li>{@link #createCrossjoinRegion(mondrian8.olap.CacheControl.CellRegion[])}</li>
 * <li>{@link #createMeasuresRegion(Cube)}</li>
 * <li>{@link #flush(mondrian8.olap.CacheControl.CellRegion)}</li>
 * </ul></p>
 *
 ...
 * <li>{@link #createDeleteCommand(mondrian8.olap.CacheControl.MemberSet)}</li>
 * <li>{@link #createCompoundCommand(java.util.List)}</li>
 * <li>{@link #createCompoundCommand(mondrian8.olap.CacheControl.MemberEditCommand[])}</li>
 * <li>{@link #createSetPropertyCommand(Member, String, Object)}</li>
 * <li>{@link #createSetPropertyCommand(mondrian8.olap.CacheControl.MemberSet,java.util.Map)}</li>
 * <li>{@link #flush(mondrian8.olap.CacheControl.MemberSet)}</li>
 * <li>{@link #execute(mondrian8.olap.CacheControl.MemberEditCommand)}</li>
 * </ul></p>
 *
 * @author jhyde
 * @since Sep 27, 2006
...
public interface CacheControl {
    ...
    public interface CellRegion {
         ...
         * @return a list of {@link mondrian8.olap.Dimension} objects.
         */
     ...
     * {@link CacheControl#createUnionSet(mondrian8.olap.CacheControl.MemberSet[])}.
     */
