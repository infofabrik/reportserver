...
public interface FunTable {
    ...
    /**
     * Returns a list of {@link mondrian8.olap.fun.Resolver} objects.
     */
    ...
    /**
     * Returns a list of {@link mondrian8.olap.fun.FunInfo} objects.
     */
     ...
     *
     * <p>An implementation of {@link mondrian8.olap.FunTable} must register all
     * of its functions and operators by making callbacks during its
     * {@link mondrian8.olap.FunTable#defineFunctions(mondrian8.olap.FunTable.Builder)}
     * method.
     */
    public interface Builder {
         ...
         *
         * @see mondrian8.olap.FunTable#isReserved
         */
