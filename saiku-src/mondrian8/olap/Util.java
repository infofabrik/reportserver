...
/**
 * Utility functions used throughout mondrian8. All methods are static.
 *
 * @author jhyde
 * @since 6 August, 2001
 */
public class Util extends XOMUtil {
     ...
     * things are available via {@link mondrian8.util.UtilCompatible}.
     ...
     * In this case, the result will be a {@link mondrian8.mdx.ResolvedFunCall}.
     *
     ...
     * a look at the <code>mondrian8.olap.UtilTestCase</code> test case.
     */
     ...
     *
     * @deprecated Use {@link mondrian8.server.monitor.Monitor#getServer()} and
     *  {@link mondrian8.server.monitor.ServerInfo#sqlStatementExecuteNanos};
     ...
     *
     * @see mondrian8.olap.Util.Flat3List
     * @param <T>
     */
     ...
     * <p>The list is created via {@link Util#flatList(Object[])}.
     *
     * @see mondrian8.olap.Util.Flat2List
     * @param <T>
     */
     ...
     *
     * @see mondrian8.olap.Util#getMemoryInfo()
     */
