...
public class FunUtil extends Util {
     ...
     * has returned the MDX null value. See {@link mondrian8.calc.IntegerCalc}.
     */
     ...
     * {@link #evaluateTuples(mondrian8.olap.Evaluator, mondrian8.calc.Calc, mondrian8.calc.TupleList)}.
     *
     ...
     *
     * @see #hierarchizeTupleList(mondrian8.calc.TupleList, boolean)
     */
    ...
    */
     ...
     *
     *
     * @param evaluator Evaluator, provides a {@link mondrian8.olap.SchemaReader}
     *   and {@link mondrian8.olap.Cube}
