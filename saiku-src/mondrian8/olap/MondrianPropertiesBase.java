 ...
 * <code>mondrian8.properties</code> file. Although it is possible to retrieve
 ...
 *
 * <li>Modify the default <code>mondrian8.properties</code> file checked into
...
public abstract class MondrianPropertiesBase extends TriggerableProperties {
    ...
    protected static final String mondrianDotProperties = "mondrian8.properties";
    ...
    /**
     * Loads this property set from: the file "$PWD/mondrian8.properties" (if it
     * exists); the "mondrian8.properties" in the CLASSPATH; and from the system
     * properties.
     */
    public void populate() {
        // Read properties file "mondrian8.properties", if it exists. If we have
        ...
        if (file.exists() && file.isFile()) {
            // Read properties file "mondrian8.properties" from PWD, if it
            // exists.
            try {
        ...
        if (url != null) {
            ...
            LOGGER.warn(
                "mondrian8.properties can't be found under '"
                + new File(".").getAbsolutePath() + "' or classloader");
        }

        // copy in all system properties which start with "mondrian8."
        int count = 0;
