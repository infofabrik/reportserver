...
import mondrian8.olap.NativeEvaluationUnsupportedException;
import mondrian8.olap.InvalidHierarchyException;
import java.sql.SQLDataException;
import mondrian8.olap.QueryTimeoutException;
import mondrian8.olap.QueryCanceledException;
import mondrian8.olap.ResourceLimitExceededException;
import mondrian8.olap.MondrianException;
...
{
    private static final String baseName = "mondrian8.resource.MondrianResource";
    ...
    public MondrianResource() throws IOException {
        ...
        this.HighCardinalityInDimension = new _Def2("HighCardinalityInDimension", "The highCardinality attribute specified on dimension ''{0}'' is deprecated and will be removed in future versions of mondrian8.The feature will produce wrong results in some scenarios and should be used with caution.", null);
        ...
        this.SegmentCacheIsNotImplementingInterface = new _Def3("SegmentCacheIsNotImplementingInterface", "The mondrian8.rolap.SegmentCache property points to a class name which is not an\n        implementation of mondrian8.spi.SegmentCache.", null);
        ...
        this.NativeSqlInClauseTooLarge = new _Def9("NativeSqlInClauseTooLarge", "Cannot use native aggregation constraints for level ''{0}'' because the number of members is larger than the value of ''mondrian8.rolap.maxConstraints'' ({1})", null);
        ...
        this.SqlQueryLimitReached = new _Def3("SqlQueryLimitReached", "The number of concurrent SQL statements which can be used simultaneously by this Mondrian server instance has been reached. Set ''mondrian8.rolap.maxSqlThreads'' to change the current limit.", null);
        this.SegmentCacheLimitReached = new _Def3("SegmentCacheLimitReached", "The number of concurrent segment cache operations which can be run simultaneously by this Mondrian server instance has been reached. Set ''mondrian8.rolap.maxCacheThreads'' to change the current limit.", null);
    ...
    public static synchronized MondrianResource instance() {
        return (MondrianResource)instance("mondrian8.resource.MondrianResource", getThreadOrDefaultLocale(), ResourceBundle.getBundle("mondrian8.resource.MondrianResource", getThreadOrDefaultLocale()));
    }
    
    public static synchronized MondrianResource instance(final Locale locale) {
        return (MondrianResource)instance("mondrian8.resource.MondrianResource", locale, ResourceBundle.getBundle("mondrian8.resource.MondrianResource", locale));
    }
