...
class MondrianOlap4jProperty implements IMondrianOlap4jProperty, Named {
    ...
    static {
        ...
        for (mondrian8.olap.Property o
            : mondrian8.olap.Property.enumeration.getValuesSortedByName())
        {
    ...
    final mondrian8.olap.Property property;

    MondrianOlap4jProperty(mondrian8.olap.Property property) {
        this.property = property;
    }

    mondrian8.olap.Level level;

    MondrianOlap4jProperty
        (mondrian8.olap.Property property, mondrian8.olap.Level level) {
        this(property);
        this.level = level;
    }
    ...
    public mondrian8.olap.Level getLevel() {
        return level;
    }
