...
import mondrian8.rolap.RolapMeasure;
    ...
    implements Member, Named
{
    ...
    MondrianOlap4jMember(
        ...
        mondrian8.olap.Member mondrianMember)
    {
        ...
        throws OlapException
    {
        ...
        final List<mondrian8.olap.Member> children =
            Locus.execute(
                conn,
                "MondrianOlap4jMember.getChildMembers",
                new Locus.Action<List<mondrian8.olap.Member>>() {
                    public List<mondrian8.olap.Member> execute() {
                        return
    ...
    public MondrianOlap4jMember getParentMember() {
        final mondrian8.olap.Member parentMember = member.getParentMember();
    ...
    public Member getDataMember() {
        final mondrian8.olap.Member dataMember = member.getDataMember();
        if (dataMember == null) {
            return null;
        }
    ...
    public boolean isVisible() {
        return (Boolean) member.getPropertyValue(
            mondrian8.olap.Property.VISIBLE.getName());
    }
