...
public class NameFilter extends AbstractFilterFunction
{
    ...
    public NameFilter(final Hierarchy hierarchy, final String... matchingExpression) {
        this.operator = " = ";
    ...
    public NameFilter(final Hierarchy hierarchy, final List<String> matchingExpression) {
        this.operator = " = ";
        this.filterExpression = new ArrayList<String>();
        this.hierarchy = hierarchy;
    ...
    public NameFilter(final Hierarchy hierarchy, final List<String> matchingExpression, final String operator) {
        this.operator = " = ";
        this.filterExpression = new ArrayList<String>();
        this.hierarchy = hierarchy;
        this.filterExpression.addAll(matchingExpression);
    ...
    public List<ParseTreeNode> getArguments(final MdxParser parser) {
        ...
        for (int i = 0; i < this.filterExpression.size(); ++i) {
            ...
            final CallNode filterNode = new CallNode((ParseRegion)null, o, Syntax.Infix, new ParseTreeNode[] { (ParseTreeNode)currentMemberNameNode, filterExp });
