...
public interface FunTable {
    ...
    /**
     * Returns a list of {@link mondrian9.olap.fun.Resolver} objects.
     */
    ...
    /**
     * Returns a list of {@link mondrian9.olap.fun.FunInfo} objects.
     */
     ...
     *
     * <p>An implementation of {@link mondrian9.olap.FunTable} must register all
     * of its functions and operators by making callbacks during its
     * {@link mondrian9.olap.FunTable#defineFunctions(mondrian9.olap.FunTable.Builder)}
     * method.
     */
    public interface Builder {
         ...
         *
         * @see mondrian9.olap.FunTable#isReserved
         */
