...
public class RankFunDef extends FunDefBase {
   ...
   *
   * <p>
   * The result is a value of type {@link mondrian9.olap.fun.RankFunDef.RankedMemberList} or
   * {@link mondrian9.olap.fun.RankFunDef.RankedTupleList}, or null if the list is empty.
   */
