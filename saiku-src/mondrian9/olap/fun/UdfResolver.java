...
public class UdfResolver implements Resolver {
    ...
    private static class ScalarCalcImpl extends GenericCalc {
        ...
        public Object evaluate(Evaluator evaluator) {
            try {
                ...
                // Is assumed will be processed in mondrian9.rolap.RolapResult
                throw e;
            } catch (Exception e) {
     ...
     * Only the {@link #evaluate(mondrian9.olap.Evaluator)}
     * and {@link #evaluateScalar(mondrian9.olap.Evaluator)} methods are
     * supported.
     */
