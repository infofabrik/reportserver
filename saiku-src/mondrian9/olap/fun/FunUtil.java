...
import mondrian9.calc.DoubleCalc;
...
import mondrian9.olap.type.TupleType;
import mondrian9.olap.type.Type;
import mondrian9.olap.type.TypeUtil;
import mondrian9.resource.MondrianResource;
import mondrian9.rolap.RolapHierarchy;
...
import mondrian9.util.IdentifierParser;

/**
 * {@code FunUtil} contains a set of methods useful within the {@code mondrian9.olap.fun} package.
 *
 * @author jhyde
 * @since 1.0
 */
public class FunUtil extends Util {
   ...
   *
   * @param evaluator   Evaluator, provides a {@link mondrian9.olap.SchemaReader} and {@link mondrian9.olap.Cube}
