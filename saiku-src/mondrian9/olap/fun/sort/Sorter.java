...
// All Rights Reserved.
*/
package mondrian9.olap.fun.sort;
...
import mondrian9.olap.fun.MemberOrderKeyFunDef;
...
import static mondrian9.olap.Util.newInternal;
import static mondrian9.olap.fun.FunUtil.DoubleNull;
import static mondrian9.olap.fun.FunUtil.IntegerNull;
...
public class Sorter {
   ...
   * {@link #evaluateTuples(mondrian9.olap.Evaluator, mondrian9.calc.Calc, mondrian9.calc.TupleList)}.
   *
   ...
   * @see #hierarchizeTupleList(mondrian9.calc.TupleList, boolean)
   */
   ...
   *
   * <p>Similar to {@link mondrian9.util.Pair}, but saves boxing overhead of converting
