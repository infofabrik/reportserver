 ...
 * mondrian9. The first one is to set the
 ...
 * <code>/META-INF/services/mondrian9.spi.SegmentCache</code> which contains
 ...
 * cache implementation is not part of the same class loader as mondrian9.
