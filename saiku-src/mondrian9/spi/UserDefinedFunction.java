...
public interface UserDefinedFunction {
    ...
    interface Argument {
         ...
         * {@link #evaluate(mondrian9.olap.Evaluator)} except if the argument
         ...
         * {@link #evaluateList(mondrian9.olap.Evaluator)} or
         * {@link #evaluateIterable(mondrian9.olap.Evaluator)}.
         *
         * @param evaluator Evaluation context
