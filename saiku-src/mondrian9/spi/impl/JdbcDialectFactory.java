...
import mondrian9.spi.DialectFactory;

/**
 * Implementation of {@link mondrian9.spi.DialectFactory} for subclasses
 * of {@link mondrian9.spi.impl.JdbcDialectImpl}.
 *
...
public class JdbcDialectFactory implements DialectFactory {
     ...
     * {@link mondrian9.spi.DialectFactory#createDialect(javax.sql.DataSource, java.sql.Connection)}.
     *
