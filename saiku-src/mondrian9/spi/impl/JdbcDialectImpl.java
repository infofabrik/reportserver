...
import mondrian9.spi.StatisticsProvider;
...
public class JdbcDialectImpl implements Dialect {
    ...
    private List<String> getStatisticsProviderNames() {
        // Dialect-specific path, e.g. "mondrian9.statistics.providers.MYSQL"
        final String path =
        ...
        // Generic property, "mondrian9.statistics.providers"
