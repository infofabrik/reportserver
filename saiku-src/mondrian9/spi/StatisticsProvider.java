 ...
 * the "mondrian9.statistics.providers.DATABASE" property (substituting the
 * current database name, e.g. MYSQL or ORACLE, for <i>DATABASE</i>), then at
 * the {@link mondrian9.olap.MondrianProperties#StatisticsProviders "mondrian9.statistics.providers"}
 * property.</p>
 *
 * @see mondrian9.spi.impl.JdbcStatisticsProvider
 * @see mondrian9.spi.impl.SqlStatisticsProvider
 *
 */
