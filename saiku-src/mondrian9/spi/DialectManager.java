...
import mondrian9.spi.impl.JdbcDialectFactory;
import mondrian9.spi.impl.JdbcDialectImpl;
import mondrian9.util.ClassResolver;
import mondrian9.util.ServiceDiscovery;

/**
 * Manages {@link mondrian9.spi.Dialect} and {@link mondrian9.spi.DialectFactory}
 * objects.
 *
 * @author jhyde
 * @since Jan 13, 2009
...
public abstract class DialectManager {
    ...
    /**
     * Implementation class for {@link mondrian9.spi.DialectManager}.
     *
    ...
    private static class DialectManagerImpl {
         ...
         * {@link mondrian9.util.ServiceDiscovery} for more details.)
         */
        DialectManagerImpl() {
    ...
    /**
     * Implementation of {@link mondrian9.spi.DialectFactory} that caches
     * dialects based on data source.
     *
     * @see mondrian9.spi.Dialect#allowsDialectSharing()
     */
