...
import mondrian9.calc.impl.BetterExpCompiler;
import mondrian9.olap.*;
import mondrian9.olap.type.Type;
import mondrian9.util.CreationException;
import mondrian9.util.ObjectFactory;

import java.util.List;

/**
 * Mediates the compilation of an expression ({@link mondrian9.olap.Exp})
...
public interface ExpCompiler {
     ...
     *
     * <p>See {@link #compileList(mondrian9.olap.Exp)}.
     *
     * @param exp Expression
     ...
     *   {@link #compileString(mondrian9.olap.Exp)}
