...
/**
 * Abstract implementation of the {@link mondrian9.calc.ListCalc} interface.
 *
 * <p>The derived class must
 * implement the {@link #evaluateList(mondrian9.olap.Evaluator)} method, and the {@link
 * #evaluate(mondrian9.olap.Evaluator)} method will call it.
 *
 * @author jhyde
 * @since Sep 27, 2005
 */
