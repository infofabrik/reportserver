 ...
 * {@link mondrian9.calc.impl.ValueCalc}; see also {@link mondrian9.calc.impl.TupleValueCalc}.
 *
 * @author jhyde
 * @since Sep 27, 2005
 */
public class MemberValueCalc extends GenericCalc {
     ...
     * {@link MemberValueCalc#create(mondrian9.olap.Exp,
     * mondrian9.calc.MemberCalc[], boolean)}
     * factory method.
     *
