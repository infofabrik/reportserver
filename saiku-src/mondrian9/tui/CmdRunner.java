...
import mondrian9.olap.Connection;
import mondrian9.olap.DriverManager;
import mondrian9.olap.fun.FunInfo;
...
public class CmdRunner {
    ...
    public Expr parseParameter(String value) {
        ...
        } else if (element instanceof mondrian9.olap.Level) {
            mondrian9.olap.Level level = (mondrian9.olap.Level) element;
    ...
    /**
     * Gets a connection to mondrian9.
     *
...
*/
    ...
    protected static void usage(String msg, PrintStream out) {
        ...
        buf.append(
            "Usage: mondrian9.tui.CmdRunner args"
            + nl
            + "  args:"
            + nl
    ...
    private static void setDefaultCommentState() {
        allowNestedComments = mondrian9.olap.Scanner.getNestedCommentsState();
        String[][] scannerCommentsDelimiters =
            mondrian9.olap.Scanner.getCommentDelimiters();
