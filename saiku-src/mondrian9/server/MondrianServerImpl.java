...
/**
 * Implementation of {@link mondrian9.olap.MondrianServer}.
 *
 * @author jhyde
 * @since Jun 25, 2006
 */
    ...
    private void registerMBean() {
        ...
        try {
            ObjectName mxbeanName = new ObjectName(
                "mondrian9.server:type=Server-" + id);
