...
import mondrian9.mdx.*;
import mondrian9.olap.*;
import mondrian9.olap.Member;
import mondrian9.olap.fun.MondrianEvaluationException;
import mondrian9.rolap.*;
import mondrian9.util.Bug;
import mondrian9.xmla.XmlaHandler;
...
public abstract class MondrianOlap4jConnection implements OlapConnection {
     ...
     */
    final Map<mondrian9.olap.Schema, MondrianOlap4jSchema> schemaMap =
        new HashMap<mondrian9.olap.Schema, MondrianOlap4jSchema>();
        ...
        throws SQLException
    {
        ...
        this.mondrianConnection =
            (RolapConnection) mondrian9.olap.DriverManager
    ...
    MondrianOlap4jCube toOlap4j(mondrian9.olap.Cube cube) {
        MondrianOlap4jSchema schema = toOlap4j(cube.getSchema());
        return new MondrianOlap4jCube(cube, schema);
    }

    MondrianOlap4jDimension toOlap4j(mondrian9.olap.Dimension dimension) {
        if (dimension == null) {
            return null;
        }
    ...
    Type toOlap4j(mondrian9.olap.type.Type type) {
        if (type instanceof mondrian9.olap.type.BooleanType) {
            return new BooleanType();
        } else if (type instanceof mondrian9.olap.type.CubeType) {
            final mondrian9.olap.Cube mondrianCube =
                ((mondrian9.olap.type.CubeType) type).getCube();
            return new CubeType(toOlap4j(mondrianCube));
        } else if (type instanceof mondrian9.olap.type.DecimalType) {
            mondrian9.olap.type.DecimalType decimalType =
                (mondrian9.olap.type.DecimalType) type;
            return new DecimalType(
                decimalType.getPrecision(),
                decimalType.getScale());
        } else if (type instanceof mondrian9.olap.type.DimensionType) {
            mondrian9.olap.type.DimensionType dimensionType =
                (mondrian9.olap.type.DimensionType) type;
            return new DimensionType(
                toOlap4j(dimensionType.getDimension()));
        } else if (type instanceof mondrian9.olap.type.HierarchyType) {
            return new BooleanType();
        } else if (type instanceof mondrian9.olap.type.LevelType) {
            return new BooleanType();
        } else if (type instanceof mondrian9.olap.type.MemberType) {
            final mondrian9.olap.type.MemberType memberType =
                (mondrian9.olap.type.MemberType) type;
        ...
        } else if (type instanceof mondrian9.olap.type.NullType) {
            return new NullType();
        } else if (type instanceof mondrian9.olap.type.NumericType) {
            return new NumericType();
        } else if (type instanceof mondrian9.olap.type.SetType) {
            final mondrian9.olap.type.SetType setType =
                (mondrian9.olap.type.SetType) type;
            return new SetType(toOlap4j(setType.getElementType()));
        } else if (type instanceof mondrian9.olap.type.StringType) {
            return new StringType();
        } else if (type instanceof mondrian9.olap.type.TupleType) {
            mondrian9.olap.type.TupleType tupleType =
                (mondrian9.olap.type.TupleType) type;
            final Type[] types = toOlap4j(tupleType.elementTypes);
            return new TupleType(types);
        } else if (type instanceof mondrian9.olap.type.SymbolType) {
    ...
    MondrianOlap4jMember toOlap4j(mondrian9.olap.Member member) {
        if (member == null) {
            return null;
        }
    ...
    MondrianOlap4jLevel toOlap4j(mondrian9.olap.Level level) {
        if (level == null) {
            return null;
        }
    ...
    MondrianOlap4jHierarchy toOlap4j(mondrian9.olap.Hierarchy hierarchy) {
        if (hierarchy == null) {
            return null;
        }
    ...
    Type[] toOlap4j(mondrian9.olap.type.Type[] mondrianTypes) {
    ...
    MondrianOlap4jNamedSet toOlap4j(
        mondrian9.olap.Cube cube,
        mondrian9.olap.NamedSet namedSet)
    {
        if (namedSet == null) {
            return null;
        }
    ...
    static class Helper {
            ...
            String msg, Throwable cause)
        {
            ...
            assert !mondrian9.util.Bug.olap4jUpgrade(
    ...
    private static class MondrianToOlap4jNodeConverter {
        ...
        private org.olap4j.mdx.Syntax toOlap4j(mondrian9.olap.Syntax syntax) {
