...
import mondrian9.rolap.RolapMeasure;
    ...
    implements Member, Named
{
    ...
    MondrianOlap4jMember(
        ...
        mondrian9.olap.Member mondrianMember)
    {
        ...
        throws OlapException
    {
        ...
        final List<mondrian9.olap.Member> children =
            Locus.execute(
                conn,
                "MondrianOlap4jMember.getChildMembers",
                new Locus.Action<List<mondrian9.olap.Member>>() {
                    public List<mondrian9.olap.Member> execute() {
                        return
    ...
    public MondrianOlap4jMember getParentMember() {
        final mondrian9.olap.Member parentMember = member.getParentMember();
    ...
    public Member getDataMember() {
        final mondrian9.olap.Member dataMember = member.getDataMember();
        if (dataMember == null) {
            return null;
        }
    ...
    public boolean isVisible() {
        return (Boolean) member.getPropertyValue(
            mondrian9.olap.Property.VISIBLE.getName());
    }
