...
class MondrianOlap4jProperty implements IMondrianOlap4jProperty, Named {
    ...
    static {
        ...
        for (mondrian9.olap.Property o
            : mondrian9.olap.Property.enumeration.getValuesSortedByName())
        {
    ...
    final mondrian9.olap.Property property;

    MondrianOlap4jProperty(mondrian9.olap.Property property) {
        this.property = property;
    }

    mondrian9.olap.Level level;

    MondrianOlap4jProperty
        (mondrian9.olap.Property property, mondrian9.olap.Level level) {
        this(property);
        this.level = level;
    }
    ...
    public mondrian9.olap.Level getLevel() {
        return level;
    }
