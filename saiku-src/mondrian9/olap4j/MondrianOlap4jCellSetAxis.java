...
import mondrian9.rolap.RolapAxis;
...
class MondrianOlap4jCellSetAxis implements CellSetAxis {
    ...
    private final mondrian9.olap.QueryAxis queryAxis;
    ...
    MondrianOlap4jCellSetAxis(
        ...
        mondrian9.olap.QueryAxis queryAxis,
        RolapAxis axis)
    {
        ...
        public List<Member> getMembers() {
            return new AbstractList<Member>() {
                public Member get(int slice) {
                    final mondrian9.olap.Member mondrianMember =
