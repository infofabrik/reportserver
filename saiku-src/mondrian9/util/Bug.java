 ...
 * <dl>
 *
 * <dt>Obsolete {@link mondrian9.olap.Id.Segment}</dt>
 * <dd>Replace it by {@link org.olap4j.mdx.IdentifierSegment}. Likewise
 * {@link mondrian9.olap.Id.Quoting} with {@link org.olap4j.mdx.Quoting}.
...
public class Bug {
     ...
     * {@link mondrian9.olap.MondrianProperties#SsasCompatibleNaming},
     ...
     * {@link mondrian9.spi.Dialect.DatabaseProduct#LUCIDDB} and we wish to
     * avoid slow tests.
     *
     ...
     * {@code mondrian9.test.PerforceTest} logger set at
    ...
    public static boolean avoidSlowTestOnLucidDB(Dialect dialect) {
        return
            ...
            && !LogManager.getLogger("mondrian9.test.PerformanceTest")
                .isDebugEnabled();
    }
}
