...
/**
 * Utilities to generate MondrianProperties.java and mondrian9.properties
...
public class PropertyUtil {
    ...
    private void generate(String[] args) {
        ...
        final File propertiesFile =
            new File("target/mondrian9.properties.template");
    ...
    enum Generator {
        JAVA {
                ...
                PrintWriter out)
            {
                ...
                out.println("package mondrian9.olap;");
                out.println();
                ...
                String[] lines = {
                    ...
                    "     * plus the contents of \"mondrian9.properties\" if it",
                    "     * exists. A singleton.",
                    "     */",
