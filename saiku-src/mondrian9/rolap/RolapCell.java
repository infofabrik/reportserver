...
import mondrian9.olap.fun.SetFunDef;
import mondrian9.resource.MondrianResource;
import mondrian9.rolap.agg.*;
...
/**
 * <code>RolapCell</code> implements {@link mondrian9.olap.Cell} within a
 * {@link RolapResult}.
 */
public class RolapCell implements Cell {
    /**
     * @see mondrian9.util.Bug#olap4jUpgrade Use
     * {@link mondrian9.xmla.XmlaConstants}.ActionType.DRILLTHROUGH when present
     */
