 ...
 * Each call that modifies state (such as {@link mondrian9.olap.Evaluator#setContext(mondrian9.olap.Member)}) creates, at
...
public class RolapEvaluator implements Evaluator {
  ...
  /**
   * More specific version of {@link #getContext(mondrian9.olap.Hierarchy)}, for internal code.
   *
   * @param hierarchy
   *          Hierarchy
   ...
   * @param eval
   *          Evaluator
   * @throws mondrian9.olap.fun.MondrianEvaluationException
   *           if there is a loop
   */
