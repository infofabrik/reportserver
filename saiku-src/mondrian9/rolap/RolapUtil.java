...
import mondrian9.server.*;
import mondrian9.spi.Dialect;
import mondrian9.util.ClassResolver;
...
/**
 * Utility methods for classes in the <code>mondrian9.rolap</code> package.
 *
 * @author jhyde
 * @since 22 December, 2001
 */
public class RolapUtil {
    public static final Logger MDX_LOGGER = LogManager.getLogger("mondrian9.mdx");
    public static final Logger SQL_LOGGER = LogManager.getLogger("mondrian9.sql");
    public static final Logger MONITOR_LOGGER =
        LogManager.getLogger("mondrian9.server.monitor");
    public static final Logger PROFILE_LOGGER =
        LogManager.getLogger("mondrian9.profile");
     ...
     * {@link #setHook(mondrian9.rolap.RolapUtil.ExecuteQueryHook)} are
     ...
     * {@link mondrian9.calc.Calc#dependsOn(Hierarchy)} are accurate.
     */
