...
import mondrian9.calc.ParameterSlot;
import mondrian9.calc.TupleCollections;
import mondrian9.calc.TupleCursor;
import mondrian9.calc.TupleIterable;
import mondrian9.calc.TupleIterator;
import mondrian9.calc.TupleList;
import mondrian9.calc.impl.CacheCalc;
import mondrian9.calc.impl.DelegatingTupleList;
import mondrian9.calc.impl.GenericCalc;
import mondrian9.calc.impl.ListTupleList;
import mondrian9.calc.impl.ValueCalc;
import mondrian9.mdx.DimensionExpr;
import mondrian9.mdx.HierarchyExpr;
import mondrian9.mdx.MdxVisitorImpl;
import mondrian9.mdx.MemberExpr;
import mondrian9.mdx.ResolvedFunCall;
import mondrian9.olap.Axis;
import mondrian9.olap.Cell;
import mondrian9.olap.Dimension;
import mondrian9.olap.DimensionType;
import mondrian9.olap.Evaluator;
import mondrian9.olap.Exp;
import mondrian9.olap.ExpCacheDescriptor;
import mondrian9.olap.Hierarchy;
import mondrian9.olap.Member;
import mondrian9.olap.MemberBase;
import mondrian9.olap.MondrianProperties;
import mondrian9.olap.NamedSet;
import mondrian9.olap.Parameter;
import mondrian9.olap.Position;
import mondrian9.olap.Property;
import mondrian9.olap.Query;
import mondrian9.olap.QueryAxis;
import mondrian9.olap.ResultBase;
import mondrian9.olap.ResultLimitExceededException;
import mondrian9.olap.SchemaReader;
import mondrian9.olap.Util;
import mondrian9.olap.fun.AbstractAggregateFunDef;
import mondrian9.olap.fun.AggregateFunDef;
import mondrian9.olap.fun.MondrianEvaluationException;
import mondrian9.olap.fun.VisualTotalsFunDef.VisualTotalMember;
...
import mondrian9.rolap.agg.AggregationManager;
import mondrian9.rolap.agg.CellRequestQuantumExceededException;
import mondrian9.server.Execution;
import mondrian9.server.Locus;
import mondrian9.spi.CellFormatter;
import mondrian9.util.CancellationChecker;
import mondrian9.util.Format;
import mondrian9.util.ObjectPool;
...
public class RolapResult extends ResultBase {
  ...
  /**
   * A FormatValueFormatter takes a {@link Locale} as a parameter and uses it to get the {@link mondrian9.util.Format} to
  ...
  public class CompoundSlicerRolapMember extends DelegatingRolapMember implements RolapMeasure {
    ...
    public boolean isOnSameHierarchyChainInternal( MemberBase member2 ) {
      ...
      int index = -1;
      for ( List<mondrian9.olap.Member> subList : tupleList ) {
        if ( index == -1 ) {
