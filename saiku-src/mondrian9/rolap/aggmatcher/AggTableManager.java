...
// All Rights Reserved.
*/
package mondrian9.rolap.aggmatcher;
...
import mondrian9.olap.Util.PropertyList;
import mondrian9.recorder.ListRecorder;
import mondrian9.recorder.MessageRecorder;
import mondrian9.recorder.RecorderException;
 ...
 * <li>A {@link mondrian9.rolap.RolapSchema} creates an {@link AggTableManager},
 *     and stores it in a member variable to ensure that it is not
 *     garbage-collected.
 * <li>The {@link mondrian9.rolap.RolapSchema} calls {@link #initialize(PropertyList)},
...
*/
     ...
     * {@link mondrian9.rolap.aggmatcher.ExplicitRules.Group} in every
