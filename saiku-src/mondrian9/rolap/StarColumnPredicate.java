...
public interface StarColumnPredicate extends StarPredicate {
     ...
     * {@link #toSql(mondrian9.rolap.sql.SqlQuery, StringBuilder)}.
     *
     * <p>todo: remove this method when
     * {@link mondrian9.util.Bug#BugMondrian313Fixed bug MONDRIAN-313} and
     * {@link mondrian9.util.Bug#BugMondrian314Fixed bug MONDRIAN-314} are fixed.
     */
    StarColumnPredicate cloneWithColumn(RolapStar.Column column);

    /**
     * Returned by
     * {@link mondrian9.rolap.StarColumnPredicate#intersect},
