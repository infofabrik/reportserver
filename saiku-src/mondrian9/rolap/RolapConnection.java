...
import mondrian9.parser.MdxParserValidator;
import mondrian9.resource.MondrianResource;
import mondrian9.server.*;
import mondrian9.spi.*;
import mondrian9.spi.impl.JndiDataSourceResolver;
 ...
 * {@link DriverManager#getConnection(String, mondrian9.spi.CatalogLocator)}.
...
public class RolapConnection extends ConnectionBase {
  ...
  /**
   * Returns the instance of the {@link mondrian9.spi.DataSourceResolver}
   * plugin.
   *
   ...
   * {@link mondrian9.olap.Util.PropertyList connectInfo}.
   *
   ...
   *                                        the property file
   * @deprecated Use {@link #execute(mondrian9.server.Execution)}; this method
