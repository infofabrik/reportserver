...
import mondrian9.rolap.sql.SqlConstraint;
import mondrian9.util.Pair;

/**
 * Uses a {@link mondrian9.rolap.cache.SmartCache} to store lists of members,
 * where the key depends on a {@link mondrian9.rolap.sql.SqlConstraint}.
 *
 * <p>Example 1:
 *
 * <pre>
 ...
 * cacheKey of the {@link mondrian9.rolap.sql.SqlConstraint}.
 *
 * @see mondrian9.rolap.sql.SqlConstraint#getCacheKey
 *
 * @author av
 * @since Nov 21, 2005
 */
