...
public class RolapHierarchy extends HierarchyBase {
    ...
    MemberReader createMemberReader(Role role) {
        ...
        case CUSTOM:
            ...
            case PARTIAL:
                Type memberType1 =
                    new mondrian9.olap.type.MemberType(
                        getDimension(),
                        this,
                        null,
                        null);
     ...
     * {@link mondrian9.olap.MondrianDef.Closure} element
     ...
     * As part of {@link mondrian9.util.Bug#BugSegregateRolapCubeMemberFixed},
     * maybe make {@link mondrian9.rolap.RolapCubeMember} an interface.
     *
     * @see mondrian9.olap.Role.RollupPolicy
     */
