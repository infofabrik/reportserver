...
import mondrian9.rolap.aggmatcher.AggTableManager;
import mondrian9.spi.*;
import mondrian9.spi.impl.Scripts;
import mondrian9.util.ByteString;
...
public class RolapSchema implements Schema {
     ...
     * that has
     * {@link mondrian9.rolap.RolapConnectionProperties#Ignore Ignore}=true.
     */
  ...
  @Deprecated
     ...
     * (see {@link mondrian9.rolap.RolapConnectionProperties#Ignore}), adds
     ...
     *   The class must implement {@link mondrian9.spi.UserDefinedFunction}
