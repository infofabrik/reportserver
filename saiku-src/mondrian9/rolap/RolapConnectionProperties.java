...
public enum RolapConnectionProperties {
  ...
  /**
   * The "Role" property is the name of the {@link mondrian9.olap.Role role}
   ...
   * {@link mondrian9.spi.DynamicSchemaProcessor} interface.
  ...
  /**
   * The name of a class implementing the
   * {@link mondrian9.spi.DataSourceChangeListener} interface.
   ...
   * {@link mondrian9.olap.Schema#getWarnings}.
   */
  Ignore,
