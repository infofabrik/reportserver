...
// All Rights Reserved.
*/
package mondrian9.rolap.agg;

import org.apache.logging.log4j.Logger;

import mondrian9.olap.Member;
import mondrian9.olap.MondrianProperties;
import mondrian9.olap.MondrianServer;
import mondrian9.olap.Util;
import mondrian9.olap.CacheControl.CellRegion;
import mondrian9.resource.MondrianResource;
import mondrian9.rolap.CacheControlImpl;
import mondrian9.rolap.RolapSchema;
import mondrian9.rolap.RolapStar;
import mondrian9.rolap.RolapStoredMeasure;
import mondrian9.rolap.RolapUtil;
import mondrian9.rolap.SchemaKey;
import mondrian9.rolap.cache.MemorySegmentCache;
import mondrian9.rolap.cache.SegmentCacheIndex;
import mondrian9.rolap.cache.SegmentCacheIndexImpl;
import mondrian9.server.Execution;
import mondrian9.server.Locus;
import mondrian9.server.monitor.CellCacheEvent;
import mondrian9.server.monitor.CellCacheSegmentCreateEvent;
import mondrian9.server.monitor.CellCacheSegmentDeleteEvent;
import mondrian9.server.monitor.Monitor;
import mondrian9.spi.SegmentBody;
import mondrian9.spi.SegmentCache;
import mondrian9.spi.SegmentColumn;
import mondrian9.spi.SegmentHeader;
import mondrian9.util.BlockingHashMap;
import mondrian9.util.MDCUtil;
import mondrian9.util.Pair;
 ...
 * and "external cache" (as implemented by a {@link mondrian9.spi.SegmentCache}.
 *
 * <p>Segment states</p>
 *
 * <table>
 ...
 *
 * <p>3. Delete {@link mondrian9.rolap.RolapStar#lookupOrCreateAggregation}
 * and {@link mondrian9.rolap.RolapStar#lookupSegment}
 * and {@link mondrian9.rolap.RolapStar}.lookupAggregationShared
 ...
 *
 * <p>1. {@link mondrian9.rolap.RolapStar#getCellFromCache} moved from
 ...
 * mondrian9.rolap.agg.enableCacheHitCounters.</p>
 *
 ...
 * mondrian9.spi. Leave behind dependencies on mondrian9.rolap.agg. In particular,
 ...
 *
 * <p>8. Longer term. Move {@link mondrian9.rolap.RolapStar.Bar}.segmentRefs to
 * {@link mondrian9.server.Execution}. Would it still be thread-local?</p>
 *
 * <p>10. Call
 * {@link mondrian9.spi.DataSourceChangeListener#isAggregationChanged}.
 ...
 * {@link mondrian9.rolap.agg.SegmentBuilder.SegmentConverter} is a hack that
 ...
 * {@link mondrian9.rolap.agg.SegmentCacheManager#peek}.</p>
 *
 ...
 * copying.</p>
 *
 * <p>21. Obsolete {@link mondrian9.util.CombiningGenerator}.</p>
 *
 * <p>22. {@link SegmentHeader#constrain(mondrian9.spi.SegmentColumn[])} is
...
public class SegmentCacheManager {
  ...
  public final ExecutorService cacheExecutor =
    Util.getExecutorService(
      ...
      MondrianProperties.instance()
        .SegmentCacheManagerNumberCacheThreads.get(),
      1,
      "mondrian9.rolap.agg.SegmentCacheManager$cacheExecutor",
      ( r, executor ) -> {
  ...
  public final ExecutorService sqlExecutor =
    Util.getExecutorService(
      ...
      MondrianProperties.instance()
        .SegmentCacheManagerNumberSqlThreads.get(),
      1,
      "mondrian9.rolap.agg.SegmentCacheManager$sqlExecutor",
      ( r, executor ) -> {
        throw MondrianResource.instance()
  ...
  public SegmentCacheManager( MondrianServer server ) {
    ...
    actor = new Actor();
    thread = new Thread(
      actor, "mondrian9.rolap.agg.SegmentCacheManager$ACTOR" );
  ...
  private abstract static class Event implements Message {
    ...
    /**
     * Dispatches a call to the appropriate {@code visit} method on {@link mondrian9.server.monitor.Visitor}.
     *
  ...
  /**
   * Copy-pasted from {@link mondrian9.server.monitor.Monitor}. Consider abstracting common code.
   */
