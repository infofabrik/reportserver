...
import mondrian9.olap.fun.VisualTotalsFunDef;
import mondrian9.server.Locus;
import mondrian9.spi.PropertyFormatter;
    ...
    implements RolapMember
{
     ...
     * {@link mondrian9.olap.CacheControl#createMoveCommand}.
     *
     ...
     * {@link mondrian9.olap.fun.FunUtil#compareHierarchically}.
     *
     ...
     * {@link mondrian9.olap.MondrianProperties#PropertyValueMapFactoryClass}
     * is not set.
     */
        ...
        implements PropertyValueMapFactory
    {
         ...
         * {@link mondrian9.olap.Member}</p> have additional properties
         * that aren't explicitly declared.  The most common offenders
         * are the (@link mondrian9.olap.Measure} implementations, which
