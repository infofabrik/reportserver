 ...
 *
 * @author jhyde
 * @see mondrian9.xmla.RowsetDefinition
 * @since May 2, 2003
 */
abstract class Rowset implements XmlaConstants {
     ...
     * {@link mondrian9.xmla.Rowset.Row} object.
     *
     * @param row Row
     ...
     *
     * <p>A condition is a {@link mondrian9.olap.Util.Functor1} whose return
     * type is boolean.
     *
     ...
     * {@link mondrian9.xmla.Rowset.Row}.
     */
