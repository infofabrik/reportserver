...
public interface TeamSpaceService {
   ...
   /**
    * Retrieves the primary {@link TeamSpace} of the current user if this is
    * explicitely set.
    * 
    * @return The primary {@link TeamSpace} of the current user if this is
    *         explicitely set.
    */
    ...
    * 
    * @return A {@link Collection} of the {@link TeamSpace} owned by the current
    *         user
    */
    ...
    * 
    * @param user The {@link User}
    * @return A {@link Collection} of the {@link TeamSpace}s owned by the given
    *         {@link User}
    */
   ...
   /**
    * Merges the given {@link TeamSpace} with the representation in the database
   ...
   /**
    * Merges the given {@link TeamSpaceMember} with the representation in the
   ...
   /**
    * Merges the given {@link TeamSpaceApp} with the representation in the database
    * and returns the result.
    * 
    ...
    * 
    * @return true if the current user is a global {@link TeamSpace} admin; false
    *         otherwise
    */
    ...
    * 
    * @param user The {@link User}
    * @return true if the given {@link User} is a global {@link TeamSpace} admin;
    *         false otherwise
    */
    ...
    * @return true if the current user is a manager of the given {@link TeamSpace};
    *         false otherwise
    */
    ...
    * @param user      The {@link User}
    * @param teamSpace The {@link TeamSpace}
    * @return true if the given {@link User} is a manager of the given
    *         {@link TeamSpace}; false otherwise
    */
    ...
    * 
    * @param teamSpace The {@link TeamSpace}
    * @return true if the current user is a guest in the given {@link TeamSpace};
    *         false otherwise
    */
    ...
    * 
    * @param teamSpace The {@link TeamSpace}
    * @return true if the given {@link User} is a guest in the given
    *         {@link TeamSpace}; false otherwise
    */
    ...
    * 
    * @param teamSpace The {@link TeamSpace}
    * @return true if the current user is a user of the given {@link TeamSpace};
    *         false otherwise
    */
    ...
    * 
    * @param teamSpace The {@link TeamSpace}
    * @return true if the given {@link User} is a user of the given
    *         {@link TeamSpace}; false otherwise
    */
    ...
    * 
    * @param teamSpace The {@link TeamSpace}
    * @return true if the current user is an admin of the given {@link TeamSpace};
    *         false otherwise
    */
    ...
    * @param user      The {@link User}
    * @param teamSpace The {@link TeamSpace}
    * @return true if the given {@link User} is an admin of the given
    *         {@link TeamSpace}; false otherwise
    */
   boolean isAdmin(User user, TeamSpace teamSpace);

   /**
    * Tests if the given {@link User} has the given {@link TeamSpaceRole} on the
    * given {@link TeamSpace}
    * 
    * @param user       The {@link User}
    * @param teamSpace  The {@link TeamSpace}
    * @param roleToHave The {@link TeamSpaceRole} to test
    * @return true if the {@link User} has the {@link TeamSpaceRole}; false
    *         otherwise
    */
   boolean hasRole(User user, TeamSpace teamSpace, TeamSpaceRole roleToHave);

   /**
    * Tests if the current user has the given {@link TeamSpaceRole} on the given
    * {@link TeamSpace}
    * 
    * @param teamSpace  The {@link TeamSpace}
    * @param roleToHave The {@link TeamSpaceRole} to test
    * @return true if the current user has the {@link TeamSpaceRole}; false
    *         otherwise
    */
    ...
    * 
    * @param teamSpace The {@link TeamSpace}
    * @return true if the current user has the right to access the given
    *         {@link TeamSpace}; false otherwise
    */
   public boolean mayAccess(TeamSpace teamSpace);

   /**
    * Tests if the given {@link User} has the right to access the given
    * {@link TeamSpace}
    * 
    * @param user      The {@link User}
    * @param teamSpace The {@link TeamSpace}
    * @return true if the {@link User} has the right to access the given
    *         {@link TeamSpace}; false otherwise
    */
