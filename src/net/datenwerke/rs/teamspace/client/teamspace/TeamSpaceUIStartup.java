...
public class TeamSpaceUIStartup {
   ...
   @Inject
   public TeamSpaceUIStartup(final WaitOnEventUIService waitOnEventService, final TeamSpaceDao rpcService,
         ...
         final EventBus eventBus, final Provider<TeamSpaceMainComponent> teamSpaceMainComponentProvider,
            ...
            new SynchronousCallbackOnEventTrigger() {
               ...
               public void execute(final WaitOnEventTicket ticket) {
                  if (securityService.hasRight(TeamSpaceGenericTargetIdentifier.class, ReadDto.class)) {
                     ...
                     hookHandler.attachHooker(TeamSpaceEditDialogHook.class, editTeamSpaceBasicSettingsProvider,
               ...
               public void execute(final WaitOnEventTicket ticket) {
                  if (teamSpaceServiceProvider.get().isGlobalTsAdmin())
                     hookHandler.attachHooker(AdminModuleProviderHook.class,
                           new AdminModuleProviderHook(teamSpaceAdminModuleProvider.get()),
