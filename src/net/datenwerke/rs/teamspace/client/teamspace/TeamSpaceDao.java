...
public class TeamSpaceDao extends Dao {
   ...
   @Inject
   public TeamSpaceDao(TeamSpaceRpcServiceAsync rpcService) {
   ...
   public void reloadTeamSpace(TeamSpaceDto teamSpace, AsyncCallback<TeamSpaceDto> callback) {
      rpcService.reloadTeamSpace(teamSpace, transformAndKeepCallback(callback));
   }

   public void createNewTeamSpace(TeamSpaceDto dummySpace, AsyncCallback<TeamSpaceDto> callback) {
   ...
   public void setMembers(TeamSpaceDto teamSpace, Collection<StrippedDownTeamSpaceMemberDto> members,
