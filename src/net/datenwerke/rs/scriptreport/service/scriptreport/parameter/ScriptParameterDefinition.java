...
@Audited
@GenerateDto(dtoPackage = "net.datenwerke.rs.scriptreport.client.scriptreport.parameters.dto", displayTitle = "ScriptReportMessages.INSTANCE.scriptParameterText()", additionalImports = ScriptReportMessages.class)
