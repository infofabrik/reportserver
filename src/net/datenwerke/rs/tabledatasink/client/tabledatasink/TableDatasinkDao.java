...
import net.datenwerke.rs.tabledatasink.client.tabledatasink.rpc.TableDatasinkRpcServiceAsync;

public class TableDatasinkDao extends Dao implements HasDefaultDatasink {

   private final TableDatasinkRpcServiceAsync rpcService;

   @Inject
   public TableDatasinkDao(TableDatasinkRpcServiceAsync rpcService) {
