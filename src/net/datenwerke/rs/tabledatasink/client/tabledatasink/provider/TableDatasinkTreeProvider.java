package net.datenwerke.rs.tabledatasink.client.tabledatasink.provider;
...
public class TableDatasinkTreeProvider implements Provider<ManagerHelperTree> {
   ...
   @Inject
   public TableDatasinkTreeProvider(TreeDBUIService treeDBUIService, DatasinkTreeLoaderDao datasinkTreeLoader,
