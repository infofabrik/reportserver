...
@Audited
@Indexed
@TreeDBAllowedChildren({ Report.class,

      ReportFolder.class })
@TreeDBDeniedChildren(ReportVariant.class)
@GenerateDto(dtoPackage = "net.datenwerke.rs.core.client.reportmanager.dto", dtoImplementInterfaces = FolderDto.class, poso2DtoPostProcessors = ReportFolder2DtoPostProcessor.class, typeDescriptionMsg = BaseMessages.class, typeDescriptionKey = "folder", additionalFields = {
      @AdditionalField(name = "isReportRoot", type = Boolean.class) })
@InstanceDescription(msgLocation = ReportManagerMessages.class, objNameKey = "folderTypeName",
