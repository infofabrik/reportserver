...
public class ReportDtoServiceImpl implements ReportDtoService {
   ...
   @Inject
   public ReportDtoServiceImpl(ReportService reportService, Provider<DtoService> dtoServiceProvider,
   ...
   /**
    * The reference Report of a reportdto is either the corresponding report if its
    * a base report or the parent ..
    */
   @Override
   ...
   /**
    * Loads a DTO that can be used to execute a report. This message is safe to
    * call from within DTO generation.
    * 
    */
   @Override
