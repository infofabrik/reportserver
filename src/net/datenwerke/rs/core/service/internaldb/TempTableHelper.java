...
public class TempTableHelper {
   ...
   /**
    * Returns the table for an existing table alias. To generate a fresh table on a
    * new alias use {@link #getTableName(ConnectionPoolConfig, String)}
    * 
    * @param tableAlias
    */
   ...
   private List<String> getMatchingTablesForCleanup(Connection connection, int uptoRev) throws SQLException {
      ...
      ResultSet res = connection.getMetaData().getTables(connection.getCatalog(), null, null,
