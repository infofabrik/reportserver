...
public class DatasourceContainerProviderImpl implements DatasourceContainerProvider {

   private DatasourceContainer datasourceContainer;

   public DatasourceContainerProviderImpl(DatasourceContainer datasourceContainer) {
      super();
