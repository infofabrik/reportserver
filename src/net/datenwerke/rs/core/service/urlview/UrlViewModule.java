...
public class UrlViewModule extends AbstractModule {
   ...
   @UrlViewConfig
   @Inject
   public Map<String, Map<String, List<String[]>>> providerConfig(AuthenticatorService authenticatorService,
         ConfigService configService, HookHandlerService hookHandler, RemoteMessageService remoteMessageService,
         LocalizationServiceImpl localizationService, Provider<SimpleJuel> simpleJuelProvider) {
