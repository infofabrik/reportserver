...
public abstract class TreePanelHistoryUrlBuilderHooker implements HistoryUrlBuilderHook {
   ...
   public List<HistoryLink> buildLinksFor(Object o) {
      ...
      HistoryLocation loc = new HistoryLocation(getTokenName(),
            HistoryLocation.makeParameter(TreeDBHistoryCallback.HISTORY_PARAMETER_TREE_PATH, path));
