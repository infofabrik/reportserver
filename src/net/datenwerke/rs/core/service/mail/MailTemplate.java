...
public class MailTemplate {
   ...
   public void configureMail(SimpleMail mail, SimpleJuel juel, SimpleAttachment... attachments) {

      getDataMap().entrySet().stream().forEach(e -> juel.addReplacement(e.getKey(), e.getValue()));
