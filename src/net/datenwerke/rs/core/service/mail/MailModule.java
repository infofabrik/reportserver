 ...
 * 
 * <h1>Description</h1> The mail module provides simple classes and methods for
...
public class MailModule extends AbstractReportServerModule {
   ...
   @Provides
   @Inject
   public Session provideSession(@MailModuleProperties Configuration config, @MailModuleSMTPHost String host,
         @MailModuleSMTPPort Integer port, @MailModuleUseAuthentication boolean useAuth,
