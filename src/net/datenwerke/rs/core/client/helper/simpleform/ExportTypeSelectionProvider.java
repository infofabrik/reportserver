...
public class ExportTypeSelectionProvider extends FormFieldProviderHookImpl {
   ...
   public boolean doConsumes(Class<?> type, SimpleFormFieldConfiguration... configs) {
      return ExportTypeSelection.class.equals(type) && null != configs && configs.length > 0
            && configs[0] instanceof SFFCExportTypeSelector;
   }
      ...
      formatConfigBtn.addSelectHandler(new SelectHandler() {
         ...
         public void onSelect(SelectEvent event) {
            ...
            if (null != radio && exporterMap.containsKey(radio)) {
               ...
               exporter.displayConfiguration(config.getReport(), config.getExecuteReportToken(), false,
