...
public class ReportSelectionDialog extends WestPropertiesDialog {
   ...
   @Inject
   public ReportSelectionDialog(HookHandlerService hookHandler) {
   ...
   public void initRepositories(final Optional<ReportDto> selectedReport, final RepositoryProviderConfig... configs) {
      hookHandler.getHookers(ReportSelectionRepositoryProviderHook.class)
            .forEach(hooker -> hooker.addCards(this, selectedReport, configs));
   }
   ...
   public Menu getContextMenuFor(ReportContainerDto dto, ReportSelectionRepositoryProviderHook hooker, Object... info) {
      if (null != eventHandler)
