...
public class FullTreeProvider implements Provider<ManagerHelperTree> {
   ...
   @Inject
   public FullTreeProvider(HookHandlerService hookHandler,

         FolderAndReportTreeProvider basicTreeProvider, ReportManagerTreeManagerDao reportManagerTreeHandler,
         ReportManagerMainPanel mainPanel, HistoryUiService historyService) {
