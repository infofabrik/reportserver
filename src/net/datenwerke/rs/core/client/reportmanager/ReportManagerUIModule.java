...
public class ReportManagerUIModule extends AbstractGinModule {
   ...
   protected void configure() {
      ...
      bind(UITree.class).annotatedWith(ReportManagerTreeFoldersAndReports.class)
            .toProvider(FolderAndReportTreeProvider.class);
      bind(UITree.class).annotatedWith(ReportManagerAdminViewTree.class).toProvider(FullTreeProvider.class)
            .in(Singleton.class);
