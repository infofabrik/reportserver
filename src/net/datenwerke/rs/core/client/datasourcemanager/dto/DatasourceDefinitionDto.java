...
abstract public class DatasourceDefinitionDto extends AbstractDatasourceManagerNodeDto {
	...
	public static final String PROPERTY_KEY = "dpi-datasourcedefinition-key";

	private transient static PropertyAccessor<DatasourceDefinitionDto, String> key_pa = new PropertyAccessor<DatasourceDefinitionDto, String>() {
		@Override
		public void setValue(DatasourceDefinitionDto container, String object) {
	...
	public void setKey(String key)  {
		...
		this.fireObjectChangedEvent(DatasourceDefinitionDtoPA.INSTANCE.key(), oldValue);
	}
	...
	public static PropertyAccessor<DatasourceDefinitionDto, String> getKeyPropertyAccessor()  {
		return key_pa;
	}
