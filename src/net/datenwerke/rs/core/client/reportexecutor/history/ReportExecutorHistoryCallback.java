...
public class ReportExecutorHistoryCallback implements HistoryCallback {
   ...
   @Inject
   public ReportExecutorHistoryCallback(ReportExecutorDao reportExecutorDao, ReportExecutorUIService executorService,
         TeamSpaceDao teamSpaceDao, TsDiskTreeLoaderDao diskDao) {
                  ...
                  return new VariantStorerConfig() {
                     ...
                     public VariantStorerHandleServerCalls getServerCallHandler() {
                        return new VariantStorerHandleServerCalls() {
                           ...
                           @Override
                           public void createNewVariant(ReportDto report, TeamSpaceDto teamSpace,
                                 TsDiskFolderDto folder, String executeToken, String name, String description,
                                 AsyncCallback<ReportDto> callback) {
                              executorService.createNewVariant(report, teamSpace, folder, executeToken, name,
