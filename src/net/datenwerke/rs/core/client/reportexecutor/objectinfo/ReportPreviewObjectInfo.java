 ...
 *
 */
public class ReportPreviewObjectInfo implements UrlViewSpecialViewHandler {

   private final ReportExecutorUIService reportExecutorService;
   private final ReportExecutorDao reDao;

   @Inject
   public ReportPreviewObjectInfo(ReportExecutorUIService reportExecutorService, ReportExecutorDao reDao) {
