...
public class ReportExecutorDao extends Dao {
   ...
   @Inject
   public ReportExecutorDao(ReportExecutorRpcServiceAsync rpcService, HookHandlerService hookHandler) {
      super();
      this.rpcService = rpcService;
      this.hookHandler = hookHandler;
   }

   public void createNewVariant(ReportDto reportVariantDto, String executeToken, String title, String description,
   ...
   public Request executeAs(String format, String executeToken, ReportDto report, DwModel config,
   ...
   public void editVariant(ReportDto reportVariantDto, String executeToken, String title, String description,
         AsyncCallback<ReportDto> callback) {
      reportVariantDto = unproxy(reportVariantDto);
   ...
   public void loadFullReportForExecution(ReportDto report, boolean handleFailuresMyself,
         AsyncCallback<ReportDto> callback) {
   ...
   public void loadReportForExecutionFrom(HistoryLocation location, AsyncCallback<ReportDto> callback) {
