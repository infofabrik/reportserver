...
public class ExportExternalButtonHooker implements ReportExecutorViewToolbarHook {
								...
								if(null == config.getForm() && ! config.isSelectFormat())
									...
									submit.addSelectHandler(new SelectHandler() {
										...
										public void onSelect(SelectEvent event) {
											...
											Map<String, String> values = null == detailForm ? new HashMap<String, String>() : detailForm.getStringValueMap();
	...
	protected void sendTo(ReportDto report,
			...
			List<ReportExecutionConfigDto> formatConfig, Map<String, String> values, String executorToken, final ReportExecutorMainPanel mainPanel) {
