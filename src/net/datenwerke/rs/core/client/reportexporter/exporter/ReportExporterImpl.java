...
public abstract class ReportExporterImpl implements ReportExporter {
   ...
   @Override
   public final Request prepareExportForPreview(final ReportDto report, final String executorToken,
   ...
   protected Request doExport(ReportDto report, String executorToken, AsyncCallback<Void> callback) {
      return exporterDao.storeInSessionForExport(report, executorToken, getOutputFormat(), getConfiguration(),
            callback);
   }
      ...
      RsAsyncCallback<Void> callback = new RsAsyncCallback<Void>() {
         ...
         public void onSuccess(Void result) {
            InfoConfig infoConfig = new DefaultInfoConfig(
                  ReportExporterMessages.INSTANCE.reportSuccessfullyExportedTitle(),
