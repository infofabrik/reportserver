...
public abstract class ParameterConfiguratorImpl<D extends ParameterDefinitionDto, I extends ParameterInstanceDto>
      implements ParameterConfigurator<D, I> {
   ...
   @Override
   public final Widget getEditComponentForInstance(I instance, D definition,
         Collection<ParameterInstanceDto> relevantInstances, boolean initial, int labelWidth, String executeReportToken,
         ReportDto report) {
      return doGetEditComponentForInstance(instance, relevantInstances, definition, initial, labelWidth,
            executeReportToken, report);
   }

   protected abstract Widget doGetEditComponentForInstance(I instance,
         Collection<ParameterInstanceDto> relevantInstances, D definition, boolean initial, int labelWidth,
         String executeReportToken, ReportDto report);
   ...
   protected boolean isParameterValueSelected(D definition, I instance, Widget widget) {
      return true;
   }
