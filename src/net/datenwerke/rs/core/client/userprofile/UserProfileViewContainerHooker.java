...
public class UserProfileViewContainerHooker extends UserProfileCardProviderHookImpl {
   ...
   protected void submitConsecutively(UserProfileViewContentHook next,
         final Iterator<UserProfileViewContentHook> hookerIterator, final SubmitTrackerToken outerToken) {
