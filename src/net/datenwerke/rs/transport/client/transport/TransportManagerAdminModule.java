 ...
 *
 */
public class TransportManagerAdminModule implements AdminModule {

   private final Provider<TransportManagerAdminPanel> mainWidgetProvider;

   @Inject
   public TransportManagerAdminModule(Provider<TransportManagerAdminPanel> mainWidgetProvider) {
