...
import net.datenwerke.rs.transport.service.transport.entities.dtogen.TransportFolder2DtoGenerator;
import net.datenwerke.rs.utils.misc.StringEscapeUtils;
import org.apache.commons.lang3.StringUtils;

/**
 * Poso2DtoGenerator for TransportFolder
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class TransportFolder2DtoGenerator implements Poso2DtoGenerator<TransportFolder,TransportFolderDto> {
	...
	@Inject
	public TransportFolder2DtoGenerator(
	...
	public TransportFolderDto instantiateDto(TransportFolder poso)  {
		TransportFolderDto dto = new TransportFolderDto();
	...
	public TransportFolderDto createDto(TransportFolder poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final TransportFolderDto dto = new TransportFolderDto();
		dto.setDtoView(here);
