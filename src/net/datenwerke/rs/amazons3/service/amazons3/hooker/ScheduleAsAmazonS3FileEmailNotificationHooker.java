...
public class ScheduleAsAmazonS3FileEmailNotificationHooker extends SchedulerExecutionHookAdapter {
   ...
   private static final Map<String, String> PROPERTIES = new HashMap<String, String>() {
      ...
      {
         put(DatasinkModule.PROPERTY_SUBJECT, "scheduler.fileactionAmazonS3.subject");
         put(DatasinkModule.PROPERTY_TEXT, "scheduler.fileactionAmazonS3.text");
         put(DatasinkModule.PROPERTY_DISABLED, "scheduler.fileactionAmazonS3[@disabled]");
         put(DatasinkModule.PROPERTY_HTML, "scheduler.fileactionAmazonS3[@html]");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_SUBJECT, "fileactionAmazonS3MsgSubject");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_TEXT, "fileactionAmazonS3MsgText");
      }
   };
   ...
   @Inject
   public ScheduleAsAmazonS3FileEmailNotificationHooker(
