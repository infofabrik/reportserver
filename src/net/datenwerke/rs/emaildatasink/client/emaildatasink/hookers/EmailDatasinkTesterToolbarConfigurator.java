...
public class EmailDatasinkTesterToolbarConfigurator implements MainPanelViewToolbarConfiguratorHook {

   final DatasinksMessages messages = GWT.create(DatasinksMessages.class);

   private final ToolbarService toolbarUtils;
   private final EmailDatasinkDao emailDatasinkDao;

   @Inject
   public EmailDatasinkTesterToolbarConfigurator(ToolbarService toolbarUtils, EmailDatasinkDao emailDatasinkDao) {
      this.toolbarUtils = toolbarUtils;
      this.emailDatasinkDao = emailDatasinkDao;
   }
   ...
   public void mainPanelViewToolbarConfiguratorHook_addLeft(MainPanelView view, ToolBar toolbar,
      ...
      if (!(view instanceof SimpleFormView))
         return;
      if (!(selectedNode instanceof EmailDatasinkDto))
         return;
