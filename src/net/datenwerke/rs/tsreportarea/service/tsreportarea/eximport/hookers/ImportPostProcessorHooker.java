 ...
 *
 */
public class ImportPostProcessorHooker implements HttpImportPostProcessProviderHook {
   ...
   @Inject
   public ImportPostProcessorHooker(TeamSpaceService teamSpaceService, TsDiskService favoriteService) {
   ...
   @Override
   public void postProcess(ImportPostProcessConfigDto config, ImportResult result) {
