...
public interface TsDiskService extends TreeDBManager<AbstractTsDiskNode> {
   ...
   /**
    * Returns a {@link List} of {@link AbstractTsDiskNode}s representing the root
    * folders of {@link TeamSpace} favorites.
    * 
   ...
   /**
    * Returns a {@link List} of all existing {@link TsDiskReportReference}s for the
   ...
   /**
    * Returns the {@link TeamSpace} which holds the given
    * {@link AbstractTsDiskNode}
    * 
    ...
    * {@link Report} mapped to their paths in the respective {@link TeamSpace}. The
    * path is returned as a list of {@link AbstractTsDiskNode}s.
    * 
    * @param report The {@link Report}
    * @return The mapping between {@link TeamSpace}s and paths for the given
    *         report.
    */
   Map<TeamSpace, List<List<AbstractTsDiskNode>>> getTeamSpacesWithPathsThatLinkTo(Report report);

   /**
    * Returns the path which contains the given {@link AbstractTsDiskNode} as a
