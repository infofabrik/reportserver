...
public class MenuRenameHooker implements TsFavoriteMenuHook {
   ...
   @Inject
   public MenuRenameHooker(TsDiskTreeManagerDao treeManagerDao, TeamSpaceUIService teamSpaceService) {
   ...
   protected void displayChangeNameDialog(final AbstractTsDiskNodeDto node, final TsDiskMainComponent mainComponent) {
      ...
      final ValueProvider nameProp = (node instanceof TsDiskFolderDto) ? TsDiskFolderDtoPA.INSTANCE.name()
      ...
      final String nameKey = form.addField(String.class, nameProp, BaseMessages.INSTANCE.name(), new SFFCAllowBlank() {
         @Override
      ...
      final ValueProvider descProp = (node instanceof TsDiskFolderDto) ? TsDiskFolderDtoPA.INSTANCE.description()
      ...
      final String descriptionKey = form.addField(String.class, descProp, BaseMessages.INSTANCE.propertyDescription(),
      ...
      submitBtn.addSelectHandler(new SelectHandler() {
         ...
         public void onSelect(SelectEvent event) {
            ...
            treeManagerDao.updateName(node, true, (String) form.getValue(nameKey),
                  (String) form.getValue(descriptionKey), new RsAsyncCallback<AbstractNodeDto>() {
                     @Override
