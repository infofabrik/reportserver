...
public class MenuExportHooker implements TsFavoriteMenuHook {
   ...
   @Inject
   public MenuExportHooker(ReportExporterUIService reportExporterService, TeamSpaceUIService teamSpaceService,
         ReportExecutorDao reportExecutorDao, ReportManagerTreeLoaderDao reportLoaderDao) {
