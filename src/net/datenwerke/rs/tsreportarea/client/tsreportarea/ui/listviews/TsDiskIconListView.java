...
public class TsDiskIconListView implements TsFavoriteListViewHook {
   ...
   public TsDiskListView getListView(final TsDiskMainComponent mainComponent) {
      ...
      ListViewCustomAppearance<AbstractTsDiskNodeDto> appearance = new ListViewCustomAppearance<AbstractTsDiskNodeDto>(
            "." + style.thumbWrap(), style.over() + " rs-teamspace-lv-over", style.select()) {
         @Override
      ...
      final ListView<AbstractTsDiskNodeDto, AbstractTsDiskNodeDto> listView = new ListView<AbstractTsDiskNodeDto, AbstractTsDiskNodeDto>(
            mainComponent.getListStore(), new IdentityValueProvider<AbstractTsDiskNodeDto>(), appearance);
      ...
      listView.setCell(
            new SimpleSafeHtmlCell<AbstractTsDiskNodeDto>(new AbstractSafeHtmlRenderer<AbstractTsDiskNodeDto>() {
               @Override
      ...
      if (mainComponent.allowDrag()) {
         ListViewDragSource<AbstractTsDiskNodeDto> dragSource = new ListViewDragSource<AbstractTsDiskNodeDto>(
               listView) {
         ...
         ListViewDropTarget<AbstractTsDiskNodeDto> dropTarget = new ListViewDropTarget<AbstractTsDiskNodeDto>(
               listView) {
