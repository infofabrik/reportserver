...
import net.datenwerke.rs.eximport.client.eximport.im.hookers.ImportMergeOptionsHooker;
...
public class ImportUIStartup {
   ...
   public ImportUIStartup(final HookHandlerService hookHandler, final WaitOnEventUIService waitOnEventService,
         ...
         final Provider<ImportMergeOptionsHooker> importMergeOptionsHooker) {

      hookHandler.attachHooker(ImporterPostProcessorConfiguratorHook.class, importMergeOptionsHooker, HookHandlerService.PRIORITY_HIGH + 20);
