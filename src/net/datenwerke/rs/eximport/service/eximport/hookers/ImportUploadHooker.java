...
public class ImportUploadHooker implements FileUploadHandlerHook {
   ...
   @Inject
   public ImportUploadHooker(Provider<SecurityService> securityServiceProvider,
         Provider<HttpImportService> httpImportServiceProvider, Provider<ZipUtilsService> zipUtilsProvider
