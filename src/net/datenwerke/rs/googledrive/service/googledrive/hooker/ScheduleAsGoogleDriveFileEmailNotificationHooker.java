...
public class ScheduleAsGoogleDriveFileEmailNotificationHooker extends SchedulerExecutionHookAdapter {
   ...
   private static final Map<String, String> PROPERTIES = new HashMap<String, String>() {
      ...
      {
         put(DatasinkModule.PROPERTY_SUBJECT, "scheduler.fileactionGoogleDrive.subject");
         put(DatasinkModule.PROPERTY_TEXT, "scheduler.fileactionGoogleDrive.text");
         put(DatasinkModule.PROPERTY_DISABLED, "scheduler.fileactionGoogleDrive[@disabled]");
         put(DatasinkModule.PROPERTY_HTML, "scheduler.fileactionGoogleDrive[@html]");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_SUBJECT, "fileactionGoogleDriveMsgSubject");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_TEXT, "fileactionGoogleDriveMsgText");
      }
   };
   ...
   @Inject
   public ScheduleAsGoogleDriveFileEmailNotificationHooker(
