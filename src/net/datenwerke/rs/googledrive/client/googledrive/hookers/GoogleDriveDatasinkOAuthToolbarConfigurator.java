...
public class GoogleDriveDatasinkOAuthToolbarConfigurator implements MainPanelViewToolbarConfiguratorHook {
   ...
   @Inject
   public GoogleDriveDatasinkOAuthToolbarConfigurator(ToolbarService toolbarUtils, GoogleDriveDao googleDriveDao,
         OAuthDao oAuthDao, UtilsUIService utilsUiService) {
   ...
   private void displayAuthorizationDialog(final GoogleDriveDatasinkDto googleDriveDatasinkDto) {

      oAuthDao.generateAuthenticationUrl(googleDriveDatasinkDto, new RsAsyncCallback<OAuthAuthenticationUriInfo>() {
         @Override
