...
public class GoogleDriveDatasinkTesterToolbarConfigurator implements MainPanelViewToolbarConfiguratorHook {
   ...
   @Inject
   public GoogleDriveDatasinkTesterToolbarConfigurator(ToolbarService toolbarUtils, GoogleDriveDao googleDriveDao) {
   ...
   public void mainPanelViewToolbarConfiguratorHook_addLeft(MainPanelView view, ToolBar toolbar,
      ...
      testBtn.addSelectHandler(event -> {
         ...
         Request request = googleDriveDao.testGoogleDriveDatasink((GoogleDriveDatasinkDto) selectedNode,
