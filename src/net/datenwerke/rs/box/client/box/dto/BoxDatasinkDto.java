...
/**
 * Dto for {@link BoxDatasink}
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class BoxDatasinkDto extends DatasinkDefinitionDto {
	...
	public static final String PROPERTY_APP_KEY = "dpi-boxdatasink-appkey";

	private transient static PropertyAccessor<BoxDatasinkDto, String> appKey_pa = new PropertyAccessor<BoxDatasinkDto, String>() {
		@Override
		public void setValue(BoxDatasinkDto container, String object) {
			container.setAppKey(object);
		}

		@Override
		public String getValue(BoxDatasinkDto container) {
		...
		@Override
		public void setModified(BoxDatasinkDto container, boolean modified) {
			container.appKey_m = modified;
		}

		@Override
		public boolean isModified(BoxDatasinkDto container) {
	...
	public static final String PROPERTY_FOLDER = "dpi-boxdatasink-folder";

	private transient static PropertyAccessor<BoxDatasinkDto, String> folder_pa = new PropertyAccessor<BoxDatasinkDto, String>() {
		@Override
		public void setValue(BoxDatasinkDto container, String object) {
	...
	public static final String PROPERTY_REFRESH_TOKEN = "dpi-boxdatasink-refreshtoken";

	private transient static PropertyAccessor<BoxDatasinkDto, String> refreshToken_pa = new PropertyAccessor<BoxDatasinkDto, String>() {
		@Override
		public void setValue(BoxDatasinkDto container, String object) {
	...
	public static final String PROPERTY_SECRET_KEY = "dpi-boxdatasink-secretkey";

	private transient static PropertyAccessor<BoxDatasinkDto, String> secretKey_pa = new PropertyAccessor<BoxDatasinkDto, String>() {
		@Override
		public void setValue(BoxDatasinkDto container, String object) {
	...
	public static final String PROPERTY_HAS_REFRESH_TOKEN = "dpi-boxdatasink-hasrefreshtoken";

	private transient static PropertyAccessor<BoxDatasinkDto, Boolean> hasRefreshToken_pa = new PropertyAccessor<BoxDatasinkDto, Boolean>() {
		@Override
		public void setValue(BoxDatasinkDto container, Boolean object) {
			container.setHasRefreshToken(object);
		}

		@Override
		public Boolean getValue(BoxDatasinkDto container) {
	...
	public static final String PROPERTY_HAS_SECRET_KEY = "dpi-boxdatasink-hassecretkey";

	private transient static PropertyAccessor<BoxDatasinkDto, Boolean> hasSecretKey_pa = new PropertyAccessor<BoxDatasinkDto, Boolean>() {
		@Override
		public void setValue(BoxDatasinkDto container, Boolean object) {
	...
	public void setAppKey(String appKey)  {
		...
		this.fireObjectChangedEvent(BoxDatasinkDtoPA.INSTANCE.appKey(), oldValue);
	}
	...
	public static PropertyAccessor<BoxDatasinkDto, String> getAppKeyPropertyAccessor()  {
		return appKey_pa;
	}
	...
	public void setFolder(String folder)  {
		...
		this.fireObjectChangedEvent(BoxDatasinkDtoPA.INSTANCE.folder(), oldValue);
	}
	...
	public static PropertyAccessor<BoxDatasinkDto, String> getFolderPropertyAccessor()  {
		return folder_pa;
	}
	...
	public void setRefreshToken(String refreshToken)  {
		...
		this.fireObjectChangedEvent(BoxDatasinkDtoPA.INSTANCE.refreshToken(), oldValue);
	}
	...
	public static PropertyAccessor<BoxDatasinkDto, String> getRefreshTokenPropertyAccessor()  {
	...
	public void setSecretKey(String secretKey)  {
		...
		this.fireObjectChangedEvent(BoxDatasinkDtoPA.INSTANCE.secretKey(), oldValue);
	}
	...
	public static PropertyAccessor<BoxDatasinkDto, String> getSecretKeyPropertyAccessor()  {
		return secretKey_pa;
	}
	...
	public void setHasRefreshToken(Boolean hasRefreshToken)  {
		...
		this.fireObjectChangedEvent(BoxDatasinkDtoPA.INSTANCE.hasRefreshToken(), oldValue);
	}
	...
	public static PropertyAccessor<BoxDatasinkDto, Boolean> getHasRefreshTokenPropertyAccessor()  {
	...
	public void setHasSecretKey(Boolean hasSecretKey)  {
		...
		this.fireObjectChangedEvent(BoxDatasinkDtoPA.INSTANCE.hasSecretKey(), oldValue);
	}
	...
	public static PropertyAccessor<BoxDatasinkDto, Boolean> getHasSecretKeyPropertyAccessor()  {
	...
	public boolean equals(Object obj)  {
		if(! (obj instanceof BoxDatasinkDto))
			return false;

		if(null == getId())
			return super.equals(obj);
		return getId().equals(((BoxDatasinkDto)obj).getId());
	}
	...
	public static Dto2PosoMapper newPosoMapper()  {
		return new BoxDatasinkDto2PosoMap();
	}

	public BoxDatasinkDtoPA instantiatePropertyAccess()  {
		return GWT.create(BoxDatasinkDtoPA.class);
	}
