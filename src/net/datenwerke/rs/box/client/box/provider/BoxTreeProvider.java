package net.datenwerke.rs.box.client.box.provider;
...
public class BoxTreeProvider implements Provider<ManagerHelperTree> {
   ...
   @Inject
   public BoxTreeProvider(TreeDBUIService treeDBUIService, DatasinkTreeLoaderDao datasinkTreeLoader,
   ...
   public ManagerHelperTree get() {
      /* store */
      List<Dto2PosoMapper> filters = Arrays.asList(new DatasinkFolderDto2PosoMap(), new BoxDatasinkDto2PosoMap());
