...
public class ScheduleAsBoxFileEmailNotificationHooker extends SchedulerExecutionHookAdapter {
   ...
   private static final Map<String, String> PROPERTIES = new HashMap<String, String>() {
      ...
      {
         put(DatasinkModule.PROPERTY_SUBJECT, "scheduler.fileactionBox.subject");
         put(DatasinkModule.PROPERTY_TEXT, "scheduler.fileactionBox.text");
         put(DatasinkModule.PROPERTY_DISABLED, "scheduler.fileactionBox[@disabled]");
         put(DatasinkModule.PROPERTY_HTML, "scheduler.fileactionBox[@html]");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_SUBJECT, "fileactionBoxMsgSubject");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_TEXT, "fileactionBoxMsgText");
      }
   };
   ...
   @Inject
   public ScheduleAsBoxFileEmailNotificationHooker(
