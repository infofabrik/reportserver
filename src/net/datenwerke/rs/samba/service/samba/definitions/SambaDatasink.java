...
/**
 * Used to define Samba datasinks that can be used in ReportServer to send reports
 * to a given Samba server.
 */
@Entity
...
@Indexed
public class SambaDatasink extends DatasinkDefinition implements BasicDatasink {
