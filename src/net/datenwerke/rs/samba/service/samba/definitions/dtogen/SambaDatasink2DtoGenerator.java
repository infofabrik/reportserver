...
import net.datenwerke.rs.samba.service.samba.definitions.dtogen.SambaDatasink2DtoGenerator;
import net.datenwerke.rs.utils.misc.StringEscapeUtils;
import org.apache.commons.lang3.StringUtils;

/**
 * Poso2DtoGenerator for SambaDatasink
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class SambaDatasink2DtoGenerator implements Poso2DtoGenerator<SambaDatasink,SambaDatasinkDto> {
	...
	private final net.datenwerke.rs.samba.service.samba.definitions.dtogen.SambaDatasink2DtoPostProcessor postProcessor_3;
	private final Provider<DtoService> dtoServiceProvider;

	@Inject
	public SambaDatasink2DtoGenerator(
		...
		net.datenwerke.rs.samba.service.samba.definitions.dtogen.SambaDatasink2DtoPostProcessor postProcessor_3	){
	...
	public SambaDatasinkDto instantiateDto(SambaDatasink poso)  {
		SambaDatasinkDto dto = new SambaDatasinkDto();
	...
	public SambaDatasinkDto createDto(SambaDatasink poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final SambaDatasinkDto dto = new SambaDatasinkDto();
		dto.setDtoView(here);
		...
		if(here.compareTo(DtoView.NORMAL) >= 0){
			/*  set domain */
			dto.setDomain(StringEscapeUtils.escapeXml(StringUtils.left(poso.getDomain(),8192)));
