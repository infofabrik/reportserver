...
public class ScheduleAsSambaFileAction extends AbstractAction {
    ...
    public void execute(AbstractJob job) throws ActionExecutionException {
        ...
        if (! sambaService.isSambaEnabled() || ! sambaService.isSambaSchedulingEnabled())
        ...
        try {
            sambaService.sendToSambaServer(compiledReport.getReport(), sambaDatasink, filename, folder);
        } catch (Exception e) {
