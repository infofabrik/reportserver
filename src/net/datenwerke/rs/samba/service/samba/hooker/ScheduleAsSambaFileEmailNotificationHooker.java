...
public class ScheduleAsSambaFileEmailNotificationHooker extends SchedulerExecutionHookAdapter {
   ...
   private static final Map<String, String> PROPERTIES = new HashMap<String, String>() {
      ...
      {
         put(DatasinkModule.PROPERTY_SUBJECT, "scheduler.fileactionSamba.subject");
         put(DatasinkModule.PROPERTY_TEXT, "scheduler.fileactionSamba.text");
         put(DatasinkModule.PROPERTY_DISABLED, "scheduler.fileactionSamba[@disabled]");
         put(DatasinkModule.PROPERTY_HTML, "scheduler.fileactionSamba[@html]");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_SUBJECT, "fileactionSambaMsgSubject");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_TEXT, "fileactionSambaMsgText");
      }
   };
   ...
   @Inject
   public ScheduleAsSambaFileEmailNotificationHooker(
