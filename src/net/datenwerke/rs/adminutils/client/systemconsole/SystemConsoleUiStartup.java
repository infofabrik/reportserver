...
public class SystemConsoleUiStartup {
   ...
   @Inject
   public SystemConsoleUiStartup(final HookHandlerService hookHandler, final WaitOnEventUIService waitOnEventService,
         final SecurityUIService securityService, final Provider<SystemConsoleAdminModule> adminModuleProvider,
   ...
   private void installAdminHooker() {
      if (enterpriseService.isEnterprise()
            && securityService.hasRight(SystemConsoleGenericTargetIdentifier.class, ReadDto.class))
