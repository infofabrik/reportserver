...
public class BirtHelper {
   ...
   @Inject
   public BirtHelper(BirtReportService reportService, DatasourceTransformationService datasourceTransformationService) {
   ...
   public IExtractionResults getDataSetData(BirtReport bReport, DataSetHandle dataSetHandle, ParameterSet parameters)
...
//		Connection connection = dataSourceTransformer.transform(bReport, parameters);
   ...
   public Collection<IParameterSelectionChoice> getParameterSelectionList(IParameterDefn parameterDefinition,
         ParameterSet parameters) throws BirtException {
      IGetParameterDefinitionTask task = reportService.getReportEngine().createGetParameterDefinitionTask(reportDesign);
