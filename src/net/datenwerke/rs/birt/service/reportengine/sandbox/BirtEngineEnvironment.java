...
public class BirtEngineEnvironment implements Callable<CompiledRSBirtReport> {
   ...
   @Inject
   public BirtEngineEnvironment(@Assisted IReportEngine reportEngine, @Assisted byte[] reportBytes,
         @Assisted ParameterSet parameters, @Assisted @Nullable Connection connection, @Assisted String outputFormat,
         @Assisted BirtOutputGenerator outputGenerator, @Assisted ReportExecutionConfig[] configs,
               ...
               if (parameterValue instanceof List) {
                  ...
                  if (null != parameterInstance && parameterInstance instanceof DatasourceParameterInstance) {
                     ...
                     if (parameterInstance.getDefinition().isEditable() && !parameterInstance.isStillDefault()) {
                        ...
                        selectedValue = ((DatasourceParameterInstance) parameterInstance)
                              .getMultiDefaultValue(parameters);
                     }
                  ...
                  if (null != parameterInstance && parameterInstance instanceof DatasourceParameterInstance) {
                     ...
                     if (parameterInstance.getDefinition().isEditable() && !parameterInstance.isStillDefault()) {
                        ...
                        selectedValue = ((DatasourceParameterInstance) parameterInstance)
                              .getSingleDefaultValue(parameters);
                     }
                     if (null != selectedValue) {
