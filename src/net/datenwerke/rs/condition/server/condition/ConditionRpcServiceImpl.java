...
@Singleton
public class ConditionRpcServiceImpl extends SecuredRemoteServiceServlet implements ConditionRpcService {
   ...
   @Inject
   public ConditionRpcServiceImpl(ConditionService conditionService, DtoService dtoService,
   ...
   @Override
   public List<String> getReplacementsFor(ReportConditionDto conditionDto) throws ServerCallFailedException {
