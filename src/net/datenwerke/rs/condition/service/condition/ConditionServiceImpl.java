...
public class ConditionServiceImpl implements ConditionService {
   ...
   @Inject
   public ConditionServiceImpl(Provider<EntityManager> entityManagerFactory, Provider<SimpleJuel> juelProvider,
         Provider<AuthenticatorService> authServiceProvider, ReportExecutorService reportExecutor,
   ...
   protected boolean executeCondition(ReportCondition condition, String expression, User user)
      ...
      RSTableModel data = (RSTableModel) reportExecutor.execute(report, user,
