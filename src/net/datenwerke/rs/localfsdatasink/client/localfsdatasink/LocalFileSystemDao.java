...
public class LocalFileSystemDao extends Dao {
   ...
   public void exportIntoLocalFileSystem(ReportDto reportDto, String executorToken,
      ...
      rpcService.exportIntoLocalFileSystem(reportDto, executorToken, localFileSystemDatasinkDto, format, configs,
            name, folder, transformAndKeepCallback(callback));
   }
