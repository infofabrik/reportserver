package net.datenwerke.rs.localfsdatasink.client.localfsdatasink.provider;
...
public class LocalFileSystemTreeProvider implements Provider<ManagerHelperTree> {
   ...
   @Inject
   public LocalFileSystemTreeProvider(TreeDBUIService treeDBUIService, DatasinkTreeLoaderDao datasinkTreeLoader,
