...
public class ScheduleConfigAsLocalFileSystemHooker implements ScheduleConfigProviderHook {
   ...
   @Inject
   public ScheduleConfigAsLocalFileSystemHooker(DtoService dtoService,
         Provider<ScheduleAsLocalFileSystemFileAction> actionProvider, Provider<DtoService> dtoServiceProvider) {
   ...
   public void adaptJob(ReportExecuteJob job, ReportScheduleDefinition scheduleDTO)
      ...
      ScheduleAsLocalFileSystemInformation info = scheduleDTO
      ...
      action.setLocalFileSystemDatasink(
            (LocalFileSystemDatasink) dtoServiceProvider.get().loadPoso(info.getLocalFileSystemDatasinkDto()));
      try {
