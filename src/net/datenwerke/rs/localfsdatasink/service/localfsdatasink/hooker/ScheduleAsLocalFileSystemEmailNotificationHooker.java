...
public class ScheduleAsLocalFileSystemEmailNotificationHooker extends SchedulerExecutionHookAdapter {

   private static final Map<String, String> PROPERTIES = new HashMap<String, String>() {
      private static final long serialVersionUID = -4530850796051224912L;
      {
         put(DatasinkModule.PROPERTY_SUBJECT, "scheduler.fileactionLocalFilesystem.subject");
         put(DatasinkModule.PROPERTY_TEXT, "scheduler.fileactionLocalFilesystem.text");
         put(DatasinkModule.PROPERTY_DISABLED, "scheduler.fileactionLocalFilesystem[@disabled]");
         put(DatasinkModule.PROPERTY_HTML, "scheduler.fileactionLocalFilesystem[@html]");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_SUBJECT, "fileactionLocalFileSystemMsgSubject");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_TEXT, "fileactionLocalFileSystemMsgText");
      }
   };
   ...
   @Inject
   public ScheduleAsLocalFileSystemEmailNotificationHooker(
   ...
   public void actionExecutionEndedSuccessfully(AbstractJob abstractJob, AbstractAction abstractAction,
      ...
      if (!(abstractAction instanceof ScheduleAsLocalFileSystemFileAction))
         return;

      ReportExecuteJob job = (ReportExecuteJob) abstractJob;

      try {
         sendmail((ScheduleAsLocalFileSystemFileAction) abstractAction, job, null);
