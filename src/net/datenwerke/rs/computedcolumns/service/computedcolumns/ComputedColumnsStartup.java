...
public class ComputedColumnsStartup {
   ...
   @Inject
   public ComputedColumnsStartup(HookHandlerService hookHandler,

         Provider<BaseFunctionProvider> baseFunctionProvider, Provider<BaseFunctionToSqlProvider> baseFunctionToSql,

         Provider<ComputedColumnSqlProvider> sqlProvider,

         Provider<ArithmeticOperatorHandler> arithmeticHandler, Provider<CaseExpressionHandler> caseHandler,
         Provider<CommaSeparatorHandler> commaHandler, Provider<ConcattenationExpressionHandler> concattenationHandler,
         Provider<InExpressionHandler> inHandler, Provider<LogicalOperatorHandler> logicalOperatorHandler,
         Provider<NullHandler> nullHandler, Provider<NumberHandler> numberHandler,
         Provider<ParameterHandler> parameterHandler, Provider<ParenthesisHandler> parenthesisHandler,
         Provider<RelationHandler> relationHandler, Provider<StringHandler> stringHandler,

         Provider<ArithmeticOperatorToSql> arithmeticToSql, Provider<CaseExpressionToSql> caseExpressionToSql,
         Provider<CommaSeparatorToSql> commaSeparatorToSql, Provider<ConcattentationOperatorToSql> concattenationToSql,
         Provider<FunctionToSql> functionToSql, Provider<InToSql> inToSql,
         Provider<LogicalOperatorToSql> logicalOperatorToSql, Provider<NullToSql> nullToSql,
         Provider<NumberToSql> numberToSql, Provider<ParameterToSql> parameterToSql,
         Provider<ParenthesisToSql> parenthesisToSql, Provider<RelationToSql> relationToSql,
         Provider<StringToSql> stringToSql, Provider<VariableToSql> variableToSql,
