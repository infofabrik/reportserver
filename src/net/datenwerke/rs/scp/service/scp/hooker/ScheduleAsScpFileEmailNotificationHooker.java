...
public class ScheduleAsScpFileEmailNotificationHooker extends SchedulerExecutionHookAdapter {
   ...
   private static final Map<String, String> PROPERTIES = new HashMap<String, String>() {
      ...
      {
         put(DatasinkModule.PROPERTY_SUBJECT, "scheduler.fileactionScp.subject");
         put(DatasinkModule.PROPERTY_TEXT, "scheduler.fileactionScp.text");
         put(DatasinkModule.PROPERTY_DISABLED, "scheduler.fileactionScp[@disabled]");
         put(DatasinkModule.PROPERTY_HTML, "scheduler.fileactionScp[@html]");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_SUBJECT, "fileactionScpMsgSubject");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_TEXT, "fileactionScpMsgText");
      }
   };
   ...
   @Inject
   public ScheduleAsScpFileEmailNotificationHooker(
