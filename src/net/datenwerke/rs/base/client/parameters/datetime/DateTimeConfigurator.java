...
public class DateTimeConfigurator extends ParameterConfiguratorImpl<DateTimeParameterDefinitionDto, DateTimeParameterInstanceDto> {
	...
	@Override
	public Widget doGetEditComponentForInstance(final DateTimeParameterInstanceDto instance, Collection<ParameterInstanceDto> relevantInstances, final DateTimeParameterDefinitionDto definition, boolean initial, int labelWidth, String executeReportToken, ReportDto report) {
