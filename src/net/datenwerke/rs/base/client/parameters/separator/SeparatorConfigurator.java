 ...
 */
@Singleton
public class SeparatorConfigurator
      extends ParameterConfiguratorImpl<SeparatorParameterDefinitionDto, SeparatorParameterInstanceDto> {
   ...
   @Override
   public Widget doGetEditComponentForInstance(SeparatorParameterInstanceDto instance,
         Collection<ParameterInstanceDto> relevantInstances, final SeparatorParameterDefinitionDto definition,
