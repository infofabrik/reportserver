...
public class DatasourceConfigurator
   ...
   @Inject
   public DatasourceConfigurator(DatasourceParameterDao rpcService,
         Provider<DatasourceEditComponentForInstance> editComponentForInstanceProvider,
         DatasourceParameterUiService dsParamService, EnterpriseUiService entpriseService,
         TableReportUtilityDao tableReportDao, ToolbarService toolbarService) {
   ...
   public Widget getEditComponentForDefinition(final DatasourceParameterDefinitionDto definition,
         ...
         public DatabaseSpecificFieldConfigExecution getConfigExecution() {
            return new DatabaseSpecificFieldConfigExecution() {
               ...
               public void executeGetColumns(String query, final AsyncCallback<List<String>> callback) {
                  /* fake report */
                  DatasourceContainerDto dsContainer = (DatasourceContainerDto) form
                        .getValue(DatasourceParameterDefinitionDtoPA.INSTANCE.datasourceContainer().getPath());

                  tableReportDao.loadColumnDefinition(report, dsContainer, query, null,
                        new RsAsyncCallback<List<ColumnDto>>() {
                           @Override
         ...
         public DatabaseSpecificFieldConfigToolbar getFieldConfigToolbar() {
            return new DatabaseSpecificFieldConfigToolbar() {
               ...
               public void enhance(ToolBar toolbar, final CodeMirrorPanel codeMirrorPanel) {
                  /* add parameter */
                  DwTextButton selectParamBtn = toolbarService.createSmallButtonLeft(
                        ReportmanagerMessages.INSTANCE.selectParamBtnLabel(), BaseIcon.TABLE_ADD);
                  ...
                  menu.addBeforeShowHandler(new BeforeShowHandler() {
                     ...
                     public void onBeforeShow(BeforeShowEvent event) {
                        ...
                        final MenuItem subMenuItemReport = new DwMenuItem(
                              ReportmanagerMessages.INSTANCE.currentReport());
                        ...
                        final MenuItem subMenuItemExpressions = new DwMenuItem(
                              ReportmanagerMessages.INSTANCE.expressions());
      ...
      /* data source */
      String dataOriginDatasourceKey = form.addField(DatasourceContainerDto.class,
      ...
      if (dsParamService.isAllowPostProcessing()) {
         ...
         postProcessKey = form.addField(String.class, DatasourceParameterDefinitionDtoPA.INSTANCE.postProcess(),
               RsMessages.INSTANCE.datasourceParameterPostProcess(), new SFFCTextAreaImpl() {
                  @Override
      ...
      form.addField(Integer.class, DatasourceParameterDefinitionDtoPA.INSTANCE.height(),
      ...
      form.beginFloatRow();
      form.setFieldWidth(210);
      final String modeKey = form.addField(List.class, DatasourceParameterDefinitionDtoPA.INSTANCE.mode(),
            RsMessages.INSTANCE.seletionMode(), new SFFCStaticDropdownList<ModeDto>() {
      ...
      final String singleSelectionModeKey = form.addField(List.class,
            DatasourceParameterDefinitionDtoPA.INSTANCE.singleSelectionMode(), RsMessages.INSTANCE.singleSeletionMode(),
      ...
      final String multiSelectionModeKey = form.addField(List.class,
            DatasourceParameterDefinitionDtoPA.INSTANCE.multiSelectionMode(), RsMessages.INSTANCE.multiSeletionMode(),
      ...
      final String boxModeKey = form.addField(List.class, DatasourceParameterDefinitionDtoPA.INSTANCE.boxLayoutMode(),
            RsMessages.INSTANCE.boxLayoutMode(), new SFFCStaticDropdownList<BoxLayoutModeDto>() {
      ...
      final String boxPackModeKey = form.addField(List.class,
            DatasourceParameterDefinitionDtoPA.INSTANCE.boxLayoutPackMode(), RsMessages.INSTANCE.boxLayoutPackMode(),
      ...
      final String boxPackColSizeKey = form.addField(Integer.class,
            DatasourceParameterDefinitionDtoPA.INSTANCE.boxLayoutPackColSize(),
            RsMessages.INSTANCE.boxLayoutPackColSize());

      form.endRow();

      /* add type */
      form.setFieldWidth(210);
      final String typeKey = form.addField(List.class, DatasourceParameterDefinitionDtoPA.INSTANCE.returnType(),
            RsMessages.INSTANCE.returnType(), new SFFCStaticDropdownList<DatatypeDto>() {
               @Override
      ...
      String formatKey = form.addField(String.class, DatasourceParameterDefinitionDtoPA.INSTANCE.format(),
            RsMessages.INSTANCE.format());

      form.setFieldWidth(210);
      /* default value */
      singleDefaultValuesKey = form.addField(List.class,
            DatasourceParameterDefinitionDtoPA.INSTANCE.singleDefaultValueSimpleData(),
            RsMessages.INSTANCE.defaultValues(), new SFFCDynamicListInPopup<DatasourceParameterDataDto>() {
      ...
      form.setFieldWidth(1);
      multiDefaultValuesKey = form.addField(List.class,
      ...
      CompositeOrCondition radioCheckCond = new CompositeOrCondition(
            new CompositeAndCondition(new ComplexCondition(modeKey, new FieldEquals(ModeDto.Single)),
                  new ComplexCondition(singleSelectionModeKey, new FieldEquals(SingleSelectionModeDto.Radio))),
            new CompositeAndCondition(new ComplexCondition(modeKey, new FieldEquals(ModeDto.Multi)),
   ...
   protected ListStore<DatasourceParameterDataDto> getParameterDataStore(
         final DatasourceParameterDefinitionDto definition, final ReportDto report) {
      ...
      RpcProxy<ListLoadConfig, ListLoadResult<DatasourceParameterDataDto>> proxy = new RpcProxy<ListLoadConfig, ListLoadResult<DatasourceParameterDataDto>>() {
         ...
         public void load(ListLoadConfig loadConfig,
               final AsyncCallback<ListLoadResult<DatasourceParameterDataDto>> callback) {
            ...
            if ((null == definition.getDatasourceContainer()
                  || null == definition.getDatasourceContainer().getDatasource())
                  && (!dsParamService.isAllowPostProcessing() || null == definition.getPostProcess()
                        || "".equals(definition.getPostProcess().trim())))
               cb.onSuccess(
                     new ListLoadResultBean<DatasourceParameterDataDto>(new ArrayList<DatasourceParameterDataDto>()));
            else
               datasourceParamDao.loadDatasourceParameterData((DatasourceParameterDefinitionDto) definition, null, true,
                     report, cb);
         }
      };

      ListLoader<ListLoadConfig, ListLoadResult<DatasourceParameterDataDto>> listLoader = new ListLoader<ListLoadConfig, ListLoadResult<DatasourceParameterDataDto>>(
            proxy);
      ListStore<DatasourceParameterDataDto> store = new LoadableListStore<ListLoadConfig, DatasourceParameterDataDto, ListLoadResult<DatasourceParameterDataDto>>(
            new BasicObjectModelKeyProvider(), listLoader);
   ...
   protected void reloadDefault(final String modeKey, final String multiDefaultValuesKey,
         final String singleDefaultValuesKey, final SimpleForm form) {
   ...
   @Override
   public Widget doGetEditComponentForInstance(DatasourceParameterInstanceDto instance,
         Collection<ParameterInstanceDto> relevantInstances, DatasourceParameterDefinitionDto definition,
         boolean initial, int labelWidth, String executeReportToken, final ReportDto report) {
      /*
       * store configurator for later use -- when a parameter is redrawn due to a
       * change for example in dependent parameters this will be overwritten
       */
   ...
   public void dependeeInstanceChanged(DatasourceParameterInstanceDto instance,
         DatasourceParameterDefinitionDto aDefinition, Collection<ParameterInstanceDto> relevantInstances) {
