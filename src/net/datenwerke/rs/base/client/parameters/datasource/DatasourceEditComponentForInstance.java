...
public class DatasourceEditComponentForInstance {
	...
	public Widget getEditComponent(DatasourceParameterDefinitionDto definition, DatasourceParameterInstanceDto instance, Collection<ParameterInstanceDto> relevantInstances, int labelWidth, boolean initial, ReportDto report) {
		/* what mode */
	...
	protected Widget getEditComponent_cb(
			...
			Collection<ParameterInstanceDto> relevantInstances, boolean initial, final boolean multi, int labelWidth, ReportDto report) {
		final DwHorizontalFlowLayoutContainer container = new DwHorizontalFlowLayoutContainer();
//		container.setNobreak(false);
		
		ListLoader<ListLoadConfig, ListLoadResult<DatasourceParameterDataDto>> loader = getLoader(definition, relevantInstances, report);
	...
	protected Widget getEditComponent_lb(
		...
		final ListLoader<ListLoadConfig, ListLoadResult<DatasourceParameterDataDto>> loader = getLoader(definition, relevantInstances, report);
	...
	protected Widget getEditComponent_single(final DatasourceParameterDefinitionDto definition, final DatasourceParameterInstanceDto instance, Collection<ParameterInstanceDto> relevantInstances, boolean initial, int labelWidth, ReportDto report) {
		final ListStore<DatasourceParameterDataDto> store = new ListStore<DatasourceParameterDataDto>(new BasicObjectModelKeyProvider());
		final ListLoader<ListLoadConfig, ListLoadResult<DatasourceParameterDataDto>> loader = getLoader(definition, relevantInstances, report);
	    loader.addLoadHandler(new LoadResultListStoreBinding<ListLoadConfig, DatasourceParameterDataDto, ListLoadResult<DatasourceParameterDataDto>>(store));
	...
	protected Widget getEditComponent_popup(final DatasourceParameterDefinitionDto definition, final DatasourceParameterInstanceDto instance, final Collection<ParameterInstanceDto> relevantInstances, int labelWidth, ReportDto report) {
	 ...
	 * @param definition
	 */
	private ListLoader<ListLoadConfig, ListLoadResult<DatasourceParameterDataDto>> getLoader(final DatasourceParameterDefinitionDto definition, final Collection<ParameterInstanceDto> relevantInstances, final ReportDto report) {
