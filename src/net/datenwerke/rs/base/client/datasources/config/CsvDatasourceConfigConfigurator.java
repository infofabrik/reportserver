...
public class CsvDatasourceConfigConfigurator implements DatasourceDefinitionConfigConfigurator {
   ...
   public List<Widget> getOptionalAdditionalFormfields(DatasourceDefinitionConfigDto config,
      ...
      if (datasourceDefinitionDto instanceof CsvDatasourceDto) {
         ...
         if (connector instanceof DatasourceConnectorDtoDec) {
            ((DatasourceConnectorDtoDec) connector).addConnectorSpecificFormFields(widgets, config,
                  datasourceDefinitionDto, datasourceSelectionField, this);
         }
   ...
   public void inheritChanges(DatasourceDefinitionConfigDto config, DatasourceDefinitionDto datasourceDefinitionDto) {
      if (datasourceDefinitionDto instanceof CsvDatasourceDto) {
         DatasourceConnectorDto connector = ((CsvDatasourceDto) datasourceDefinitionDto).getConnector();
         if (connector instanceof DatasourceConnectorDtoDec) {
            ((DatasourceConnectorDtoDec) connector).inheritConnectorSpecificChanges(config, datasourceDefinitionDto,
                  this);
         }
   ...
   public boolean consumes(DatasourceDefinitionDto datasourceDefinitionDto,
      ...
      return null != datasourceConfig && datasourceConfig instanceof FormatBasedDatasourceConfigDto
            && datasourceDefinitionDto instanceof FormatBasedDatasourceDefinitionDto;
   }
