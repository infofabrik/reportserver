...
public class ColumnFormatWindow extends DwWindow {
   ...
   private SimpleForm generateForm() {
      ...
      typeKey = form.addField(List.class, FilterMessages.INSTANCE.formatTypeLabel(),
            new SFFCStaticDropdownList<FormatType>() {
      ...
      currencyKey = form.addField(List.class, FilterMessages.INSTANCE.currencySymbolLabel(),
            new SFFCEnumList(CurrencyTypeDto.class));
      ...
      final String[] allFields = new String[] { decimalPlacesKey, thousandSepKey, currencyKey, baseFormat, targetFormat,
            dateRollover, dateReplaceError, dateReplaceErrorWith, template };
      ...
      final String[] dateFields = null != column.getType() && SqlTypes.isDateLikeType(column.getType())
            ? new String[] { targetFormat }
            : new String[] { baseFormat, targetFormat, dateRollover, dateReplaceError, dateReplaceErrorWith };
      ...
      if (null != column.getFormat()) {
         ...
         if (format instanceof ColumnFormatNumberDto) {
            ...
            case SCIENTIFIC:
               ...
               break;
            default:
               form.setValue(typeKey, FormatType.NUMBER);
            }
   ...
   protected void inheritColumnFormat() {
      ...
      case NUMBER:
         ...
         ((ColumnFormatNumberDtoDec) format)
               .setNumberOfDecimalPlaces(Math.max(0, (Integer) form.getValue(decimalPlacesKey)));
