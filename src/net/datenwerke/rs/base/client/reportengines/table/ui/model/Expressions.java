...
public enum Expressions {
   IN("$X{IN, column, parameterkey}"), NOTIN("$X{NOTIN, column, parameterkey}"),
   NOTEQUAL("$X{NOTEQUAL, column, parameterkey}"), LESS("$X{LESS, column, parameterkey}"),
   LESS_EQUAL("$X{LESS], column, parameterkey}"), GREATER("$X{GREATER, column, parameterkey}"),
