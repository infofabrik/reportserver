...
public class TwoColumnGridView extends GridView<FilterRangeDto> {
   ...
   public TwoColumnGridView(ListStore<FilterRangeDto> store, ColumnDto column,
         SelectionPanel<FilterRangeDto> selectionPanel) {
   ...
   protected Grid<FilterRangeDto> createGrid(ListStore<FilterRangeDto> store) {
      ...
      ColumnConfig<FilterRangeDto, String> columnFrom = new ColumnConfig<FilterRangeDto, String>(frPa.rangeFrom(), 180,
            FilterMessages.INSTANCE.rangeFrom());
      ...
      ColumnConfig<FilterRangeDto, String> columnTo = new ColumnConfig<FilterRangeDto, String>(frPa.rangeTo(), 180,
            FilterMessages.INSTANCE.rangeTo());
