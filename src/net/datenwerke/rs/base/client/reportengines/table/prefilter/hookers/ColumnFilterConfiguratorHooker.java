...
public class ColumnFilterConfiguratorHooker implements PreFilterConfiguratorHook {
   ...
   class ExtendedColumnSelector extends ColumnSelector {
      ...
      public ExtendedColumnSelector(TableReportUtilityDao tableReportUtilityDao, TableReportDto report,
            String executeToken) {
   ...
   public void displayFilter(TableReportDto report, FilterSpecDto filter, String executeToken,
      ...
      ColumnFilterWindow mfilter = new ColumnFilterWindow(report, ((ColumnFilterDto) filter).getColumn(), executeToken,
            false, false) {
