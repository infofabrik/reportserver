...
public class JasperReportForm extends AbstractReportForm {
   ...
   @Inject
   public JasperReportForm(DatasourceUIService datasourceService, FileUploadUiService fileUploadService,
   ...
   protected void initializeForm(FormPanel form, VerticalLayoutContainer fieldWrapper) {
      ...
      masterLabel = new FieldLabel(uploadComponent,
            ReportmanagerMessages.INSTANCE.JRXMLMaster() + (null != master ? " (" + master.getName() + ")" : ""));
      ...
      selectionWidget.addSource(new FileSelectorSourceImpl() {
         ...
         public DownloadProperties getDownloadPropertiesFor(SelectedFileWrapper selectedItem) {
            ...
            DownloadProperties properties = new DownloadProperties(String.valueOf(jrxml.getId()),
                  JasperUiModule.JRXML_DOWNLOAD_HANDLER);
            return properties;
         }
