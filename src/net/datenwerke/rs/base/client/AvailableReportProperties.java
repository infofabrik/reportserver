...
public enum AvailableReportProperties {
   PROPERTY_OUTPUT_FORMAT_AUTH("output_format_auth"), PROPERTY_OUTPUT_FORMAT_DEFAULT("output_format_default"),
   ...
   PROPERTY_OUTPUT_PARAMETERS("output_parameters", true), PROPERTY_OUTPUT_FILTERS("output_filters", true),
