...
public class QueryBuilder {
   ...
   /**
    * Stores a list of vectors containing the selected columns and their respective
    * aliases
    */
   ...
   public QueryBuilder(DatabaseHelper dbHelper, Map<String, ParameterValue> parameterReplacementMap,
   ...
   public QueryBuilder(DatabaseHelper dbHelper, String innerQuery, Map<String, ParameterValue> parameterReplacementMap,
         QueryReplacementHelper queryReplacementHelper) {
      this.dbHelper = dbHelper;
   ...
   public boolean isDirty() {
      return isCountRows() || isLimit() || isOffset() || isDistinct() || columns.size() != 0 || conditions.size() != 0
            || orders.size() != 0 || (sourceTables.size() != 1
                  || (sourceTables.size() > 0 && !sourceTables.get(0).equals("(" + getInnerQuery() + ")"))) //$NON-NLS-1$ //$NON-NLS-2$
      ;
   }
   ...
   public QueryBuilder setAdditionalColumns(List<AdditionalColumnSpec> additionalColumns) {
