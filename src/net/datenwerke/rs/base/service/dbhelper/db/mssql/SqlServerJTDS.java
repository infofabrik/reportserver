 ...
 *
 */
public class SqlServerJTDS extends DatabaseHelper {

   public static final String DB_NAME = "SQL Server (Old driver, jTDS)";
   public static final String DB_DRIVER = "net.sourceforge.jtds.jdbc.Driver";
   public static final String DB_DESCRIPTOR = "DBHelper_SQL_Server_jTDS";
   public static final String DB_DESCRIPTION = "jTDS SQL Server (MSSQL) driver";
