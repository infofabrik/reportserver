...
public class TableReportIntegrityValidator implements MaintenanceTask{
	...
	private List<FilterSpec> getOrphanedFilterSpecs() {
		...
		SQLQuery query = em
				.getSession()
				.createSQLQuery(
						"SELECT A.ENTITY_ID FROM RS_FILTER_SPEC A "
						+ "LEFT OUTER JOIN ( "
	...
	protected List<FilterBlock> getOrphanedFilterBlocks() {
		...
		SQLQuery query = em
				.getSession()
				.createSQLQuery(
						"SELECT A.ENTITY_ID FROM RS_FILTER_BLOCK A "
						+ "LEFT OUTER JOIN ( "
	...
	public List<Column> getOrphanedColumns() {
		...
		SQLQuery query = em
				.getSession()
				.createSQLQuery(
						"SELECT A.ENTITY_ID FROM RS_COLUMN A "
						+ "LEFT OUTER JOIN ( "
	...
	public List<Filter> getOrphanedSapFilters() {
		...
		SQLQuery query = em
				.getSession()
				.createSQLQuery(
						"SELECT A.ENTITY_ID FROM RS_FILTER A "
						+ "LEFT OUTER JOIN ( "
	...
	public List<FilterRange> getOrphanedRanges() {
		...
		SQLQuery query = em
				.getSession()
				.createSQLQuery(
						"SELECT A.ENTITY_ID FROM RS_FILTER_RANGE A "
						+ "LEFT OUTER JOIN ( "
