...
public class ColumnDtoPost
      implements Dto2PosoPostProcessor<ColumnDto, Column>, Poso2DtoPostProcessor<Column, ColumnDto> {
   ...
   /**
    * Converts all decimal values in the supplied reports filters from the users
    * locale to the system default setting
    * 
    * @param report
    */
   ...
   /**
    * Changes all decimal numbers in filters in the given report to reflect the
    * users locale
    * 
    * @param tmpReport
    */
