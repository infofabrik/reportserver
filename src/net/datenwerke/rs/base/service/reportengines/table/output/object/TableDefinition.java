...
public class TableDefinition implements Serializable {
   ...
   public TableDefinition(List<String> columnNames, List<String> originalColumnNames, List<Class<?>> columnTypes,
         List<Integer> sqlColumnTypes) {
      super();
   ...
   private TableDefinition(List<String> columnNames, List<String> originalColumnNames, List<Class<?>> columnTypes,
         List<Integer> sqlColumnTypes, List<Integer> displaySizes) {
      super();
      this.columnNames = columnNames;
      this.originalColumnNames = originalColumnNames;
      this.columnTypes = columnTypes;
   ...
   public static TableDefinition fromResultSetMetaData(ResultSetMetaData metaData, List<Column> columns)
         throws SQLException {
      List<String> names = new ArrayList<String>();
      List<Class<?>> types = new ArrayList<Class<?>>();
      List<Integer> sqlColumnTypes = new ArrayList<Integer>();
   ...
   public List<Object[]> getColumns() {
      ...
      for (int i = 0; i < columnNames.size(); i++)
         columns.add(
               new Object[] { columnNames.get(i), columnTypes.get(i), displaySizes.get(i), sqlColumnTypes.get(i) });
   ...
   public String toString() {
      return "TableDefinition [columnNames=" + columnNames + ", columnTypes=" + columnTypes + "]";
   }
