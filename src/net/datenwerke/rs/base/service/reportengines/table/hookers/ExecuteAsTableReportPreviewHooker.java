...
public class ExecuteAsTableReportPreviewHooker implements ReportExecutorExecuteAsHooker {
   ...
   @Override
   public Dto adjustResult(ReportDto reportDto, User currentUser, Collection<ReportExecutionConfig> config,
         Object result) {
   ...
   @Override
   public ReportDto adjustReport(ReportDto report, User currentUser, String format,
         Collection<ReportExecutionConfig> config) {
      return report;
   }
