...
public class TableModelDbHelper {
   ...
   public RSTableModel selectAsRsTableModel(ConnectionPoolConfig cpc, String query)
   ...
   public int writeRsTableModel(RSTableModel rsTableModel, Connection connection, String tableName,
         OverwriteMode overwriteMode, String createTableStatement) throws DatabaseException, SQLException {
      Database db;
...
//		System.out.println(createqry);
   ...
   public int writeRsTableModel(RSTableModel rsTableModel, ConnectionPoolConfig cpc, String tableName)
         throws DatabaseException, SQLException, InterruptedException, ExecutionException {
      Connection conn = null;
      try {
         conn = (Connection) dbPoolService.getConnection(cpc).get();
   ...
   public int writeRsTableModel(RSTableModel rsTableModel, ConnectionPoolConfig cpc, String tableName,
         OverwriteMode overwriteMode, String createTableStatement)
         throws DatabaseException, SQLException, InterruptedException, ExecutionException {
      Connection conn = null;
      try {
         conn = (Connection) dbPoolService.getConnection(cpc).get();
