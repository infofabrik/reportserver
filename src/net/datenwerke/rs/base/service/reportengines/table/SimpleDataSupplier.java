...
public class SimpleDataSupplier {
   ...
   public RSTableModel getData(DatasourceContainerProvider container, Report report, User user)
         throws ReportExecutorException {
      ParameterSet parameters = parameterSetFactory.create(user, report);
      return getData(container, parameters, null, null);
   }

   public RSTableModel getData(DatasourceContainerProvider container, ParameterSet parameters)
         throws ReportExecutorException {
      return getData(container, parameters, null, null);
   }
   ...
   public int getDataCount(DatasourceContainerProvider container, ParameterSet parameters)
         throws ReportExecutorException {
      return getDataCount(container, parameters, null);
   }

   public int getDataCount(DatasourceContainerProvider container, ParameterSet parameters, TableDatasourceConfig config)
         throws ReportExecutorException {
      /* get proper datasource */
//		TableDataSource ds = dataSourceTransformerProvider.get().transform(container, parameters);
   ...
   public RSTableModel getColumnValuesPaged(DatasourceContainerProvider container, Column column, Integer offset,
         Integer length, boolean useFilters) throws ReportExecutorException {
      return getColumnValuesPaged(container, null, column, offset, length, useFilters);
   }

   public RSTableModel getColumnValuesPaged(DatasourceContainerProvider container, ParameterSet parameters,
         Column column, Integer offset, Integer length, boolean useFilters) throws ReportExecutorException {
      return getColumnValuesPaged(container, parameters, column, null, offset, length, useFilters);
   }

   public RSTableModel getColumnValuesPaged(DatasourceContainerProvider container, ParameterSet parameters,
         Column column, List<AdditionalColumnSpec> additionalColumns, Integer offset, Integer length,
         boolean useFilters) throws ReportExecutorException {
      return _getColumnValuesPaged(container, parameters, Collections.singletonList(column), additionalColumns, offset,
            length, useFilters, false, null);
   }

   public RSTableModel getColumnValuesPaged(DatasourceContainerProvider container, ParameterSet parameters,
         Column column, List<AdditionalColumnSpec> additionalColumns, Integer offset, Integer length,
         boolean useFilters, DataConsumer consumer) throws ReportExecutorException {
      return _getColumnValuesPaged(container, parameters, Collections.singletonList(column), additionalColumns, offset,
            length, useFilters, false, consumer);
   }

   public RSTableModel getColumnValuesPaged(DatasourceContainerProvider container, ParameterSet parameters,
         List<Column> columns, List<AdditionalColumnSpec> additionalColumns, Integer offset, Integer length,
         boolean useFilters) throws ReportExecutorException {
      return _getColumnValuesPaged(container, parameters, columns, additionalColumns, offset, length, useFilters, false,
            null);
   }
   ...
   public RSTableModel getDistinctColumnValuesPaged(DatasourceContainerProvider container, Column column,
         Integer offset, Integer length, boolean useFilters) throws ReportExecutorException {
      return getDistinctColumnValuesPaged(container, null, column, offset, length, useFilters);
   }

   public RSTableModel getDistinctColumnValuesPaged(DatasourceContainerProvider container, ParameterSet parameters,
         Column column, Integer offset, Integer length, boolean useFilters) throws ReportExecutorException {
   ...
   public RSTableModel getDistinctColumnValuesPaged(DatasourceContainerProvider container, ParameterSet parameters,
         Column column, List<AdditionalColumnSpec> additionalColumns, Integer offset, Integer length,
         boolean useFilters, String executeToken) throws ReportExecutorException {
      return _getColumnValuesPaged(container, parameters, Collections.singletonList(column), additionalColumns, offset,
            length, useFilters, true, null, executeToken);
   }
   ...
   public RSTableModel getDistinctColumnValuesPaged(DatasourceContainerProvider container, ParameterSet parameters,
         ...
         boolean useFilters, DataConsumer consumer) throws ReportExecutorException {
      return _getColumnValuesPaged(container, parameters, Collections.singletonList(column), additionalColumns, offset,
            length, useFilters, true, consumer);
   }

   public RSTableModel getDistinctColumnValuesPaged(DatasourceContainerProvider container, ParameterSet parameters,
         List<Column> columns, List<AdditionalColumnSpec> additionalColumns, Integer offset, Integer length,
         boolean useFilters) throws ReportExecutorException {
      return _getColumnValuesPaged(container, parameters, columns, additionalColumns, offset, length, useFilters, true,
            null);
   }
   ...
   public RSTableModel _getColumnValuesPaged(DatasourceContainerProvider container, ParameterSet parameters,
         List<Column> column, List<AdditionalColumnSpec> additionalColumns, Integer offset, Integer length,
         boolean useFilters, boolean distinct, DataConsumer streamConsumer) throws ReportExecutorException {
      return _getColumnValuesPaged(container, parameters, column, additionalColumns, offset, length, useFilters,
            distinct, streamConsumer, null);
   }

   public RSTableModel _getColumnValuesPaged(DatasourceContainerProvider container, ParameterSet parameters,
         List<Column> column, List<AdditionalColumnSpec> additionalColumns, Integer offset, Integer length,
         boolean useFilters, boolean distinct, DataConsumer streamConsumer, String executorToken)
         throws ReportExecutorException {
      /* get proper datasource */
//		TableDataSource ds = dataSourceTransformerProvider.get().transform(container, parameters);
      TableDataSource ds = datasourceTransformationService.transform(TableDataSource.class, container, parameters);
   ...
   public int getColumnValuesCount(DatasourceContainerProvider container, Column column, boolean useFilters)
         throws ReportExecutorException {
      return getColumnValuesCount(container, null, column, useFilters);
   }

   public int getColumnValuesCount(DatasourceContainerProvider container, ParameterSet parameters, Column column,
         boolean useFilters) throws ReportExecutorException {
      return getColumnValuesCount(container, parameters, column, null, useFilters);
   }

   public int getColumnValuesCount(DatasourceContainerProvider container, ParameterSet parameters, Column column,
         List<AdditionalColumnSpec> additionalColumns, boolean useFilters) throws ReportExecutorException {
      return _getColumnValuesCount(container, parameters, Collections.singletonList(column), additionalColumns,
            useFilters, false);
   }

   public int getDistinctColumnValuesCount(DatasourceContainerProvider container, Column column, boolean useFilters)
         throws ReportExecutorException {
      return getDistinctColumnValuesCount(container, null, column, useFilters);
   }

   public int getDistinctColumnValuesCount(DatasourceContainerProvider container, ParameterSet parameters,
         Column column, boolean useFilters) throws ReportExecutorException {
      return getDistinctColumnValuesCount(container, parameters, column, null, useFilters);
   }

   public int getDistinctColumnValuesCount(DatasourceContainerProvider container, ParameterSet parameters,
         Column column, List<AdditionalColumnSpec> additionalColumns, boolean useFilters)
         throws ReportExecutorException {
      return _getColumnValuesCount(container, parameters, Collections.singletonList(column), additionalColumns,
            useFilters, true);
   }

   public int _getColumnValuesCount(DatasourceContainerProvider container, ParameterSet parameters,
         List<Column> columns, List<AdditionalColumnSpec> additionalColumns, boolean useFilters, boolean distinct)
         throws ReportExecutorException {
      /* get proper datasource */
//		TableDataSource ds = dataSourceTransformerProvider.get().transform(container, parameters);
      TableDataSource ds = datasourceTransformationService.transform(TableDataSource.class, container, parameters);
   ...
   private void applyTableReportSettings(TableDataSource ds, TableReport tableReport, ParameterSet paramSet,
         List<Column> columns, boolean useFilters) {
      /* apply parameters */
      if (null == paramSet) {
      ...
      if (useFilters) {
         ...
         List<Column> columnsToUse = new ArrayList<>();
         ...
         for (Column column : columns) {
            ...
            /*
             * the like filter is used for filtering in the dialog and was overwritten by
   ...
   public RSTableModel streamData(TableDataSource ds, DataConsumer consumer, String executorToken)
         throws ReportExecutorException {
      try {
         /* open datasource */
         ds.open(executorToken);
