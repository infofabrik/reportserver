...
public class JasperReportEngine extends ReportEngine<JRDataSource, JasperOutputGenerator, JasperMetadataExporter> {
   ...
   @Inject
   public JasperReportEngine(JasperOutputGeneratorManager outputGeneratorManager,
         JasperMetadataExporterManager metadataExporterManager, JasperUtilsService jasperUtilsService,
   ...
   private CompiledRSJasperReport executeReport(Connection connection, JRDataSource datasource,
         final JasperReport report, ParameterSet parameters, String outputFormat, User user,
      ...
      try {
                           ...
                           if (jrxml.getName().replaceFirst("(?i)\\.jrxml$", "").equals(subreport)) {
                              try {
                                 ...
                                 JasperDesign design = JRXmlLoader
                                       .load(new ByteArrayInputStream(jrxml.getContent().getBytes()));
                                 validate(design);
                                 ...
                                 throw new IllegalArgumentException(
                                       "Problem with subreport " + jrxml.getName() + ": " + e);
                              }
                           }
                        }
                     }
         ...
         final ClassLoader classLoader = new ClassLoader() {
            public java.net.URL getResource(String name) {
               URL classloaderResource = net.sf.jasperreports.engine.JasperReport.class.getClassLoader()
                     .getResource(name);
               ...
               if (!isUrl(name)) {
                  try {
                     ...
                     return new URL("rsfsx", "jaspersubreport", -1, "/" + report.getUuid() + "/" + name,
                           urlStreamHandlerFactory.createURLStreamHandler("rsfsx"));
         ...
         JRClassLoader.setProtectionDomainFactory(new ProtectionDomainFactory() {
            ...
            public ProtectionDomain getProtectionDomain(ClassLoader classloader) {
               try {
                  CodeSource cs = new CodeSource(new URL("file://jasperreports/defaultcodesource"),
         ...
         /* compile report */
         net.sf.jasperreports.engine.JasperReport jasperReport = JasperCompileManager.getInstance(context)
