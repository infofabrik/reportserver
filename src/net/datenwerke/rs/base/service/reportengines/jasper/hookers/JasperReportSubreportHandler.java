...
public class JasperReportSubreportHandler implements FileSelectionHandlerHook {
   ...
   @Inject
   public JasperReportSubreportHandler(Provider<AuthenticatorService> authenticatorServiceProvider,
         Provider<SecurityService> securityServiceProvider, Provider<ReportService> reportServiceProvider,
         Provider<DtoService> dtoServiceProvider, Provider<JasperUtilsService> jasperUtils,
