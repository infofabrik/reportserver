...
public class JasperReportJRXMLDownloadHooker implements FileDownloadHandlerHook {
   ...
   @Inject
   public JasperReportJRXMLDownloadHooker(Provider<JasperUtilsService> jasperUtilsProvider,
         Provider<ReportService> reportServiceProvider, Provider<SecurityService> securityServiceProvider,
