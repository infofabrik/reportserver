...
public class ReportParameterReplacement extends ParameterSetReplacementProviderImpl {
   ...
   public Map<String, ParameterValue> provideReplacements(User user, Report report) {
      ...
      reps.put(REPORT_REPLACEMENT_NAME, new ParameterValueImpl(REPORT_REPLACEMENT_NAME,
            (report != null && report.getName() != null) ? report.getName() : "", String.class));
      reps.put(REPORT_REPLACEMENT_DESCRIPTION, new ParameterValueImpl(REPORT_REPLACEMENT_DESCRIPTION,
            (report != null && report.getDescription() != null) ? report.getDescription() : "", String.class));
      reps.put(REPORT_REPLACEMENT_KEY,
            new ParameterValueImpl(REPORT_REPLACEMENT_KEY,
                  null == report ? ""
                        : report.getKey() != null ? report.getKey()
                              : report.getOldTransientKey() != null ? report.getOldTransientKey() : "",
                  String.class));
      reps.put(REPORT_REPLACEMENT_ID,
            new ParameterValueImpl(REPORT_REPLACEMENT_ID,
                  null == report ? null
                        : report.getId() != null ? report.getId()
                              : report.getOldTransientId() != null ? report.getOldTransientId() : null,
                  Long.class));
