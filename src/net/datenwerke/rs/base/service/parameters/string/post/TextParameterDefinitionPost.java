...
public class TextParameterDefinitionPost
      implements Dto2PosoPostProcessor<TextParameterDefinitionDto, TextParameterDefinition>,
      Poso2DtoPostProcessor<TextParameterDefinition, TextParameterDefinitionDto> {
   ...
   @Override
   public void dtoInstantiated(TextParameterDefinition poso, TextParameterDefinitionDto dto) {
      // TODO Auto-generated method stub

   }

   @Override
   public void posoCreated(TextParameterDefinitionDto dto, TextParameterDefinition poso) {
      user2System(dto, poso);
   }

   @Override
   public void posoCreatedUnmanaged(TextParameterDefinitionDto dto, TextParameterDefinition poso) {
      user2System(dto, poso);
   }
   ...
   @Override
   public void posoLoaded(TextParameterDefinitionDto dto, TextParameterDefinition poso) {
      user2System(dto, poso);
   }

   @Override
   public void posoMerged(TextParameterDefinitionDto dto, TextParameterDefinition poso) {
      user2System(dto, poso);
   }

   private void user2System(TextParameterDefinitionDto dto, TextParameterDefinition poso) {
   ...
   private void system2User(TextParameterDefinitionDto dto, TextParameterDefinition poso) {
