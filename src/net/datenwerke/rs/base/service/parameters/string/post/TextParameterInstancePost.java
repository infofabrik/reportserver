...
public class TextParameterInstancePost
      implements Dto2PosoPostProcessor<TextParameterInstanceDto, TextParameterInstance>,
      Poso2DtoPostProcessor<TextParameterInstance, TextParameterInstanceDto> {
   ...
   @Override
   public void posoCreatedUnmanaged(TextParameterInstanceDto dto, TextParameterInstance poso) {
      user2System(dto, poso);
   ...
   private void system2User(TextParameterInstance poso, TextParameterInstanceDto dto) {
   ...
   private void user2System(TextParameterInstanceDto dto, TextParameterInstance poso) {
