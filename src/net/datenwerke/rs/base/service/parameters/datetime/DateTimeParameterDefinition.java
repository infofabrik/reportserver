 ...
 * <dd>mode</dd>
 * <dt>1 : only ask for date 2 : only ask for time 3 : ask for date and time
 * </dt>
...
@Audited
@GenerateDto(dtoPackage = "net.datenwerke.rs.base.client.parameters.datetime.dto", displayTitle = "RsMessages.INSTANCE.dateTimeParameterText()", additionalImports = RsMessages.class, createDecorator = true)
