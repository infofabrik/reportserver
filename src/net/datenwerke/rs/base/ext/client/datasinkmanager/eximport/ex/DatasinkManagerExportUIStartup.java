...
import net.datenwerke.rs.base.ext.client.datasinkmanager.eximport.ex.hookers.ExportButtonHook;
import net.datenwerke.rs.eximport.client.eximport.security.ExportGenericTargetIdentifier;
import net.datenwerke.security.client.security.SecurityUIService;
import net.datenwerke.security.client.security.dto.ExecuteDto;

public class DatasinkManagerExportUIStartup {
   @Inject
   public DatasinkManagerExportUIStartup(final HookHandlerService hookHandler,
