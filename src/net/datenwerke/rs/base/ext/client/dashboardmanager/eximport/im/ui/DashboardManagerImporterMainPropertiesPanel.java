...
public class DashboardManagerImporterMainPropertiesPanel
      extends ImporterMainPropertiesPanel<DashboardManagerImportConfigDto> {
   ...
   @Inject
   public DashboardManagerImporterMainPropertiesPanel(@DashboardTreeFolders Provider<UITree> treeProvider) {
   ...
   @Override
   public void validateConfig(DashboardManagerImportConfigDto config) throws NotProperlyConfiguredException {
   ...
   protected void configureForm() {
      ...
      parentKey = form.addField(DashboardFolderDto.class, DashboardMessages.INSTANCE.importWhereTo(),
