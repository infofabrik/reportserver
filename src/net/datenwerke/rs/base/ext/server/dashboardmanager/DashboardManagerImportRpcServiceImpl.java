 ...
 */
@Singleton
public class DashboardManagerImportRpcServiceImpl extends SecuredRemoteServiceServlet
      implements DashboardManagerImportRpcService {
   ...
   @Inject
   public DashboardManagerImportRpcServiceImpl(Provider<HttpTreeImportService> httpImportServiceProvider) {
