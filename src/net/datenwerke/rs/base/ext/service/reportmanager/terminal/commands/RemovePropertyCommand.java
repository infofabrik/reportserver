...
public class RemovePropertyCommand implements ReportModSubCommandHook {
   ...
   @Inject
   public RemovePropertyCommand(ReportService reportService) {
   ...
   @Override
   @CliHelpMessage(messageClass = ReportManagerExtMessages.class, name = BASE_COMMAND, description = "commandReportmod_sub_removeProperty_description", nonOptArgs = {
