...
import net.datenwerke.rs.remoteserver.client.remoteservermanager.eximport.ex.hookers.ExportButtonHook;
import net.datenwerke.security.client.security.SecurityUIService;
import net.datenwerke.security.client.security.dto.ExecuteDto;

public class RemoteServerManagerExportUIStartup {
   @Inject
   public RemoteServerManagerExportUIStartup(
      ...
      /* test if user has rights to see manager admin view */
