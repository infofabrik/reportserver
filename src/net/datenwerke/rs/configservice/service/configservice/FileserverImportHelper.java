...
public class FileserverImportHelper {
   ...
   @Inject
   public FileserverImportHelper(FileServerService fileServerService, ConfigDirService configDirService,
         TerminalService terminalService, UnzipCommandHelper unzipHelper, MimeUtils mimeUtils) {
   ...
   public AbstractFileServerNode importFile(File f) throws IOException, ObjectResolverException {
      ...
      AbstractFileServerNode node = createFileAndFolders(fileServerService.getRoots().get(0), pathInFileserver,
            f.isDirectory());
   ...
   public AbstractFileServerNode createFileAndFolders(AbstractFileServerNode base, String filename,
         boolean isDirectory) {
   ...
   private AbstractFileServerNode createFileAndFolders(AbstractFileServerNode base, Queue<String> filename,
         boolean isDirectory) {
