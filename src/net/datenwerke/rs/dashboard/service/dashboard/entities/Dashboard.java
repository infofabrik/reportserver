...
public class Dashboard implements Serializable {
   ...
   public List<Dadget> getDadgetsInColumn(int col) {
      ...
      for (Dadget d : this.dadgets) {
         if (col == d.getCol() || (col == 1 && d.getCol() > 1 && layout == LayoutType.ONE_COLUMN)
               || (col == 2 && d.getCol() > 2
                     && (layout == LayoutType.TWO_COLUMN_EQUI || layout == LayoutType.TWO_COLUMN_LEFT_LARGE
                           || layout == LayoutType.TWO_COLUMN_RIGHT_LARGE))
