...
public class DashboardServiceImpl extends SecuredTreeDBManagerImpl<AbstractDashboardManagerNode>
   ...
   @Inject
   public DashboardServiceImpl(Provider<EntityManager> entityManagerProvider,
         UserPropertiesService userPropertiesService, Provider<AuthenticatorService> authenticatorServiceProvider,
