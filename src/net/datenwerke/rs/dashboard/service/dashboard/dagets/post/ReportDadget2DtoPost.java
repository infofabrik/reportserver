...
public class ReportDadget2DtoPost
		implements
		Poso2DtoPostProcessor<ReportDadget, ReportDadgetDto> {
	...
	@Inject
	public ReportDadget2DtoPost(SecurityService securityService, Provider<DtoService> dtoServiceProvider, ReportDtoService reportDtoService) {
