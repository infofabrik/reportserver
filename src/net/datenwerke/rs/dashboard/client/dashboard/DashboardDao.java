...
public class DashboardDao extends Dao {
   ...
   public void removeDashboard(DashboardDto dashboard, AsyncCallback<Void> callback) {
      asyncService.removeDashboard(dashboard, transformAndKeepCallback(callback));
   }

   public void editDashboard(DashboardDto dashboard, AsyncCallback<DashboardDto> callback) {
      asyncService.editDashboard(dashboard, transformAndKeepCallback(callback));
   }

   public void addDadgetToDashboard(DashboardDto dashboard, DadgetDto dadget, AsyncCallback<DashboardDto> callback) {
   ...
   public void importReferencedDashboardForUser(DashboardNodeDto dashboard, AsyncCallback<DashboardDto> callback) {
   ...
   public void getDashboardParameterInstances(DashboardDto dashboardDto,
   ...
   public void setDashboardParameterInstances(DashboardDto dashboardDto, Set<ParameterInstanceDto> parameterInstances,
   ...
   public void getDadgetParameterInstances(DadgetDto dadgetDto,
         AsyncCallback<Map<String, ParameterInstanceDto>> callback) {
