...
public class StaticHtmlDadgetProcessor implements DadgetProcessorHook {
   ...
   public void displayConfigDialog(final DadgetDto dadget, final DadgetConfigureCallback dadgetConfigureCallback) {
      ...
      final String titleField = form.addField(String.class, StaticHtmlDadgetDtoPA.INSTANCE.title(),
            DashboardMessages.INSTANCE.staticHtmlDadgetTitleLabel());
      final String reloadField = form.addField(Long.class, StaticHtmlDadgetDtoPA.INSTANCE.reloadInterval(),
            DashboardMessages.INSTANCE.reloadIntervalLabel());
      final String heightField = form.addField(Integer.class, StaticHtmlDadgetDtoPA.INSTANCE.height(),
            DashboardMessages.INSTANCE.heightLabel());

      final String codeMirrorField = form.addField(String.class, StaticHtmlDadgetDtoPA.INSTANCE.data(),
            DashboardMessages.INSTANCE.staticHtmlDadgetHtmlLabel(), new SFFCCodeMirror() {
   ...
   public Widget getAdminConfigDialog(DadgetDto dadget, SimpleForm wrappingForm) {
      ...
      form.addField(String.class, StaticHtmlDadgetDtoPA.INSTANCE.data(),
            DashboardMessages.INSTANCE.staticHtmlDadgetHtmlLabel(), new SFFCCodeMirror() {
