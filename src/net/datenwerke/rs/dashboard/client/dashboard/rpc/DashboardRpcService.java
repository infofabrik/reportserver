...
public interface DashboardRpcService extends RemoteService {
   ...
   public DashboardDto editDadgetToDashboard(DashboardDto dashboardDto, DadgetDto dadget)
         throws ServerCallFailedException;

   public DashboardDto removeDadgetFromDashboard(DashboardDto dashboard, DadgetDto dadget)
         throws ServerCallFailedException;
