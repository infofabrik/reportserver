...
public class DadgetPanel extends DwContentPanel {
   ...
   @Inject
   public DadgetPanel(HookHandlerService hookHandler, ReportExecutorUIService reportExecutorService) {
            ...
            if (reportDadget.isShowExecuteButton()) {
               ...
               execBtn.addSelectHandler(event -> {
                  if (null != ((ReportDadgetDto) reportDadget).getReportForDisplay())
                     reportExecutorService.executeReport(((ReportDadgetDto) reportDadget).getReportForDisplay());
               });
               addTool(execBtn);
            }
         }
