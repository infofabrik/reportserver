...
/**
 * The list of the available access methods. The NONE access type is the lowest,
 * the GRANT is the highest . Every method implies the preceding
 *
 */
public enum AclMethod {
   NONE, READ, WRITE, GRANT;
