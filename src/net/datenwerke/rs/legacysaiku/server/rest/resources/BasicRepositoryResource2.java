...
public class BasicRepositoryResource2 implements ISaikuRepository {
    ...
    * 
    * @see
    * org.legacysaiku.web.rest.resources.ISaikuRepository#getRepository(java.lang.
   ...
   public List<IRepositoryObject> getRepository(@QueryParam("path") String path, @QueryParam("type") String type,
      ...
      if (report instanceof SaikuReportVariant) {
         RepositoryFileObject variantObject = new RepositoryFileObject(report.getName() + ".saiku",
               report.getId().toString(), "saiku", "variant-" + report.getId() + ".saiku", null);
    ...
    * 
    * @see
    * org.legacysaiku.web.rest.resources.ISaikuRepository#getResource(java.lang.
    * String)
    */
   @GET
   @Produces({ "text/plain" })
    ...
    * 
    * @see
    * org.legacysaiku.web.rest.resources.ISaikuRepository#saveResource(java.lang.
    * String, java.lang.String)
    */
   @POST
   @Path("/resource")
    ...
    * 
    * @see
    * org.legacysaiku.web.rest.resources.ISaikuRepository#deleteResource(java.lang.
    * String)
    */
   @DELETE
   @Path("/resource")
