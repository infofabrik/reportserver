...
public interface OlapQueryService {
   ...
   List<SaikuMember> getResultMetadataMembers(IQuery query, boolean preferResult, String dimensionName,
   ...
   boolean includeMember(IQuery query, String dimensionName, String uniqueMemberName, String selectionType,
         int memberposition);

   boolean removeMember(IQuery query, String dimensionName, String uniqueMemberName, String selectionType)
   ...
   IQuery createNewOlapQuery(String queryName, SaikuReport report, String connectionName, Cube cube)
         throws SQLException;
