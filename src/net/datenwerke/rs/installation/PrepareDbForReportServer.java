...
public class PrepareDbForReportServer implements DbInstallationTask {
	...
	private void prepareGenericSecurityTargets() {
		...
		/* system console */
		GenericSecurityTargetEntity systemConsoleEntity = securityService.createGenericSecurityTargetEntity(SystemConsoleSecurityTarget.class);
		...
		/* datasinks */
		GenericSecurityTargetEntity datasinksEntity = securityService.createGenericSecurityTargetEntity(DatasinkManagerAdminViewSecurityTarget.class);
