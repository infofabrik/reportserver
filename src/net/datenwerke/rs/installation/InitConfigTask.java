...
public class InitConfigTask implements DbInstallationTask {
   ...
   @Inject
   public InitConfigTask(Provider<ConfigDirService> configDirServiceProvider,
         Provider<UserManagerService> userManagerServiceProvider, Provider<ConfigService> configServiceProvider) {
