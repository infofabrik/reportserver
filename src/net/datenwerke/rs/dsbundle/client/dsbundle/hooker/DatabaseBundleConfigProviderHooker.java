...
public class DatabaseBundleConfigProviderHooker implements DatasourceDefinitionConfigProviderHook {
   ...
   @Inject
   public DatabaseBundleConfigProviderHooker(Provider<DatabaseBundleConfigConfigurator> configurator,
         Provider<DatabaseBundleForm> formProvider, EnterpriseUiService enterpriseService) {
