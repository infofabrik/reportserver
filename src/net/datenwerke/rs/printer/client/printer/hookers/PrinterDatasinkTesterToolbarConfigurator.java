...
public class PrinterDatasinkTesterToolbarConfigurator implements MainPanelViewToolbarConfiguratorHook {
   ...
   @Inject
   public PrinterDatasinkTesterToolbarConfigurator(ToolbarService toolbarUtils, PrinterDao printerDao) {
   ...
   public void mainPanelViewToolbarConfiguratorHook_addLeft(MainPanelView view, ToolBar toolbar,
      ...
      if (!(view instanceof SimpleFormView))
         return;
      if (!(selectedNode instanceof PrinterDatasinkDto))
         return;
      ...
      testBtn.addSelectHandler(event -> {
         ...
         Request request = printerDao.testPrinterDatasink((PrinterDatasinkDto) selectedNode,
