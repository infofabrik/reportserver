...
public class SaikuReportForm extends AbstractReportForm {
   ...
   @Inject
   public SaikuReportForm(DatasourceUIService datasourceService,
   ...
   protected void initializeForm(FormPanel form, VerticalLayoutContainer fieldWrapper) {
      ...
      fieldWrapper.add(new FieldLabel(enableMdx, SaikuMessages.INSTANCE.fieldLabelEnableMdx()),
   ...
   protected void addDatasourceField(Container container, boolean displayConfigFields) {
      datasourceFieldCreator = datasourceService.getSelectionField(container, displayConfigFields,
            datasourceTreeProvider, MondrianDatasourceDto.class);
