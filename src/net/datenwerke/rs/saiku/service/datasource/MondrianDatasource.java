...
@Audited
@GenerateDto(dtoPackage = "net.datenwerke.rs.saiku.client.datasource.dto", poso2DtoPostProcessors = MondrianDatasource2DtoPostProcessor.class, additionalFields = {
      @AdditionalField(name = "hasPassword", type = Boolean.class), })
@InstanceDescription(msgLocation = SaikuMessages.class, objNameKey = "mondrianDatasourceTypeName", icon = "cubes")
@Indexed
