...
public class MondrianDatasource2DtoPostProcessor
      implements Poso2DtoPostProcessor<MondrianDatasource, MondrianDatasourceDto> {
   ...
   @Override
   public void dtoInstantiated(MondrianDatasource arg0, MondrianDatasourceDto arg1) {
