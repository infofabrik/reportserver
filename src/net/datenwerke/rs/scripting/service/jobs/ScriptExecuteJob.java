...
@AssociationOverride(name = BaseJob__.baseProperties, joinTable = @JoinTable(name = "SCHED_SCR_EXE_JOB_2_PROP"))
public class ScriptExecuteJob extends ReportServerJob {

   @Inject
   @Transient
   private FileServerService fileServer;
   @Inject
   @Transient
   private SimpleScriptingService scriptService;
   @Inject
   @Transient
