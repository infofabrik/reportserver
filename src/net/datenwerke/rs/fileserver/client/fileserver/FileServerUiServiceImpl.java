...
public class FileServerUiServiceImpl implements FileServerUiService {
   ...
   @Inject
   public FileServerUiServiceImpl(FileServerDao fileDao, HookHandlerService hookHandlerService,
   ...
   @Override
   public void editFileDirectly(final FileServerFileDto file, final boolean editable, final boolean refreshable,
         final boolean emailable, final boolean scrollToEnd) {
   ...
   @Override
   public void editFileDirectly(FileServerFileDto file, boolean editable, boolean refreshable, boolean emailable,
   ...
   @Override
   public void editFileDirectly(String filename, String data, boolean editable, boolean refreshable, boolean emailable,
      ...
      if (emailable) {
         ...
         mail.addSelectHandler(event -> logFilesDao.emailFile(filename, new RsAsyncCallback<Void>() {
            ...
            public void onSuccess(Void result) {
               InfoConfig infoConfig = new DefaultInfoConfig(ReportExporterMessages.INSTANCE.messageSend(),
                     ReportExporterMessages.INSTANCE.messageSend());
      ...
      if (refreshable) {
         ...
         refreshButton
               .addSelectHandler(event -> logFilesDao.readLastLines(filename, new RsAsyncCallback<List<String>>() {
                  @Override
                  public void onSuccess(List<String> result) {
                     if (null != result) {
                        ...
                        InfoConfig infoConfig = new DefaultInfoConfig(ReportmanagerMessages.INSTANCE.refreshed(),
                              ReportmanagerMessages.INSTANCE.refreshed());
                        infoConfig.setWidth(350);
                        Info.display(infoConfig);
                     }
                  }
