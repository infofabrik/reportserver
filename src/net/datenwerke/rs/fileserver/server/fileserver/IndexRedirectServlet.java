...
public class IndexRedirectServlet extends HttpServlet {
   ...
   @Inject
   public IndexRedirectServlet(Provider<FileServerService> fileServerService, Provider<FileServerAccessServlet> fsas,
         Provider<ConfigService> configService, Provider<HookHandlerService> hookHandler) {
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      if (file instanceof FileServerFile) {
         ...
         boolean doRedirect = configService.get().getConfigFailsafe("ui/ui.cf").getBoolean("useReportServerHtml",
               false);
         if (doRedirect) {
