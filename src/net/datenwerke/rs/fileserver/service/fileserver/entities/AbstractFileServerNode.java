...
@TreeDBTree(rootTypes = { FileServerFolder.class, FileServerFile.class }, manager = FileServerService.class)
@GenerateDto(dtoPackage = "net.datenwerke.rs.fileserver.client.fileserver.dto", abstractDto = true, whitelist = {
      FileServerFileDto.class, FileServerFolderDto.class })
