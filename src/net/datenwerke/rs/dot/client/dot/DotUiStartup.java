...
import net.datenwerke.rs.dot.client.dot.hookers.ReloadButtonToolbarHookerDot;
...
public class DotUiStartup {
   ...
   public DotUiStartup(final HookHandlerService hookHandler, 
         ...
         final Provider<ReloadButtonToolbarHookerDot> reloadButtonToolbarHookerDot
         ) {

      /* attach views */
      hookHandler.attachHooker(DotFileViewHook.class, dotFilePreviewViewProvider);
      /* toolbar */
      hookHandler.attachHooker(MainPanelViewToolbarConfiguratorHook.class, reloadButtonToolbarHookerDot);
   }
}
