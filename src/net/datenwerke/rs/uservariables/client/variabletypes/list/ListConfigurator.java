...
public class ListConfigurator
      extends UserVariableConfiguratorImpl<ListUserVariableDefinitionDto, ListUserVariableInstanceDto> {
   ...
   public Widget getEditComponent(ListUserVariableDefinitionDto definition) {
      new DwAlertMessageBox(UserVariablesTypesMessages.INSTANCE.noEditTitle(),
            UserVariablesTypesMessages.INSTANCE.noEditMessage()).show();
      return null;
   }
   ...
   public Widget getEditComponent(final ListUserVariableInstanceDto instance,
      ...
      form.addField(String.class, new ValueProvider<ListUserVariableInstanceDto, String>() {
         ...
         public String getValue(ListUserVariableInstanceDto instance) {
            String value = "";
            Iterator<String> it = null == instance.getValue() ? new HashSet().iterator()
                  : instance.getValue().iterator();
            if (it.hasNext()) {
               value = it.next();
               while (it.hasNext())
                  value += " | " + it.next();
   ...
   @Override
   public Object getDisplayValue(ListUserVariableInstanceDto instance, ListUserVariableDefinitionDto definition) {
   ...
   @Override
   public void configureEditWindow(ListUserVariableInstanceDto instance, ListUserVariableDefinitionDto definition,
         Window window) {
      window.setWidth(500);
      window.setHeight(280);
   }
