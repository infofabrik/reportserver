...
public class UserVariableDao extends Dao {
   ...
   public void addUserVariableInstances(List<UserVariableDefinitionDto> definitionDto,
         AbstractUserManagerNodeDto nodeDto, AsyncCallback<List<UserVariableInstanceDto>> callback) {
      rpcService.addUserVariableInstances(definitionDto, nodeDto, transformListCallback(callback));
   }

   public void getDefinedUserVariableDefinitions(AsyncCallback<ListLoadResult<UserVariableDefinitionDto>> callback) {
   ...
   public void removeUserVariableAndAskForForce(final Collection<UserVariableDefinitionDto> definition,
