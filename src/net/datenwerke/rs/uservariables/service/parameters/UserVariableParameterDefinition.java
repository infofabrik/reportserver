...
@Audited
@GenerateDto(dtoPackage = "net.datenwerke.rs.uservariables.client.parameters.dto", displayTitle = "UserVariablesMessages.INSTANCE.userVariablesParameterText()", additionalImports = UserVariablesMessages.class)
