...
@Audited
@GenerateDto(dtoPackage = "net.datenwerke.rs.uservariables.client.variabletypes.list.dto", displayTitle = "UserVariablesMessages.INSTANCE.listVariableText()", additionalImports = UserVariablesMessages.class)
