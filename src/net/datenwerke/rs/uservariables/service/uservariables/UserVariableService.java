...
public interface UserVariableService {
   ...
   /**
    * Returns a {@link Collection} of all {@link UserVariableInstance}s defined by
    * the given {@link AbstractUserManagerNode}
    * 
    * @param folk The {@link AbstractUserManagerNode}
   ...
   /**
    * Returns a {@link List} of all {@link UserVariableInstance}s which are
    * inherited from the parents of the given {@link AbstractUserManagerNode}
    * 
    * @param folk The {@link AbstractUserManagerNode}
   ...
   /**
    * Merges the submitted {@link UserVariableDefinition} with the representation
   ...
   /**
    * Merges the submitted {@link UserVariableInstance} with the representation in
    * the database and returns the merged result.
    * 
   ...
   /**
    * Returns the {@link UserVariableInstance} which was instantiated from the
    * given {@link UserVariableDefinition} by the current user
    * 
   ...
   /**
    * Returns the {@link UserVariableInstance} which was instantiated from the
    * given {@link UserVariableDefinition} by the given {@link User}
    * 
   ...
   Collection<UserVariableParameterDefinition> getParametersFor(UserVariableDefinition uvd);
