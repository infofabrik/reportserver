...
public class JxlsReportEngine extends ReportEngine<Connection, JxlsOutputGenerator, JxlsMetadataExporter> {
   ...
   protected CompiledReport executeReport(OutputStream os, Connection connection, JxlsReport jxlsReport,
         ParameterSet parameters, String outputFormat, User user, ReportExecutionConfig[] configs) {
      try {
         ...
         return outputGenerator.exportReport(os, reportBytes, connection, jxlsReport, parameters, outputFormat,
               configs);
      } catch (Exception e) {
   ...
   @Override
   public CompiledReport executeDry(OutputStream os, Report report, ParameterSet parameterSet, User user,
         String outputFormat, ReportExecutionConfig[] configs) throws ReportExecutorException {
      /* get output generator */
      JxlsOutputGenerator outputGenerator = outputGeneratorManager.getOutputGenerator(outputFormat);
