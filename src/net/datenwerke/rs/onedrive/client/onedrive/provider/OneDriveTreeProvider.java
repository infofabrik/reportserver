package net.datenwerke.rs.onedrive.client.onedrive.provider;
...
public class OneDriveTreeProvider implements Provider<ManagerHelperTree> {
   ...
   public ManagerHelperTree get() {
      /* store */
      List<Dto2PosoMapper> filters = Arrays.asList(new DatasinkFolderDto2PosoMap(), new OneDriveDatasinkDto2PosoMap());
