...
public class ScheduleAsOneDriveFileEmailNotificationHooker extends SchedulerExecutionHookAdapter {
   ...
   public static final String PROPERTY_ONEDRIVE_NOTIFICATION_SUBJECT_SUCCESS = "scheduler.fileactionOneDrive.subject";
   public static final String PROPERTY_ONEDRIVE_NOTIFICATION_TEXT_SUCCESS = "scheduler.fileactionOneDrive.text";

   private static final String PROPERTY_ONEDRIVE_NOTIFICATION_DISABLED = "scheduler.fileactionOneDrive[@disabled]";
   private static final String PROPERTY_ONEDRIVE_NOTIFICATION_HTML = "scheduler.fileactionOneDrive[@html]";
   ...
   private void sendmail(ScheduleAsOneDriveFileAction action, ReportExecuteJob job, Exception e)
      ...
      if (config.getBoolean(PROPERTY_ONEDRIVE_NOTIFICATION_DISABLED, false))
         return;
      ...
      datamap.put(PROPERTY_OWNERS, UserListForJuelPrinter.createInstance(new ArrayList<>(job.getOwners()),
            config.getBoolean(PROPERTY_ONEDRIVE_NOTIFICATION_HTML, false)));
      ...
      String subjectTemplate = config.getString(PROPERTY_ONEDRIVE_NOTIFICATION_SUBJECT_SUCCESS,
            msgs.get(SchedulerMessages.class.getCanonicalName()).get("fileactionOneDriveMsgSubject"));
      String messageTemplate = config.getString(PROPERTY_ONEDRIVE_NOTIFICATION_TEXT_SUCCESS,
            msgs.get(SchedulerMessages.class.getCanonicalName()).get("fileactionOneDriveMsgText"));

      MailTemplate mailTemplate = new MailTemplate();
      mailTemplate.setHtml(config.getBoolean(PROPERTY_ONEDRIVE_NOTIFICATION_HTML, false));
