 ...
 *
 */
public class ReportDocumentationObjectInfo implements UrlViewSpecialViewHandler {
   ...
   public Widget getWidget(String url) {
      ...
      try {
         if (url.startsWith("rs:revisions://")) {
            ...
            String reportUrl = GWT.getModuleBaseURL() + ReportDocumentationUIModule.SERVLET + "?nonce=" + nonce + "&id="
                  + reportId + "&report=revisions" + "&format=HTML";
            ...
            int nonce = Random.nextInt();
            String reportUrl = GWT.getModuleBaseURL() + ReportDocumentationUIModule.SERVLET + "?nonce=" + nonce + "&id="
                  + reportId + "&tsid=" + tsid + "&format=HTML";
