...
/**
 * Dto for {@link DropboxDatasink}
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class DropboxDatasinkDto extends DatasinkDefinitionDto {
	...
	public static final String PROPERTY_APP_KEY = "dpi-dropboxdatasink-appkey";

	private transient static PropertyAccessor<DropboxDatasinkDto, String> appKey_pa = new PropertyAccessor<DropboxDatasinkDto, String>() {
		@Override
		public void setValue(DropboxDatasinkDto container, String object) {
			container.setAppKey(object);
		}

		@Override
		public String getValue(DropboxDatasinkDto container) {
		...
		@Override
		public void setModified(DropboxDatasinkDto container, boolean modified) {
			container.appKey_m = modified;
		}

		@Override
		public boolean isModified(DropboxDatasinkDto container) {
	...
	public static final String PROPERTY_FOLDER = "dpi-dropboxdatasink-folder";

	private transient static PropertyAccessor<DropboxDatasinkDto, String> folder_pa = new PropertyAccessor<DropboxDatasinkDto, String>() {
		@Override
		public void setValue(DropboxDatasinkDto container, String object) {
	...
	public static final String PROPERTY_REFRESH_TOKEN = "dpi-dropboxdatasink-refreshtoken";

	private transient static PropertyAccessor<DropboxDatasinkDto, String> refreshToken_pa = new PropertyAccessor<DropboxDatasinkDto, String>() {
		@Override
		public void setValue(DropboxDatasinkDto container, String object) {
	...
	public static final String PROPERTY_SECRET_KEY = "dpi-dropboxdatasink-secretkey";

	private transient static PropertyAccessor<DropboxDatasinkDto, String> secretKey_pa = new PropertyAccessor<DropboxDatasinkDto, String>() {
		@Override
		public void setValue(DropboxDatasinkDto container, String object) {
	...
	public static final String PROPERTY_HAS_REFRESH_TOKEN = "dpi-dropboxdatasink-hasrefreshtoken";

	private transient static PropertyAccessor<DropboxDatasinkDto, Boolean> hasRefreshToken_pa = new PropertyAccessor<DropboxDatasinkDto, Boolean>() {
		@Override
		public void setValue(DropboxDatasinkDto container, Boolean object) {
			container.setHasRefreshToken(object);
		}

		@Override
		public Boolean getValue(DropboxDatasinkDto container) {
	...
	public static final String PROPERTY_HAS_SECRET_KEY = "dpi-dropboxdatasink-hassecretkey";

	private transient static PropertyAccessor<DropboxDatasinkDto, Boolean> hasSecretKey_pa = new PropertyAccessor<DropboxDatasinkDto, Boolean>() {
		@Override
		public void setValue(DropboxDatasinkDto container, Boolean object) {
	...
	public void setAppKey(String appKey)  {
		...
		this.fireObjectChangedEvent(DropboxDatasinkDtoPA.INSTANCE.appKey(), oldValue);
	}
	...
	public static PropertyAccessor<DropboxDatasinkDto, String> getAppKeyPropertyAccessor()  {
		return appKey_pa;
	}
	...
	public void setFolder(String folder)  {
		...
		this.fireObjectChangedEvent(DropboxDatasinkDtoPA.INSTANCE.folder(), oldValue);
	}
	...
	public static PropertyAccessor<DropboxDatasinkDto, String> getFolderPropertyAccessor()  {
		return folder_pa;
	}
	...
	public void setRefreshToken(String refreshToken)  {
		...
		this.fireObjectChangedEvent(DropboxDatasinkDtoPA.INSTANCE.refreshToken(), oldValue);
	}
	...
	public static PropertyAccessor<DropboxDatasinkDto, String> getRefreshTokenPropertyAccessor()  {
	...
	public void setSecretKey(String secretKey)  {
		...
		this.fireObjectChangedEvent(DropboxDatasinkDtoPA.INSTANCE.secretKey(), oldValue);
	}
	...
	public static PropertyAccessor<DropboxDatasinkDto, String> getSecretKeyPropertyAccessor()  {
		return secretKey_pa;
	}
	...
	public void setHasRefreshToken(Boolean hasRefreshToken)  {
		...
		this.fireObjectChangedEvent(DropboxDatasinkDtoPA.INSTANCE.hasRefreshToken(), oldValue);
	}
	...
	public static PropertyAccessor<DropboxDatasinkDto, Boolean> getHasRefreshTokenPropertyAccessor()  {
	...
	public void setHasSecretKey(Boolean hasSecretKey)  {
		...
		this.fireObjectChangedEvent(DropboxDatasinkDtoPA.INSTANCE.hasSecretKey(), oldValue);
	}
	...
	public static PropertyAccessor<DropboxDatasinkDto, Boolean> getHasSecretKeyPropertyAccessor()  {
	...
	public boolean equals(Object obj)  {
		if(! (obj instanceof DropboxDatasinkDto))
			return false;

		if(null == getId())
			return super.equals(obj);
		return getId().equals(((DropboxDatasinkDto)obj).getId());
	}
	...
	public static Dto2PosoMapper newPosoMapper()  {
		return new DropboxDatasinkDto2PosoMap();
	}

	public DropboxDatasinkDtoPA instantiatePropertyAccess()  {
		return GWT.create(DropboxDatasinkDtoPA.class);
	}
