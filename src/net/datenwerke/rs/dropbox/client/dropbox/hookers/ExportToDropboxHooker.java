...
public class ExportToDropboxHooker implements ExportExternalEntryProviderHook {
   ...
   @Inject
   public ExportToDropboxHooker(@DatasinkTreeDropbox Provider<UITree> treeProvider,
   ...
   protected void displayExportDialog(final ReportDto report, final ReportExecutorInformation info,
      ...
      datasinkUiServiceProvider.get().displaySendToDatasinkDialog(DropboxDatasinkDto.class, report.getName(),
