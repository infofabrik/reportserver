...
public class ScheduleAsDropboxFileEmailNotificationHooker extends SchedulerExecutionHookAdapter {
   ...
   public static final String PROPERTY_DROPBOX_NOTIFICATION_SUBJECT_SUCCESS = "scheduler.fileactionDropbox.subject";
   public static final String PROPERTY_DROPBOX_NOTIFICATION_TEXT_SUCCESS = "scheduler.fileactionDropbox.text";

   private static final String PROPERTY_DROPBOX_NOTIFICATION_DISABLED = "scheduler.fileactionDropbox[@disabled]";
   private static final String PROPERTY_DROPBOX_NOTIFICATION_HTML = "scheduler.fileactionDropbox[@html]";
   ...
   @Inject
   public ScheduleAsDropboxFileEmailNotificationHooker(@SchedulerModuleProperties Configuration config,
   ...
   private void sendmail(ScheduleAsDropboxFileAction action, ReportExecuteJob job, Exception e)
      ...
      if (config.getBoolean(PROPERTY_DROPBOX_NOTIFICATION_DISABLED, false))
         return;
      ...
      datamap.put(PROPERTY_OWNERS, UserListForJuelPrinter.createInstance(new ArrayList<>(job.getOwners()),
            config.getBoolean(PROPERTY_DROPBOX_NOTIFICATION_HTML, false)));
      ...
      String subjectTemplate = config.getString(PROPERTY_DROPBOX_NOTIFICATION_SUBJECT_SUCCESS,
            msgs.get(SchedulerMessages.class.getCanonicalName()).get("fileactionDropboxMsgSubject"));
      String messageTemplate = config.getString(PROPERTY_DROPBOX_NOTIFICATION_TEXT_SUCCESS,
            msgs.get(SchedulerMessages.class.getCanonicalName()).get("fileactionDropboxMsgText"));

      MailTemplate mailTemplate = new MailTemplate();
      mailTemplate.setHtml(config.getBoolean(PROPERTY_DROPBOX_NOTIFICATION_HTML, false));
