...
public class ScheduleConfigAsFileHooker implements ScheduleConfigProviderHook {
   ...
   @Inject
   public ScheduleConfigAsFileHooker(DtoService dtoService, Provider<ScheduleAsFileAction> actionProvider,
         TeamSpaceService teamSpaceService, TsDiskService tsService) {
