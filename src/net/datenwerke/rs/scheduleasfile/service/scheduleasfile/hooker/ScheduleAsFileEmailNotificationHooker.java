...
public class ScheduleAsFileEmailNotificationHooker extends SchedulerExecutionHookAdapter {
   ...
   @Inject
   public ScheduleAsFileEmailNotificationHooker(@SchedulerModuleProperties Configuration config,
         MailService mailService, TsDiskService tsDiskService, RemoteMessageService remoteMessageService) {
   ...
   private void sendmail(ScheduleAsFileAction action, ReportExecuteJob job, String subjectTemplate, String tpl,
