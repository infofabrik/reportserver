...
public class CrystalReportParameterProposerToolbarConfiguratorHooker implements MainPanelViewToolbarConfiguratorHook {
   ...
   @Inject
   public CrystalReportParameterProposerToolbarConfiguratorHooker(ToolbarService toolbarUtils,
         CrystalUtilsDao crystalUtilsDao, ParameterUIService parameterService) {
   ...
   public void mainPanelViewToolbarConfiguratorHook_addLeft(final MainPanelView view, ToolBar toolbar,
      ...
      DwTextButton createPreviewBtn = toolbarUtils
            .createSmallButtonLeft(CrystalMessages.INSTANCE.parameterProposalBtn(), BaseIcon.LIGHTBULB);
            ...
            crystalUtilsDao.proposeParametersFor(report, new RsAsyncCallback<List<CrystalParameterProposalDto>>() {
               ...
               public void onSuccess(List<CrystalParameterProposalDto> result) {
                  if (null != result && !result.isEmpty()) {
                     ...
                     new DwAlertMessageBox(CrystalMessages.INSTANCE.noProposalsFoundTitle(),
                           CrystalMessages.INSTANCE.noProposalsFoundText()).show();
                  }
               }
            });
         }
   ...
   protected void displayResults(final ParameterView view, final CrystalReportDto report,
         List<CrystalParameterProposalDto> proposals) {
      /* create store */
      final ListStore<CrystalParameterProposalDto> proposalStore = new ListStore<CrystalParameterProposalDto>(
            crystalPa.dtoId());
      ...
      /* Name column */
      ColumnConfig<CrystalParameterProposalDto, String> nameConfig = new ColumnConfig<CrystalParameterProposalDto, String>(
            crystalPa.name(), 200, JasperMessages.INSTANCE.name());
      columns.add(nameConfig);

      /* Key column */
      ColumnConfig<CrystalParameterProposalDto, String> keyConfig = new ColumnConfig<CrystalParameterProposalDto, String>(
            crystalPa.key(), 200, JasperMessages.INSTANCE.key());
      ...
      ColumnConfig<CrystalParameterProposalDto, ParameterDefinitionDto> proposalConfig = new ColumnConfig<CrystalParameterProposalDto, ParameterDefinitionDto>(
            crystalPa.parameterProposal(), 200, JasperMessages.INSTANCE.proposal());
      ...
      /* create grid */
      final DeletableRowsGrid<CrystalParameterProposalDto> grid = new DeletableRowsGrid<CrystalParameterProposalDto>(
            proposalStore, new ColumnModel<CrystalParameterProposalDto>(columns));
   ...
   protected void addParametersFor(final ParameterView view, CrystalReportDto report,
         List<CrystalParameterProposalDto> proposalDtos) {
