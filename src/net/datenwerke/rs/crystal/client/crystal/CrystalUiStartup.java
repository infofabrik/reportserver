...
public class CrystalUiStartup {
   ...
   @Inject
   public CrystalUiStartup(final HookHandlerService hookHandler, final WaitOnEventUIService waitOnEventService,
         final SecurityUIService securityService, final CrystalUtilsDao crystalDao,
         ...
         final Provider<Crystal2CSV> crystal2CSV, final Provider<Crystal2Excel> crystal2Excel,
         final Provider<Crystal2PDF> crystal2PDF, final Provider<Crystal2Word> crystal2Word,
      ...
      hookHandler.attachHooker(ReportViewHook.class, new ReportViewHook(crystalReportPreviewViewFactory),
            HookHandlerService.PRIORITY_LOW);

      hookHandler.attachHooker(ReportExporterExportReportHook.class, new ReportExporterExportReportHook(crystal2PDF));
      hookHandler.attachHooker(ReportExporterExportReportHook.class, new ReportExporterExportReportHook(crystal2Word),
            HookHandlerService.PRIORITY_LOW);
      hookHandler.attachHooker(ReportExporterExportReportHook.class, new ReportExporterExportReportHook(crystal2Excel),
            HookHandlerService.PRIORITY_LOW);
      hookHandler.attachHooker(ReportExporterExportReportHook.class, new ReportExporterExportReportHook(crystal2CSV),
            HookHandlerService.PRIORITY_LOW);
