...
public class ActivateUserToolbarConfigurator implements MainPanelViewToolbarConfiguratorHook {
   ...
   @Inject
   public ActivateUserToolbarConfigurator(ActivateUserServiceDao activateUserService, ToolbarService toolbarService) {
   ...
   public void mainPanelViewToolbarConfiguratorHook_addRight(MainPanelView view, ToolBar toolbar,
      ...
      DwTextButton activateBtn = toolbarService
            .createSmallButtonLeft(PasswordPolicyMessages.INSTANCE.activateButtonLabel(), BaseIcon.ENVELOPE_O);
