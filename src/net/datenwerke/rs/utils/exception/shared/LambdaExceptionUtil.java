package net.datenwerke.rs.utils.exception.shared;
...
public final class LambdaExceptionUtil {
   ...
   public static <E extends Exception> IntConsumer rethrowIntConsumer(IntConsumer_WithExceptions<E> consumer) throws E {
      return i -> {
         try {
            consumer.accept(i);
         } catch (Exception exception) {
