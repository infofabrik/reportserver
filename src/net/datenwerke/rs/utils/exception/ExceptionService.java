...
public interface ExceptionService {
   ...
   public enum LogProperty {
      ...
      // general properties
      JAVA_VERSION(TYPE_GENERAL), JAVA_VM_ARGUMENTS(TYPE_GENERAL), APPLICATION_SERVER(TYPE_GENERAL), OS_VERSION(TYPE_GENERAL), 
      REPORTSERVER_VERSION(TYPE_GENERAL),
      ...
      DATASOURCE_ID(TYPE_DATASOURCE), DATASOURCE_NAME(TYPE_DATASOURCE), DATASOURCE_TYPE(TYPE_DATASOURCE), 
