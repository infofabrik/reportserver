 ...
 * 
 * <h1>Description</h1> The juel module provides basic functionality for
 * handling juel related tasks.
 * 
 * <h1>Content</h1>
 * <h2>Services</h2>
 * <ul>
...
public class JuelModule extends AbstractModule {
   ...
   public Collection<String> provideJuelBlacklist(ConfigService configService) {
      ...
      List list = configService.getConfigFailsafe(CONFIG_FILE).getList(BLACKLIST_PROPERTY,
            (List) Arrays.asList("getClass", ".class", "forName"));
      if (null != list)
         bl.addAll(list);
      return bl;
