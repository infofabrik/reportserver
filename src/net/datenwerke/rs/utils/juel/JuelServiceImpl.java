...
public class JuelServiceImpl implements JuelService {
   ...
   @Inject
   public JuelServiceImpl(@JuelExpressionBlacklist Provider<Collection<String>> expressionBlacklist,
   ...
   public ELContext provideBasicContext(ExpressionFactory factory) {
      ...
      /* add special objects */
      context.setVariable(VARIABLE_CURRENT_DATE,
            factory.createValueExpression(new SimpleDateWrapper(), SimpleDateWrapper.class));
      ...
      context.setVariable(S_ESCAPE_UTILS,
            factory.createValueExpression(new StringEscapeUtils(), StringEscapeUtils.class));
