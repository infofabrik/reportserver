...
public class SimpleQueryProcessor {
   ...
   @Inject
   public SimpleQueryProcessor(Provider<EntityManager> entityManagerProvider, Provider<SecurityService> securityServiceProvider, ReflectionService reflectionService,
