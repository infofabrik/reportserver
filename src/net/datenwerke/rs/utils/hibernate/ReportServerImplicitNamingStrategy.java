...
public class ReportServerImplicitNamingStrategy extends ImplicitNamingStrategyJpaCompliantImpl
   ...
   public Identifier determineBasicColumnName(ImplicitBasicColumnNameSource source) {
      return Identifier.toIdentifier(
            abbreviateName(addUnderscores(renamePropertyKeywords(source.getAttributePath().getProperty()))));
   }
   ...
   public Identifier determineJoinColumnName(ImplicitJoinColumnNameSource source) {
      ...
      if (source.getNature() == ImplicitJoinColumnNameSource.Nature.ELEMENT_COLLECTION
         ...
         name = abbreviateName(addUnderscores(source.getReferencedTableName().getText()) + "_"
               + unrenamePropertyKeywords(source.getReferencedColumnName().getText()));
      } else {
         name = abbreviateName(addUnderscores(transformAttributePath(source.getAttributePath())) + "_"
               + unrenamePropertyKeywords(source.getReferencedColumnName().getText()));
      }
   ...
   public Identifier determinePrimaryKeyJoinColumnName(ImplicitPrimaryKeyJoinColumnNameSource source) {
      return Identifier.toIdentifier(abbreviateName(
            addUnderscores(unrenamePropertyKeywords(source.getReferencedPrimaryKeyColumnName().getText()))));
   }
