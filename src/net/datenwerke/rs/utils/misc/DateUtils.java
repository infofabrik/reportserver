...
public class DateUtils {
   ...
   /**
    * All minutes have this many milliseconds except the last minute of the day on
    * a day defined with a leap second.
    */
   ...
   /****
    * Value to add to the day number returned by this calendar to find the Julian
    * Day number. This is the Julian Day number for 1/1/1970. Note: Since the unix
    * Day number is the same from local midnight to local midnight adding
    * JULIAN_DAY_OFFSET to that value results in the chronologist, historians, or
    * calenderists Julian Day number. Refer to
   ...
   /**
    * @return LOCAL Chronologists Julian day number each day starting from midnight
    *         LOCAL TIME. Refer to http://tycho.usno.navy.mil/mjd.html for more
    *         information about local C-JDN
    */
