...
@GenerateDto(dtoPackage = "net.datenwerke.rs.search.client.search.dto", createDecorator = true, dto2PosoPostProcessors = Dto2SearchFilterPost.class, additionalFields = {
