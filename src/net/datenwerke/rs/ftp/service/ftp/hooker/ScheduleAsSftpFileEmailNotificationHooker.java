...
public class ScheduleAsSftpFileEmailNotificationHooker extends SchedulerExecutionHookAdapter {
   ...
   private static final Map<String, String> PROPERTIES = new HashMap<String, String>() {
      ...
      {
         put(DatasinkModule.PROPERTY_SUBJECT, "scheduler.fileactionSftp.subject");
         put(DatasinkModule.PROPERTY_TEXT, "scheduler.fileactionSftp.text");
         put(DatasinkModule.PROPERTY_DISABLED, "scheduler.fileactionSftp[@disabled]");
         put(DatasinkModule.PROPERTY_HTML, "scheduler.fileactionSftp[@html]");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_SUBJECT, "fileactionSftpMsgSubject");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_TEXT, "fileactionSftpMsgText");
      }
   };
