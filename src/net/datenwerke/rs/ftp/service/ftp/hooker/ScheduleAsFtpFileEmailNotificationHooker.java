...
public class ScheduleAsFtpFileEmailNotificationHooker extends SchedulerExecutionHookAdapter {
   ...
   private static final Map<String, String> PROPERTIES = new HashMap<String, String>() {
      ...
      {
         put(DatasinkModule.PROPERTY_SUBJECT, "scheduler.fileactionFtp.subject");
         put(DatasinkModule.PROPERTY_TEXT, "scheduler.fileactionFtp.text");
         put(DatasinkModule.PROPERTY_DISABLED, "scheduler.fileactionFtp[@disabled]");
         put(DatasinkModule.PROPERTY_HTML, "scheduler.fileactionFtp[@html]");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_SUBJECT, "fileactionFtpMsgSubject");
         put(DatasinkModule.PROPERTY_TRANSLATIONS_TEXT, "fileactionFtpMsgText");
      }
   };
