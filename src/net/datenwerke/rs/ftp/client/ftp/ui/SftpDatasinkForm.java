...
public class SftpDatasinkForm extends SimpleFormView {
   ...
   private void addAuthenticationType(SimpleForm form) {
      ...
      authTypeKey = form.addField(List.class, SftpDatasinkDtoPA.INSTANCE.authenticationType(), DatasinksMessages.INSTANCE.authenticationType(),
