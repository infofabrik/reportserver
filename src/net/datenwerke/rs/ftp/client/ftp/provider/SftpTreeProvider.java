...
public class SftpTreeProvider implements Provider<ManagerHelperTree> {
   ...
   @Inject
   public SftpTreeProvider(TreeDBUIService treeDBUIService, DatasinkTreeLoaderDao datasinkTreeLoader,
   ...
   public ManagerHelperTree get() {
      /* store */
      List<Dto2PosoMapper> filters = Arrays.asList(new DatasinkFolderDto2PosoMap(), new SftpDatasinkDto2PosoMap());
