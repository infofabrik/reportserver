...
public class FtpDatasinkConfigProviderHooker implements DatasinkDefinitionConfigProviderHook {
   ...
   @Inject
   public FtpDatasinkConfigProviderHooker(Provider<FtpDatasinkForm> formProvider) {
