...
public class FtpsDataSinkTesterToolbarConfigurator implements MainPanelViewToolbarConfiguratorHook {
    ...
    @Inject
    public FtpsDataSinkTesterToolbarConfigurator(ToolbarService toolbarUtils, FtpDao ftpDao) {
    ...
    public void mainPanelViewToolbarConfiguratorHook_addLeft(MainPanelView view, ToolBar toolbar,
        ...
        if (!(view instanceof SimpleFormView))
            return;
        if (!(selectedNode instanceof FtpsDatasinkDto))
            return;
        ...
        testBtn.addSelectHandler(event -> {
            ...
            Request request = ftpDao.testFtpsDataSink((FtpsDatasinkDto) selectedNode,
