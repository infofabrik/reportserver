package net.datenwerke.rs.scriptdatasource.client.scriptdatasource.hooker;
...
import net.datenwerke.rs.scriptdatasource.client.scriptdatasource.config.ScriptDatasourceConfigConfigurator;
...
import net.datenwerke.rs.scriptdatasource.client.scriptdatasource.ui.ScriptDatasourceForm;
import net.datenwerke.rs.theme.client.icon.BaseIcon;

public class ScriptDatasourceConfigProviderHooker implements DatasourceDefinitionConfigProviderHook {
   ...
   @Inject
   public ScriptDatasourceConfigProviderHooker(Provider<ScriptDatasourceConfigConfigurator> configurator,
         Provider<ScriptDatasourceForm> formProvider, EnterpriseUiService enterpriseService) {
