...
public class VfsObjectResolver implements ObjectResolverHook {
   ...
   @Override
   public Collection<Object> getObjects(String locationStr, TerminalSession terminalSession)
   ...
   private VFSLocation getParentLocation(PathHelper pathHelper, TerminalSession terminalSession) throws VFSException {
      return terminalSession.getFileSystem().getLocation(pathHelper.getPath());
   }

   private VFSLocation getLocation(PathHelper pathHelper, TerminalSession terminalSession) throws VFSException {
