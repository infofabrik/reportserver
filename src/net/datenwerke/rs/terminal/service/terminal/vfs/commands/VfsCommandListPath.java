...
public class VfsCommandListPath implements TerminalCommandHook {
   ...
   @CliHelpMessage(messageClass = VfsMessages.class, name = BASE_COMMAND, description = "commandListpath_description", args = {
         @Argument(flag = "i", description = "commandListpath_iflag") }, nonOptArgs = {
