...
public class DescCommand implements TerminalCommandHook {
   ...
   @Inject
   public DescCommand(TableModelHelper tableModelHelper, EntityUtils entityUtils,
         Provider<EntityManagerFactory> entityManagerFactoryProvider, ReflectionService reflectionService) {
   ...
   @Override
   @CliHelpMessage(messageClass = TerminalMessages.class, name = BASE_COMMAND, description = "commandDesc_description", args = {
         @Argument(flag = "w", description = "commandDesc_descFlag") }, nonOptArgs = {
