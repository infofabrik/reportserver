...
public interface VersioningService {
   ...
   /**
    * Returns an instance of the given {@link Object} at the given <i>revision</i>.
    * The result gets casted to the {@link Class} <i>T</i>
    * 
    * @param <T>      The class to cast to
    * @param clazz    The {@link Class} object
    * @param object   The {@link Object}
    * @param revision The <i>revision</i> as a {@link Number}
    * @return An instance of the given {@link Object} with the data of the given
    *         <i>revision</i>
    */
   ...
   /**
    * Returns a {@link Set} of {@link Number}s identified all revisions of the
    * given {@link Object}
    * 
