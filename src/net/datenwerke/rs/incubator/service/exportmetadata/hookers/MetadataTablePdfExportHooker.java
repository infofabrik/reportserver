...
public class MetadataTablePdfExportHooker implements TableExportHook {
   ...
   @Inject
   public MetadataTablePdfExportHooker(ExportMetadataService exportMetadataService) {
   ...
   @Override
   public void beforeExport(Report report, User user, TableDefinition td, TableOutputGenerator outputGenerator,
         String outputFormat) {
