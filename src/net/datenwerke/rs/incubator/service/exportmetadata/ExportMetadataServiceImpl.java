...
public class ExportMetadataServiceImpl implements ExportMetadataService {
    ...
    */
   @Inject
   public ExportMetadataServiceImpl(@ExportMetadataModuleAuthor Provider<String> author,
         @ExportMetadataModuleTitle Provider<String> title, @ExportMetadataModuleCreator Provider<String> creator,
