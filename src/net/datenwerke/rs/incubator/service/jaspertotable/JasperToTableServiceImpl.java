...
public class JasperToTableServiceImpl implements JasperToTableService {
   ...
   @Inject
   public JasperToTableServiceImpl(JasperUtilsService jasperUtils) {
   ...
   public TableReport transformToTableReport(JasperReport report) {
      ...
      if (null != report.getMasterFile()) {
         ...
         if (null == ((JasperToTableConfig) property).getDatasourceContainer()
               || null == ((JasperToTableConfig) property).getDatasourceContainer().getDatasource()) {
