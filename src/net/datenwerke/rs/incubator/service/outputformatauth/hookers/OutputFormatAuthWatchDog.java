...
public class OutputFormatAuthWatchDog implements ReportExecutionNotificationHook {
   ...
   public void doVetoReportExecution(Report report, ParameterSet parameterSet, User user, String outputFormat,
      ...
      ReportProperty property = report
         ...
         if (null != formatString) {
            ...
            if (!formats.contains(outputFormat))
               throw new ReportExecutorException(
                     OutputFormatAuthMessages.INSTANCE.exceptionInvalidFormat(outputFormat));
         }
      }
   }
