...
public class GenericActionLogEntryDetailHooker implements ActionLogEntryDetailHook {
   ...
   @Override
   public Widget getCard(ActionEntryDto action, ScheduledReportListPanel scheduledReportListPanel) {
      ...
      if (OutcomeDto.FAILURE == action.getOutcome()) {
         ...
         executionActionLogWrapper.add(
               scheduledReportListPanel.createLabel(SchedulerMessages.INSTANCE.errorDescriptionLabel()),
