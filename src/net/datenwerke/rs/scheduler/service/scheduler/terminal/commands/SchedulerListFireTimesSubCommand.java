...
public class SchedulerListFireTimesSubCommand implements SchedulerSubCommandHook {
   ...
   @Inject
   public SchedulerListFireTimesSubCommand(SchedulerService schedulerService) {
   ...
   @Override
   @CliHelpMessage(messageClass = SchedulerMessages.class, name = BASE_COMMAND, description = "commandScheduler_sub_listFireTimes_description", nonOptArgs = {
