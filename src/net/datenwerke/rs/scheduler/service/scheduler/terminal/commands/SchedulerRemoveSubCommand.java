...
public class SchedulerRemoveSubCommand implements SchedulerSubCommandHook {
   ...
   @Inject
   public SchedulerRemoveSubCommand(SchedulerService schedulerService) {
   ...
   @Override
   @CliHelpMessage(messageClass = SchedulerMessages.class, name = BASE_COMMAND, description = "commandScheduler_sub_remove_description", nonOptArgs = {
   ...
   public CommandResult execute(CommandParser parser, TerminalSession session) throws ObjectResolverException {
      ...
      return new CommandResult(Emoji.BEER_MUG.getEmoji(" ") + "removed job: " + id);
   }
