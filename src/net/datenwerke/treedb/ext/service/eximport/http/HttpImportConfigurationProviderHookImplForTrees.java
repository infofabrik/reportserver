...
abstract public class HttpImportConfigurationProviderHookImplForTrees<N extends AbstractNode<?>, D extends AbstractNodeDto>
      implements HttpImportConfigurationProviderHook {

   protected final DtoService dtoService;
   protected final Provider<HttpImportService> httpImportServiceProvider;
   private final SecurityService securityService;

   public HttpImportConfigurationProviderHookImplForTrees(DtoService dtoService,
   ...
   protected void doConfigureNodeConfig(TreeNodeImportItemConfig realConfigNode, ImportTreeModel model,
         TreeImportConfigDto<D> treeConfig) {
