...
public abstract class TreeNodeExporter extends ExporterImpl<TreeNodeExportItemConfig> {
   ...
   @Override
   protected void doExport(final ExportSupervisor exportSupervisor, final TreeNodeExportItemConfig item)
   ...
   protected void postProcessExportedElement(ExportSupervisor exportSupervisor, TreeNodeExportItemConfig item)
         throws XMLStreamException {
   ...
   @Override
   protected void doAddReferences(ExportSupervisor exportSupervisor, TreeNodeExportItemConfig item,
   ...
   @Override
   protected void doAddEnclosed(ExportSupervisor exportSupervisor, TreeNodeExportItemConfig item,
