...
public interface RPCTreeLoader {
   ...
   public List<AbstractNodeDto> getChildren(AbstractNodeDto node, Dto state, Collection<Dto2PosoMapper> wlFilters,
         final Collection<Dto2PosoMapper> blFilters) throws ServerCallFailedException;

   public String[][] getChildrenAsFto(AbstractNodeDto node, Dto state, Collection<Dto2PosoMapper> wlFilters,
         final Collection<Dto2PosoMapper> blFilters) throws ServerCallFailedException;

   public EntireTreeDTO loadAll(Dto state, Collection<Dto2PosoMapper> whiteListFilters,
         Collection<Dto2PosoMapper> blackListFilters) throws ServerCallFailedException;
