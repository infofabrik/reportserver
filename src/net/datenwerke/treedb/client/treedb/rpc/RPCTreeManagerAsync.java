...
public interface RPCTreeManagerAsync {
   ...
   public void insertNode(AbstractNodeDto dummyNode, AbstractNodeDto node, Dto state,
   ...
   public void moveNodeInsert(AbstractNodeDto node, AbstractNodeDto reference, int position, Dto state,
         AsyncCallback<AbstractNodeDto> asyncCallback);

   public void moveNodeAppend(AbstractNodeDto node, AbstractNodeDto reference, Dto state,
         AsyncCallback<AbstractNodeDto> asyncCallback);

   public void moveNodesAppend(List<AbstractNodeDto> nodes, AbstractNodeDto reference, Dto state,
   ...
   public void setFlag(AbstractNodeDto node, long flagToSet, long flagToUnset, boolean updateNode, Dto state,
         AsyncCallback<AbstractNodeDto> callback);
