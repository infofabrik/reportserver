...
abstract public class TreeDbManagerDao<M extends RPCTreeManagerAsync> extends Dao {
   ...
   public void moveNodeInsert(AbstractNodeDto node, AbstractNodeDto reference, int position,
   ...
   public void moveNodeAppend(AbstractNodeDto node, AbstractNodeDto reference,
         AsyncCallback<AbstractNodeDto> callback) {
      treeManager.moveNodeAppend(node, reference, state, transformDtoCallback(callback));
   }

   public void moveNodesAppend(List<AbstractNodeDto> nodes, AbstractNodeDto reference,
   ...
   public void setFlag(AbstractNodeDto node, long flagToSet, long flagToUnset, boolean updateNode,
         AsyncCallback<AbstractNodeDto> callback) {
