...
public class AbstractNode2DtoPostProcessor implements Poso2DtoPostProcessor<AbstractNode, AbstractNodeDtoDec> {

   private final DtoService dtoService;

   @Inject
   public AbstractNode2DtoPostProcessor(DtoService dtoService) {
