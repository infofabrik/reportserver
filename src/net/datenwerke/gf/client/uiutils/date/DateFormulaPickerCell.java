...
public class DateFormulaPickerCell extends TriggerFieldCell<DateFormulaContainer>
      implements HasExpandHandlers, HasCollapseHandlers {
   ...
   public void expand(final Context context, final XElement parent, DateFormulaContainer value,
   ...
   @Override
   public void finishEditing(Element parent, DateFormulaContainer value, Object key,
         final ValueUpdater<DateFormulaContainer> valueUpdater) {
   ...
   @Override
   protected void onFocus(com.google.gwt.cell.client.Cell.Context context, XElement parent, DateFormulaContainer value,
         NativeEvent event, ValueUpdater<DateFormulaContainer> valueUpdater) {
   ...
   protected boolean isFocusedWithTarget(Element parent, Element target) {
      boolean result = parent.isOrHasChild(target) || (menu != null
            && (menu.getElement().isOrHasChild(target) || menu.getDatePicker().getElement().isOrHasChild(target)));
      return result;
   }
