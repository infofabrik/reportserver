...
public class ToolBarEnhancedDeletableRowsGridForTreeItemSelection extends DwContentPanel {
   ...
   public ToolBarEnhancedDeletableRowsGridForTreeItemSelection(ListStore store, ColumnModel cm, UITree tree,
         Class<? extends AbstractNodeDto>... types) {
      grid = new DeletableRowsGrid(store, cm);
      initPanel(grid, tree, types);
   }

   public ToolBarEnhancedDeletableRowsGridForTreeItemSelection(ListStore store, ColumnModel cm, UITree tree,
         Collection<Class<? extends AbstractNodeDto>> types) {
