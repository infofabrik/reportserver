...
public class TreeDBUIServiceImpl implements TreeDBUIService {
   ...
   @Override
   public RpcProxy<AbstractNodeDto, List<AbstractNodeDto>> getUITreeProxy(final TreeDbLoaderDao rpcTreeLoader,
   ...
   @Override
   public EnhancedTreeStore getUITreeStore(Class<?> baseType, TreeDbLoaderDao rpcTreeLoader,
