...
public interface TreeDBUIService {
   ...
   public abstract RpcProxy<AbstractNodeDto, List<AbstractNodeDto>> getUITreeProxy(TreeDbLoaderDao treeLoaderDao,
         Collection<Dto2PosoMapper> wlFilters, final Collection<Dto2PosoMapper> blFilters);
    ...
    * @param proxy
    */
   public abstract EnhancedTreeLoader getUITreeLoader(TreeDbLoaderDao rpcTreeLoader,
         RpcProxy<AbstractNodeDto, List<AbstractNodeDto>> proxy);
   ...
   public abstract EnhancedTreeStore getUITreeStore(Class<?> baseType, TreeDbLoaderDao rpcTreeLoader,
         TreeLoader<AbstractNodeDto> loader, boolean changeAware);

   public abstract EnhancedTreeStore getUITreeStore(Class<?> baseType, TreeDbLoaderDao rpcTreeLoader,
         RpcProxy<AbstractNodeDto, List<AbstractNodeDto>> proxy, boolean changeAware);
