...
/**
 * This LayoutContainer divides the screen in two parts. Header and main
 * 
 *
 */
@Singleton
public class DwMainViewport extends Viewport {
   ...
   @Inject
   public DwMainViewport(HeaderPanel header, ModuleManagerPanel mainPanel, StatusBarUIService statusBarService,
         ThemeUiService themeService, ModuleManagerModuleSelector moduleSelector) {
