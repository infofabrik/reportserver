...
public class LocalizationImportMessagesSubCommand implements LocalizationSubCommandHook {
   ...
   @Override
   @CliHelpMessage(messageClass = LocalizationMessages.class, name = BASE_COMMAND, description = "commandLocalization_sub_importMessages_description", nonOptArgs = {
   ...
   private CommandResult loadFromFileServer(String path, TerminalSession session)
         throws ObjectResolverException, InvalidFormatException, IOException {
