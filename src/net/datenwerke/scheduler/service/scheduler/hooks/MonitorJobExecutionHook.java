...
public interface MonitorJobExecutionHook extends Hook {
   ...
   /***
    * 
    * be careful. if the action ended abnormally the transaction will be rolled
    * back. so if you plan to write something into the database, make sure to get a
    * new transaction.
    */
   void jobExecutionFailed(AbstractJob reportExecuteJob, Exception e);
