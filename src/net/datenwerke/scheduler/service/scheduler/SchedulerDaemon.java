...
public class SchedulerDaemon implements Runnable {
   ...
   @Inject
   public SchedulerDaemon(@SchedulerAsyncPoolName String asyncPoolName, @SchedulerCheckInterval Long checkInterval,
   ...
   public void run() {
      ...
      try {
         ...
         try {
            terminated = asyncService.awaitTerminationForPool(asyncPoolName, waitBeforeForcedShutdown,
