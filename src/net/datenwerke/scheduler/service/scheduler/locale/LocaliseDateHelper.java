...
public class LocaliseDateHelper {
   ...
   static {
      try {
         ...
         /*
          * this happens if called from server side code. Because some enums use this
          * class in their toString methods we need to provide a fallback for this case
          */
      }
   }
   ...
   public static String localDay(Days day) {
      ...
      case DAY:
         return messages.day();
      case WORKINGDAY:
         return messages.workingday();
      case WEEKENDDAY:
         return messages.weekendday();
      }
      return day.name();
   }
