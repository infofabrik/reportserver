...
public class DateTriggerConfig {
   ...
   @Embedded
   @EnclosedEntity
   @AttributeOverrides({ @AttributeOverride(name = "hour", column = @Column(name = "at_time_hour")),
   ...
   @Embedded
   @EnclosedEntity
   @AttributeOverrides({ @AttributeOverride(name = "hour", column = @Column(name = "time_range_start_hour")),
   ...
   @Embedded
   @EnclosedEntity
   @AttributeOverrides({ @AttributeOverride(name = "hour", column = @Column(name = "time_range_end_hour")),
    ...
    * 
    * <p>
    * Only applies if {@link EndTypes} is set to {@link EndTypes#DATE}
    * </p>
    * 
    */
    ...
    * 
    * <p>
    * Only applies if {@link EndTypes} is set to {@link EndTypes#COUNT}
    * </p>
    * 
    */
    ...
    * 
    * <p>
    * Only specified if {@link DailyRepeatType} is set to
    * {@link DailyRepeatType#ONCE}
    * </p>
    * 
    * @see DailyRepeatType
    */
    ...
    * <p>
    * Only specified if {@link DailyRepeatType} is set to
    * {@link DailyRepeatType#BOUNDED_INTERVAL}
    * </p>
    *
    * @param atTime
    * @see DailyRepeatType
