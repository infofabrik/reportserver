...
public abstract class DateTrigger<C extends DateTriggerConfig> extends AbstractTrigger {
   ...
   /**
    * Returns the given date with the time component set to the time of the first
    * execution of the trigger at this day.
    * 
   ...
   public Date getFirstFireTimeOfDay(Date day) {
      ...
      if (DailyRepeatType.ONCE.equals(config.getDailyRepeatType())) {
         ...
         long timeInMinutes = DateUtils.getFragmentInMinutes(config.getTimeRangeStart().getDate(),
   ...
   /**
    * Sets the time component of the supplied date to the time, the trigger fires
    * the last time at this date.
    * 
   ...
   /**
    * Returns the supplied date, with its time component set to the time of the nth
    * execution of the trigger after the time given
    * 
    ...
    * 
    * <p>
    * This method does not change the time according to summer or winter time. So
    * if you add 600 minutes and the time should have been changed overnight the
    * resulting object will still be set to 10 am.
    * </p>
    * 
    * @param day
    * @param minutes
   ...
   private Calendar setTimeOfDay(Date day, int minutes) {
      if (minutes < 0 || minutes > 1440)
         throw new IllegalArgumentException(
               "Please make sure not to span days: Minutes have to be less than 1440 and greate than 0. Got " //$NON-NLS-1$
                     + minutes);
   ...
   /**
    * returns the given date with the time part set to the time of the nth
    * execution.
    * 
    * @param day
    * @param n
