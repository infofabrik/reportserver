...
public class MonthlyNthDayOfWeekConfig extends DateTriggerConfig {
	 ...
	 *  
	 * <p>Only applies if {@link net.datenwerke.rs.scheduler.client.scheduler.schedulereport.pages.SeriesConfigurationForm.SeriesPattern} is set to {@link net.datenwerke.rs.scheduler.client.scheduler.schedulereport.pages.SeriesConfigurationForm.SeriesPattern#MONTHLY} and {@link net.datenwerke.rs.scheduler.client.scheduler.schedulereport.pages.SeriesConfigurationForm.SeriesSubPattern} is set to {@link net.datenwerke.rs.scheduler.client.scheduler.schedulereport.pages.SeriesConfigurationForm.SeriesSubPattern#MONTHLY_Nth_DAY_OF_WEEK_Mth_MONTH}</p>
	 * 
	 */
