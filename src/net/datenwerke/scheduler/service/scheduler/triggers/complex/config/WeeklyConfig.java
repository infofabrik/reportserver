...
public class WeeklyConfig extends DateTriggerConfig {
	 ...
	 * 
	 * <p>Only applies if {@link net.datenwerke.rs.scheduler.client.scheduler.schedulereport.pages.SeriesConfigurationForm.SeriesPattern} is set to {@link net.datenwerke.rs.scheduler.client.scheduler.schedulereport.pages.SeriesConfigurationForm.SeriesPattern#WEEKLY}</p>
	 */
