...
@GenerateDto(dtoPackage = "net.datenwerke.scheduler.client.scheduler.dto.config.complex", createDecorator = true)
@Embeddable
public class Time implements Serializable {
   ...
   public Date getDate() {
      /*
       * Do not use new Date() and setXY(), because the milliseconds (for which no
       * setter exists, will not neccesarily be zero.
       */
