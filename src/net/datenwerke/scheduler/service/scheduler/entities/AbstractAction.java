...
public abstract class AbstractAction {
   ...
   public void execute(AbstractJob abstractJob) throws ActionExecutionException {
      final List<MonitorActionExecution> monitors = hookHandler.getHookers(MonitorActionExecution.class);
      try {
         ...
         monitors.forEach(monitor -> monitor.actionExecutionFailed(this, e));
         throw e;
