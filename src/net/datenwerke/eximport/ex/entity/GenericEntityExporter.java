...
public abstract class GenericEntityExporter extends ExporterImpl<EntityExportItemConfig> {
   ...
   @Override
   protected void doExport(ExportSupervisor exportSupervisor, EntityExportItemConfig item) throws XMLStreamException {
   ...
   @Override
   protected void doAddReferences(ExportSupervisor exportSupervisor, EntityExportItemConfig item,
