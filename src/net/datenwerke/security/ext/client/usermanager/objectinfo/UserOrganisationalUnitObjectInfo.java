...
public class UserOrganisationalUnitObjectInfo implements ObjectInfoAdditionalInfoProvider {

   private final UserManagerDao userManagerDao;

   @Inject
   public UserOrganisationalUnitObjectInfo(UserManagerDao userManagerDao) {
      ...
      userManagerDao.getOrganisationalUnitDetailsAsHtml((UserDto) object, new RsAsyncCallback<SafeHtml>() {
         ...
         public void onSuccess(SafeHtml result) {
            ...
            if (null == result)
               ...
               builder.appendHtmlConstant("<div class=\"rs-infopanel-userorganisationalunit\">");
