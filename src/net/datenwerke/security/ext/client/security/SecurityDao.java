...
public class SecurityDao extends Dao {
   ...
   public void loadSecurityViewInformation(AbstractNodeDto node, AsyncCallback<SecurityViewInformation> callback) {
   ...
   public void removeACEs(AbstractNodeDto node, List<AceDto> aceDtos, AsyncCallback<Void> callback) {
   ...
   public void aceMoved(AbstractNodeDto node, AceDto ace, int index, AsyncCallback<AceDto> callback) {
   ...
   public void loadGenericRights(Collection<GenericTargetIdentifier> targetIdentifiers,
