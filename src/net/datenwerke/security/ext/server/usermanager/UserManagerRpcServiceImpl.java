...
public class UserManagerRpcServiceImpl extends SecuredRemoteServiceServlet implements UserManagerRpcService {
   ...
   @Inject
   public UserManagerRpcServiceImpl(Provider<AuthenticatorService> authenticatorServiceProvider, DtoService dtoService,
         SecurityService securityService, UserManagerService userService) {
