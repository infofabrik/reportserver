 ...
 */
@MappedSuperclass
@GenerateDto(dtoPackage = "net.datenwerke.security.client.treedb.dto", createDecorator = true, poso2DtoPostProcessors = SecuredAbstractNode2DtoPostProcessor.class, abstractDto = true, additionalFields = {
      ...
      @AdditionalField(name = "availableAccessRightsSet", type = Boolean.class, visibility = Visibility.PROTECTED) }, whitelist = {
            ReadDto.class, WriteDto.class, ExecuteDto.class, GrantAccessDto.class, DeleteDto.class, UserDto.class,
            UserDtoDec.class, OrganisationalUnitDto.class, GroupDto.class })
abstract public class SecuredAbstractNode<N extends AbstractNode<N>> extends AbstractNode<N>
