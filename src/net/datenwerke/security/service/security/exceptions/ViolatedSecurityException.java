...
public class ViolatedSecurityException extends RuntimeException {
	...
	public ViolatedSecurityException(MethodInvocation invocation, Object target,
			Class<? extends Right>[] rights, Class<? extends SecurityAction>[] actions) {
		super(getMessageFor(invocation, target, rights, actions));
	}

	private static String getMessageFor(MethodInvocation invocation, Object target,
			Class<? extends Right>[] rights, Class<? extends SecurityAction>[] actions) {
