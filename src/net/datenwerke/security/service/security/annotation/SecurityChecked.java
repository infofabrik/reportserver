...
public @interface SecurityChecked {
   ...
   /**
    * Defines whether the caller has to have authenticated himself with a
    * certificate.
    */
   public boolean certificateRequired() default true;

   /**
    * An array of methods that are not affected by security checks (when used as
   ...
   /**
    * If this flag is set the interceptor returns true or false depending on the
    * security check.
    */
   public boolean returnBooleanOnCheck() default false;

   /**
    * Tells the interceptor to return an instance of the methods return type on
    * failure.
    * 
    * <p>
    * Common interfaces such as Collection, List, Set, Map, will be automatically
    * mapped. If you want to manually set the type to be instantiated use
    * 
    */
