 ...
 * {@link SecurityTargetConfiguration} is used to define what securees are
 ...
 * ({@link GenericSecurityTargetEntity}) is created that stores the ACL for the
 * generic target.
 * </p>
 * 
 *
...
public class SecurityTargetConfiguration {
    ...
    * 
    * <p>
    * The submitted class implements SecurityTarget, then the object maintains it
    * ACL directly. Otherwise SecurityService takes over.
    * </p>
    * 
    * @param target
    */
