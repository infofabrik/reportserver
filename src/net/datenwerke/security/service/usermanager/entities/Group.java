...
@Audited
@Indexed
@GenerateDto(dtoPackage = "net.datenwerke.security.client.usermanager.dto", typeDescriptionMsg = net.datenwerke.security.client.locale.UserManagerMessages.class, typeDescriptionKey = "group", icon = "group")
@InstanceDescription(msgLocation = UserManagerMessages.class, objNameKey = "groupTypeName", icon = "group")
