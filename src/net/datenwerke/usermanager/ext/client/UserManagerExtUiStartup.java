...
public class UserManagerExtUiStartup {
   ...
   @Inject
   public UserManagerExtUiStartup(final HookHandlerService hookHandler,
         final UserManagerUIImporterHooker importerHooker, final UserProfileUserDataHooker userProfileDataHooker) {

      /* attach ex/importer */
      hookHandler.attachHooker(ImporterConfiguratorHook.class, importerHooker);

      /* attach user profile cards */
      hookHandler.attachHooker(UserProfileCardProviderHook.class, userProfileDataHooker,
