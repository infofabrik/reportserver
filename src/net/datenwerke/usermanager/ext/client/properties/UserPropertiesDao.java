...
public class UserPropertiesDao extends Dao {
   ...
   @Inject
   public UserPropertiesDao(UserPropertiesRpcServiceAsync rpcService) {
   ...
   public void updateProperties(UserDto user, List<UserPropertyDto> addedProperties,
      ...
      rpcService.updateProperties(user, addedProperties, modifiedProperties, removedProperties,
