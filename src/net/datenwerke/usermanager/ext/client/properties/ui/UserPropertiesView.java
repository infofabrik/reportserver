...
public class UserPropertiesView extends MainPanelView {
   ...
   @Inject
   public UserPropertiesView(UserPropertiesDao propertiesDao) {
   ...
   private void createGrid() {
      ...
      /* icon column */
      ColumnConfig<UserPropertyDto, UserPropertyDto> icConfig = new ColumnConfig<UserPropertyDto, UserPropertyDto>(
            new IdentityValueProvider<UserPropertyDto>(), 40);
      ...
      /* name column */
      ColumnConfig<UserPropertyDto, String> nameConfig = new ColumnConfig<UserPropertyDto, String>(
            UserPropertyDtoPA.INSTANCE.key(), 200, UserPropertiesMessages.INSTANCE.gridNameHeader());
      nameConfig.setMenuDisabled(true);

      columns.add(nameConfig);

      /* value */
      ColumnConfig<UserPropertyDto, String> valueConfig = new ColumnConfig<UserPropertyDto, String>(
            UserPropertyDtoPA.INSTANCE.value(), 300, UserPropertiesMessages.INSTANCE.gridValueHeader());
