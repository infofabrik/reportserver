...
public class DtoCreationHelper {
   ...
   @Inject
   public DtoCreationHelper(DtoService dtoService) {
   ...
   public void onDtoCreation(Object dto, Object poso, CallbackOnDtoCreation callback) {
      ...
      if (null == bestDto || null != bestDto && bestDto instanceof Dto && dto instanceof Dto
            && ((Dto) bestDto).getDtoView().compareTo(((Dto) dto).getDtoView()) < 0) {
   ...
   public void dtoCreatedFor(Object poso, Object dto, Poso2DtoGenerator<?, ?> generator) {
      if (poso.getClass().isEnum() || poso instanceof java.lang.Enum || (null != poso.getClass().getSuperclass()
            && java.lang.Enum.class.equals(poso.getClass().getSuperclass())))
         return;
   ...
   public void posoCreatedFor(Object dto, Object poso, Dto2PosoGenerator<?, ?> generator) {
      if (dto.getClass().isEnum() || dto instanceof java.lang.Enum
            || (null != dto.getClass().getSuperclass() && java.lang.Enum.class.equals(dto.getClass().getSuperclass())))
         return;
      ...
      for (Object dto : callbackOnPosoMap.keySet()) {
         if (!createdPosoMap.containsKey(dto)) {
            for (CallbackOnPosoCreation callback : callbackOnPosoMap.get(dto)) {
               ...
               if (null == posoId || !dto2PosoMap.containsKey(dto.getClass())
                     || !dto2PosoMap.get(dto.getClass()).containsKey(posoId))
   ...
   public void createdDto(Object dto, Object poso, DtoView here, DtoView referenced) {
