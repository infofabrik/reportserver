...
public class GridHelperServiceImpl implements GridHelperService {
   ...
   @Override
   public <D, V extends Enum<?>> CCContainer<D, V> createComboBoxColumnConfig(final V[] values, ValueProvider<D, V> vp,
      ...
      return createComboBoxColumnConfig(values, vp, converter, new StringLabelProvider<Object>(), comparator, nullable,
            sortDir, width);
   }

   @Override
   public <D, V> CCContainer<D, V> createComboBoxColumnConfig(final V[] values, ValueProvider<D, V> vp,
   ...
   public <D> CCContainer<D, Boolean> createBooleanComboBoxColumnConfig(ValueProvider<D, Boolean> vp, boolean nullable,
         boolean trueFirst, int width, final String tString, final String fString) {

      return createComboBoxColumnConfig(trueFirst ? new Boolean[] { true, false } : new Boolean[] { false, true }, vp,
