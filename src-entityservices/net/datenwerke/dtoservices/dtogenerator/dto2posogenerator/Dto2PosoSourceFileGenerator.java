...
abstract public class Dto2PosoSourceFileGenerator extends SourceFileGeneratorImpl {
   ...
   protected void addConstructor(StringBuilder sourceBuilder) {
      ...
      while (argIt.hasNext()) {
         ...
         sourceBuilder.append("\t\t").append(arg.getValue()).append(" ").append(arg.getKey())
               .append(argIt.hasNext() ? ",\n" : "\n");
      }
   ...
   protected void addClassComment(StringBuilder sourceBuilder) {
      sourceBuilder.append("\n/**\n").append(" * Dto2PosoGenerator for ").append(posoAnalizer.getSimpleName())
   ...
   protected Collection<String> getImplementedInterfaces() {
      return Collections.singleton(Dto2PosoGenerator.class.getSimpleName() + "<"
            + posoAnalizer.getDtoInformation().getClassName() + "," + posoAnalizer.getSimpleName() + ">");
   }
   ...
   protected void addPostProcessingMethods(StringBuilder sourceBuilder) {
      MethodBuilder method = new MethodBuilder("postProcessCreate", "void", getDtoType() + " dto",
            getPosoType() + " poso");
