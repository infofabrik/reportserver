   ...
   public void addSetSection(Collection<String> referenceAccu, MethodBuilder method) {
      ...
      if (referencesPosoCollection()) {
         ...
         if (useProxy && referencedPoso.isPosoClass()) {
            method.addBodyLine("Collection<" + referencedPoso.getDtoInformation().getClassName() + "> "
                  + tmpCollectionVar + " = null;");
            method.addBodyLine(tmpCollectionVar + " = dto." + getGetMethodForDto() + "();");
         } else
            method.addBodyLine("Collection<" + referencedPoso.getDtoInformation().getClassName() + "> "
                  + tmpCollectionVar + " = dto." + getGetMethodForDto() + "();");
         ...
         if (isEnclosedReferencedPoso()) {
            ...
            if (null != referencedPoso.getIdField()) {
               if (merge2Unmanaged) {
                  ...
                  method.beginBodyBlock("for(" + referencedPoso.getDtoInformation().getClassName() + " refDto : "
                        + tmpCollectionVar + ")");

                  method.addBodyLine(collectionVar + ".add((" + referencedPoso.getSimpleName()
                        + ") dtoServiceProvider.get().createUnmanagedPoso(refDto));");
                  ...
                  method.addBodyLine(
                        collectionInterfaceName + " " + remCollectionVar + " = new " + collectionClassName + "();");
                  ...
                  method.beginBodyBlock(
                        "if(null != refDto && null != refDto." + referencedPoso.getIdField().getGetMethodForDto()
                              + "() && refDto." + referencedPoso.getIdField().getGetMethodForDto() + "().equals(ref."
                              + referencedPoso.getIdField().getGetMethod() + "()))");
                  ...
                  method.beginOneLineBlock(
                        "for(" + referencedPoso.getSimpleName() + " ref : " + remCollectionVar + ")");
                  method.addBodyLine(collectionVar + ".remove(ref);");
                  method.addBodyLine(Dto2PosoSourceFileGenerator.DTO2POSO_SUPERVISOR_NAME
                        + ".enclosedObjectsRemovedFromCollection(dto, poso, " + remCollectionVar + ", \"" + getName()
                        + "\");");
                  method.addBodyLine();
                  ...
                  method.addBodyLine(
                        collectionInterfaceName + " " + newCollectionVar + " = new " + collectionClassName + "();");
                  method.beginBodyBlock("for(" + referencedPoso.getDtoInformation().getClassName() + " refDto : "
                        + tmpCollectionVar + ")");
                  ...
                  method.addBodyLine(newCollectionVar + ".add((" + referencedPoso.getSimpleName()
                        + ") dtoServiceProvider.get().loadAndMergePoso(refDto));");
                  ...
                  method.beginOneLineBlock("if(! found && null != refDto && null == refDto."
                        + referencedPoso.getIdField().getGetMethodForDto() + "() )");
                  method.addBodyLine(newCollectionVar + ".add((" + referencedPoso.getSimpleName()
                        + ") dtoServiceProvider.get().createPoso(refDto));");
                  method.beginOneLineBlock("else if(! found && null != refDto && null != refDto."
                        + referencedPoso.getIdField().getGetMethodForDto() + "() )");
                  if (!isAllowForeignPosoForEnclosed()) { // default
                     method.addBodyLine("throw new IllegalArgumentException(\"dto should not have an id. property("
                           + getName() + ") \");");
            ...
            method.beginBodyBlock(
                  "for(" + referencedPoso.getDtoInformation().getClassName() + " refDto : " + tmpCollectionVar + ")");

            if (null != referencedPoso.getIdField()) {
               method.beginOneLineBlock(
                     "if(null != refDto && null != refDto." + referencedPoso.getIdField().getGetMethodForDto() + "())");
               method.addBodyLine(collectionVar + ".add((" + referencedPoso.getSimpleName()
                     + ") dtoServiceProvider.get().loadPoso(refDto));");

               method.beginBodyBlock("else if(null != refDto && null == refDto."
                     + referencedPoso.getIdField().getGetMethodForDto() + "())");
               {
                  method.addCustomLine(
                        "\t\t\t\t\t((DtoMainService)dtoServiceProvider.get()).getCreationHelper().onPosoCreation(refDto, new "
                              + CallbackOnPosoCreation.class.getName() + "(){\n");
                  method.incrementIndent();
                  method.beginBodyBlock("public void callback(Object poso)");

                  method.beginOneLineBlock("if(null == poso)");
                  method.addBodyLine("throw new IllegalArgumentException(\"referenced dto should have an id ("
                        + getName() + ")\");");
         ...
         if (useProxy && referencedPoso.isPosoClass())
            method.addBodyLine(referencedPoso.getDtoInformation().getClassName() + " " + tmpDtoVar + " = dto."
                  + getGetMethodForDto() + "();");
         else
            method.addBodyLine(referencedPoso.getDtoInformation().getClassName() + " " + tmpDtoVar + " = dto."
                  + getGetMethodForDto() + "();");
         ...
         if (null != referencedPoso.getIdField()) {
            ...
            if (isEnclosedReferencedPoso()) {
               if (merge2Unmanaged) {
                  method.addBodyLine("poso." + getSetMethod() + "((" + referencedPoso.getSimpleName()
                        + ")dtoServiceProvider.get().createUnmanagedPoso(" + tmpDtoVar + "));");
               } else {
                  method.beginBodyBlock("if(null != " + tmpDtoVar + " && null != " + tmpDtoVar + "."
                        + idField.getGetMethodForDto() + "())");

                  method.beginOneLineBlock(
                        "if(null != poso." + getGetMethod() + "() && null != poso." + getGetMethod() + "()."
                              + idField.getGetMethod() + "() && poso." + getGetMethod() + "()." + idField.getGetMethod()
                              + "().equals(" + tmpDtoVar + "." + idField.getGetMethodForDto() + "()))");
                  method.addBodyLine("poso." + getSetMethod() + "((" + referencedPoso.getSimpleName()
                        + ")dtoServiceProvider.get().loadAndMergePoso(" + tmpDtoVar + "));");
                  method.addOneLineElse();
                  if (!isAllowForeignPosoForEnclosed())
                     method.addBodyLine(
                           "throw new IllegalArgumentException(\"enclosed dto should not have non matching id ("
                                 + getName() + ")\");");
                  else
                     method.addBodyLine("poso." + getSetMethod() + "((" + referencedPoso.getSimpleName()
                           + ")dtoServiceProvider.get().loadAndMergePoso(" + tmpDtoVar + "));");
                  ...
                  method.addBodyLine(referencedPoso.getSimpleName() + " newPropertyValue = ("
                        + referencedPoso.getSimpleName() + ")dtoServiceProvider.get().createPoso(" + tmpDtoVar + ");");
                  method.addBodyLine(
                        Dto2PosoSourceFileGenerator.DTO2POSO_SUPERVISOR_NAME + ".enclosedObjectRemoved(dto, poso, poso."
                              + getGetMethod() + "(), newPropertyValue, \"" + getName() + "\");");
                  method.addBodyLine("poso." + getSetMethod() + "(newPropertyValue);");

                  method.addElseBlock();
                  method.addBodyLine("poso." + getSetMethod() + "((" + referencedPoso.getSimpleName()
                        + ")dtoServiceProvider.get().createPoso(" + tmpDtoVar + "));");
                  method.endBodyBlock();
               }
            } else {
               if (merge2Unmanaged) {
                  ...
                  {
                     method.addBodyLine(referencedPoso.getSimpleName() + " newPropertyValue = ("
                           + referencedPoso.getSimpleName() + ")dtoServiceProvider.get().loadPoso(" + tmpDtoVar + ");");
                     method.addBodyLine("poso." + getSetMethod() + "(newPropertyValue);");

                     method.addCustomLine(
                           "\t\t\t((DtoMainService)dtoServiceProvider.get()).getCreationHelper().onPosoCreation("
                                 + tmpDtoVar + ", new " + CallbackOnPosoCreation.class.getName() + "(){\n");
                     method.incrementIndent();
                     method.beginBodyBlock("public void callback(Object refPoso)");

                     method.beginOneLineBlock("if(null != refPoso)");
                     method.addBodyLine(
                           "poso." + getSetMethod() + "((" + referencedPoso.getSimpleName() + ")refPoso);");
                     method.endBodyBlock();
                     method.decrementIndent();
                     method.addCustomLine("\t\t\t});\n");
                  }
                  method.addElseIfBlock("null != " + tmpDtoVar + " && null == " + tmpDtoVar + "."
                        + idField.getGetMethodForDto() + "()");
                  {
                     String finalTmpDtoVar = tmpDtoVar + "_final";
                     method.addBodyLine("final " + referencedPoso.getDtoInformation().getClassName() + " "
                           + finalTmpDtoVar + " = " + tmpDtoVar + ";");
                     method.addCustomLine(
                           "\t\t\t((DtoMainService)dtoServiceProvider.get()).getCreationHelper().onPosoCreation("
                                 + tmpDtoVar + ", new " + CallbackOnPosoCreation.class.getName() + "(){\n");
                     method.incrementIndent();
                     ...
                     method.beginBodyBlock("if(null == refPoso)");
                     {
                        method.beginTryBlock();
                        method.addBodyLine("poso." + getSetMethod() + "((" + referencedPoso.getSimpleName()
                              + ")dtoServiceProvider.get().createUnmanagedPoso(" + finalTmpDtoVar + "));");
                  ...
                  method.beginBodyBlock("if(null != poso." + getGetMethod() + "() && null != poso." + getGetMethod()
                        + "()." + idField.getGetMethod() + "() && ! poso." + getGetMethod() + "()."
                        + idField.getGetMethod() + "().equals(" + tmpDtoVar + "." + idField.getGetMethodForDto()
                        + "()))");
                  method.addBodyLine(referencedPoso.getSimpleName() + " newPropertyValue = ("
                        + referencedPoso.getSimpleName() + ")dtoServiceProvider.get().loadPoso(" + tmpDtoVar + ");");
                  method.addBodyLine(Dto2PosoSourceFileGenerator.DTO2POSO_SUPERVISOR_NAME
                        + ".referencedObjectRemoved(dto, poso, poso." + getGetMethod() + "(), newPropertyValue, \""
                        + getName() + "\");");
                  method.addBodyLine("poso." + getSetMethod() + "(newPropertyValue);");
                  method.addElseIfBlock("null == poso." + getGetMethod() + "()");
                  method.addBodyLine("poso." + getSetMethod() + "((" + referencedPoso.getSimpleName()
                        + ")dtoServiceProvider.get().loadPoso(" + tmpDtoVar + "));");
                  ...
                  method.addElseIfBlock("null == " + tmpDtoVar);
                  method.addBodyLine(Dto2PosoSourceFileGenerator.DTO2POSO_SUPERVISOR_NAME
                        + ".referencedObjectRemoved(dto, poso, poso." + getGetMethod() + "(), null, \"" + getName()
                        + "\");");
                  method.addBodyLine("poso." + getSetMethod() + "(null);");
