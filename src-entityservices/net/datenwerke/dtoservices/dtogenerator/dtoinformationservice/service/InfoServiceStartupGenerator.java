...
public class InfoServiceStartupGenerator extends SourceFileGeneratorImpl {
   ...
   protected void addClassBody(StringBuilder sourceBuilder) {
      ...
      sourceBuilder.append("\tpublic " + dtoAnnotationProcessor.getDtoServiceBaseName()
            + DtoClientInfoServiceGeneratorFacilitator.STARTUP_SERVICE_NAME + "(\n");
      ...
      sourceBuilder.append("\t\t" + dtoAnnotationProcessor.getDtoServiceBaseName()
            + DtoClientInfoServiceGeneratorFacilitator.SERVICE_IMPLEMENTATION_NAME + " subService\n");

      sourceBuilder.append("\t){\n");

      sourceBuilder.append("\t\t((" + DtoMainInformationService.class.getSimpleName() + ")mainService)."
